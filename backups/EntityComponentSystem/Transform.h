...
namespace Framework::Helper {
    ...
    private:
        void UpdateLocalPosition(glm::vec3 scaleDelta);

        void UpdateChildPosition(glm::vec3 delta, const bool pivot = true) noexcept;
        void UpdateChildRotation(glm::vec3 delta, const bool pivot = true) noexcept;
        void UpdateChildScale(glm::vec3 delta, const bool pivot = true) noexcept;
    private:
        ...
        glm::vec3       m_parentDefDirection         = { 0, 0, 0 };
