...
@group(1) @binding(0) var SKYBOX_DIFFUSE : texture_cube<f32>;
@group(1) @binding(1) var SKYBOX_DIFFUSE_sampler : sampler;
...
fn fragment(fsIn : VertexOutput) -> FragmentOutput {
    ...
    COLOR = textureSample(SKYBOX_DIFFUSE, SKYBOX_DIFFUSE_sampler, VERTEX);
