...
constexpr StaticMeshVertex CUBE_FRONT_VERTICES[] = {
        {{1.000000,  1.000000,  1.000000},  {0.625000, 0.250000}, {0.000000,
0.000000,  1.000000}},
        {{-1.000000, 1.000000,  1.000000},  {0.625000, 0.000000}, {0.000000,
0.000000,  1.000000}},
        {{-1.000000, -1.000000, 1.000000},  {0.375000, 0.000000}, {0.000000,
0.000000,  1.000000}},
        {{1.000000,  1.000000,  1.000000},  {0.625000, 0.250000}, {0.000000,
0.000000,  1.000000}},
        {{-1.000000, -1.000000, 1.000000},  {0.375000, 0.000000}, {0.000000,
0.000000,  1.000000}},
        {{1.000000,  -1.000000, 1.000000},  {0.375000, 0.250000}, {0.000000,
0.000000,  1.000000}},
};

constexpr StaticMeshVertex CUBE_BOTTOM_VERTICES[] = {
        {{1.000000,  -1.000000, -1.000000}, {0.375000, 0.500000}, {0.000000,
-1.000000, 0.000000}},
        {{-1.000000, -1.000000, 1.000000},  {0.125000, 0.250000}, {0.000000,
-1.000000, 0.000000}},
        {{-1.000000, -1.000000, -1.000000}, {0.125000, 0.500000}, {0.000000,
-1.000000, 0.000000}},
        {{1.000000,  -1.000000, -1.000000}, {0.375000, 0.500000}, {0.000000,
-1.000000, 0.000000}},
        {{1.000000,  -1.000000, 1.000000},  {0.375000, 0.250000}, {0.000000,
...
constexpr StaticMeshVertex CUBE_LEFT_VERTICES[] = {
        {{1.000000, 1.000000,  -1.000000}, {0.625000, 0.500000}, {1.000000,
0.000000, 0.000000}},
        {{1.000000, -1.000000, 1.000000},  {0.375000, 0.250000}, {1.000000,
0.000000, 0.000000}},
        {{1.000000, -1.000000, -1.000000}, {0.375000, 0.500000}, {1.000000,
0.000000, 0.000000}},
        {{1.000000, 1.000000,  -1.000000}, {0.625000, 0.500000}, {1.000000,
0.000000, 0.000000}},
        {{1.000000, 1.000000,  1.000000},  {0.625000, 0.250000}, {1.000000,
0.000000, 0.000000}},
        {{1.000000, -1.000000, 1.000000},  {0.375000, 0.250000}, {1.000000,
0.000000, 0.000000}},
};
...
constexpr StaticMeshVertex CUBE_BACK_VERTICES[] = {
        {{-1.000000, 1.000000,  -1.000000}, {0.625000, 0.750000}, {0.000000,
0.000000,  -1.000000}},
        {{1.000000,  -1.000000, -1.000000}, {0.375000, 0.500000}, {0.000000,
0.000000,  -1.000000}},
        {{-1.000000, -1.000000, -1.000000}, {0.375000, 0.750000}, {0.000000,
0.000000,  -1.000000}},
        {{-1.000000, 1.000000,  -1.000000}, {0.625000, 0.750000}, {0.000000,
0.000000,  -1.000000}},
        {{1.000000,  1.000000,  -1.000000}, {0.625000, 0.500000}, {0.000000,
0.000000,  -1.000000}},
        {{1.000000,  -1.000000, -1.000000}, {0.375000, 0.500000}, {0.000000,
0.000000,  -1.000000}}
};
...
constexpr StaticMeshVertex CUBE_RIGHT_VERTICES[] = {
        {{-1.000000, 1.000000,  1.000000},  {0.625000, 1.000000}, {-1.000000,
0.000000,  0.000000}},
        {{-1.000000, 1.000000,  -1.000000}, {0.625000, 0.750000}, {-1.000000,
0.000000,  0.000000}},
        {{-1.000000, -1.000000, -1.000000}, {0.375000, 0.750000}, {-1.000000,
0.000000,  0.000000}},
        {{-1.000000, 1.000000,  1.000000},  {0.625000, 1.000000}, {-1.000000,
0.000000,  0.000000}},
        {{-1.000000, -1.000000, -1.000000}, {0.375000, 0.750000}, {-1.000000,
0.000000,  0.000000}},
        {{-1.000000, -1.000000, 1.000000},  {0.375000, 1.000000}, {-1.000000,
0.000000,  0.000000}},
};
...
DynamicCastSceneLogicToSceneCubeChunkLogic(scene->GetLogicBase().Get());
        ...
        auto&& [region, chunk] =
m_logic->GetRegionAndChunk(transform->GetTranslation());
    ...
    bool HasNeighbour(int32_t x, int32_t y, int32_t z, int32_t offsetX, int32_t
offsetY, int32_t offsetZ) { x += offsetX; y += offsetY; z += offsetZ;

        const bool outOfBounds = (x < 0 || x >= sizeX) ||  (y < 0 || y >= sizeY)
||  (z < 0 || z >= sizeZ);
    ...
    void GenerateVoxel() {
        //Debug::Log(std::to_string(m_chunk.x) + ", " +
std::to_string(m_chunk.y) + ", " + std::to_string(m_chunk.z));
            ...
            for (int32_t y = 0; y < sizeY; ++y) {
                for (int32_t z = 0; z < sizeZ; ++z) {
                    ...
                    float noise = Mathf::SNoise3D(
                        (static_cast<double>(m_chunk.x * sizeX + x) / 10.0 +
seed), (static_cast<double>(m_chunk.y * sizeY + y) / 10.0 + seed),
                        (static_cast<double>(m_chunk.z * sizeZ + z) / 10.0 +
seed)
                    );
    ...
    void GenerateMesh() {
        ...
        for (int32_t x = 0; x < sizeX; ++x)
        {
            for (int32_t y = 0; y < sizeY; ++y)
            {
                ...
                if (m_proceduralMesh) {
                        m_proceduralMesh->SetIndexedVertices(vertices.data(),
vertices.size()); m_proceduralMesh->SetIndices(indices.data(), indices.size());
                }
    }
