...
/*GLFWAPI const char* glfwGetWindowTitle(GLFWwindow* window) {
    //GetWindowText(((_GLFWwindow*)(window))->win32.handle, (LPWSTR) wnd_title, sizeof(wnd_title));

    char* tmp = (char*)malloc(GetWindowTextLength(((_GLFWwindow*)(window))->win32.handle) + 1);
    GetWindowText(((_GLFWwindow*)(window))->win32.handle, tmp, GetWindowTextLength(((_GLFWwindow*)(window))->win32.handle) + 1);
    return tmp;
}*/
