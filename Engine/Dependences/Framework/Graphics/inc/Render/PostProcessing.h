...
namespace Framework::Graphics {
    ...
    protected:
        ...
        Helper::Math::Vector3 m_colorCorrection       = { 1, 1, 1 };
        Helper::Math::Vector3 m_bloomColor            = { 1, 1, 1 };
    ...
    public:
        [[nodiscard]] SR_FORCE_INLINE Helper::Math::Vector3 GetColorCorrection() const noexcept { return m_colorCorrection; }
        [[nodiscard]] SR_FORCE_INLINE Helper::Math::Vector3 GetBloomColor()      const noexcept { return m_bloomColor;       }
    ...
    public:
        ...
        SR_FORCE_INLINE void SetColorCorrection(Helper::Math::Vector3 value) noexcept { m_colorCorrection     = value;     }
        SR_FORCE_INLINE void SetBloomColor(Helper::Math::Vector3 value)      noexcept { m_bloomColor           = value;     }
