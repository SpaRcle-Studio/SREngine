...
namespace SR_CORE_GUI_NS {
    SR_ENUM_NS_CLASS_T(EditorSceneViewMode, uint8_t, FreeAspect, WindowSize);

    class SceneTools : public SR_GRAPH_GUI_NS::WidgetContainer {
        using Super = SR_GRAPH_GUI_NS::WidgetContainer;

    public:
        SceneTools() : Super("SceneTools") { SetSize(SR_MATH_NS::IVector2(0, 22)); }
    ...
    public:
        ...
        SR_NODISCARD bool IsGizmo3D() const noexcept {
            return m_gizmoOperationFlag & SR_GRAPH_UI_NS::GizmoOperation::Z;
        }
