...
namespace SR_AUDIO_NS::Tools {
    bool IsModule(const char* Ext) {
        return (
            (SR_STRCMPI(Ext, "mod") == 0) || (SR_STRCMPI(Ext, "s3m") == 0) || (SR_STRCMPI(Ext, "xm") == 0) ||
            (SR_STRCMPI(Ext, "it") == 0) || (SR_STRCMPI(Ext, "669") == 0) || (SR_STRCMPI(Ext, "amf") == 0) ||
            (SR_STRCMPI(Ext, "ams") == 0) || (SR_STRCMPI(Ext, "dbm") == 0) || (SR_STRCMPI(Ext, "dmf") == 0) ||
            (SR_STRCMPI(Ext, "dsm") == 0) || (SR_STRCMPI(Ext, "far") == 0) || (SR_STRCMPI(Ext, "mdl") == 0) ||
            (SR_STRCMPI(Ext, "med") == 0) || (SR_STRCMPI(Ext, "mtm") == 0) || (SR_STRCMPI(Ext, "okt") == 0) ||
            (SR_STRCMPI(Ext, "ptm") == 0) || (SR_STRCMPI(Ext, "stm") == 0) || (SR_STRCMPI(Ext, "ult") == 0) ||
            (SR_STRCMPI(Ext, "umx") == 0) || (SR_STRCMPI(Ext, "mt2") == 0) || (SR_STRCMPI(Ext, "psm") == 0) ||
            // MIDI
