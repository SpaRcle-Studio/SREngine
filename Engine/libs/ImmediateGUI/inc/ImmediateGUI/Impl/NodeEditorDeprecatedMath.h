...
#ifndef SR_ENGINE_IMMEDIATE_GUI_NODE_EDITOR_DEPRECATED_MATH_H
#define SR_ENGINE_IMMEDIATE_GUI_NODE_EDITOR_DEPRECATED_MATH_H
...
#endif //SR_ENGINE_IMMEDIATE_GUI_NODE_EDITOR_DEPRECATED_MATH_H
