...
bool EvoScript::AddressTableGen::RegisterMethod(
    const std::function<void(EvoScript::IState*)>& setter, const std::string& className, const std::string& methodName,
    const std::string& returnType, const std::vector<std::string>& argTypes, MethodType type,
    const std::string& _overrideClass, Publicity publicity
) {
...
bool EvoScript::AddressTableGen::Save(const std::string& libFolder) {
    ...
    /// Allocator
    {
        ...
        file << "//\n// Created by Evo Script code generator on " + Tools::GetDate() +
                    ...
                    "\n"
                    "ES_EXTERN void SetAllocateMemoryFnPtr(AllocateMemoryFnPtr "
                    "fn) {\n"
                    "\tg_allocateMemory = fn;\n"
                    "}\n"
                    "\n"
...
bool EvoScript::AddressTableGen::RegisterEnum(
    ...
    EvoEnum evoEnum = {.m_name = name, .m_header = header, .m_asClass = asClass, .m_values = values};
...
bool EvoScript::AddressTableGen::RegisterTypedef(
    const std::string& name, const std::string& header, const std::string& value
) {
...
bool EvoScript::AddressTableGen::RegisterMethod(
    ...
    const std::vector<std::string>& argTypes, EvoScript::MethodType type, const std::string& _overrideClass,
...
bool EvoScript::AddressTableGen::RegisterFunction(
    const EvoScript::AddressTableGen::SetterFn& setter, const std::string& methodName, const std::string& returnType,
