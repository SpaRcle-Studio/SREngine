...
namespace SR_PHYSICS_NS {
    SR_ENUM_NS_CLASS(
        LibraryType, Unknown = 0, Bullet3 = 1, Newton = 2, PhysX = 3, Havok = 4, Volt = 5, Shark = 6, Box2D = 7
    );

    SR_ENUM_NS_CLASS(
        ShapeType, Unknown,

        Box2D, Cylinder2D, Capsule2D, Circle2D, TriangleMesh2D, Cone2D, Edge2D,

        Plane3D, Box3D, Cylinder3D, Capsule3D, Sphere3D, TriangleMesh3D, Convex3D, Cone3D
    )
} // namespace SR_PHYSICS_NS
