...
Framework::Helper::Math::Vector3<Framework::Helper::Math::Unit> Framework::Helper::Math::Quaternion::EulerAngle(bool degrees) const {
    if (degrees)
        return Vector3<Framework::Helper::Math::Unit>(glm::eulerAngles(self)).Degrees();
    else
        return Vector3<Framework::Helper::Math::Unit>(glm::eulerAngles(self));
}

Framework::Helper::Math::Quaternion::Quaternion(const Framework::Helper::Math::Vector3<Framework::Helper::Math::Unit> &p_euler, bool inRads) {
    Vector3 v = p_euler;
