...
SR_UTILS_NS::GameObject::Ptr Framework::Core::World::World::Instance(Framework::Helper::Types::Marshal &marshal)  {
...
SR_UTILS_NS::GameObject::Ptr SR_CORE_NS::World::World::Instance(const SR_HTYPES_NS::RawMesh *rawMesh) {
    GameObjectPtr root;
