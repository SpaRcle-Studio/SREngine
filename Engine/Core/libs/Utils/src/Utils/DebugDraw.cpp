...
namespace SR_UTILS_NS {
    ...
    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale, const SR_MATH_NS::FColor& color, float_t time) {
        SR_LOCK_GUARD;
        ...
        if (m_currentCallbacks && m_currentCallbacks->drawMeshCallback) {
            return m_currentCallbacks->drawConvexMeshCallback(pRawMesh, meshId, id, pos, rot, scale, color, time);
        }

        return SR_ID_INVALID;
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::Quaternion &rot, const SR_MATH_NS::FVector3 &scale, const SR_MATH_NS::FColor &color) {
        return DrawConvexMesh(pRawMesh, meshId, id, pos, rot, scale, color, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::Quaternion &rot, const SR_MATH_NS::FVector3 &scale) {
        return DrawConvexMesh(pRawMesh, meshId, id, pos, rot, scale, DEFAULT_COLOR, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::Quaternion &rot) {
        return DrawConvexMesh(pRawMesh, meshId, id, pos, rot, DEFAULT_SCALE, DEFAULT_COLOR, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3 &pos) {
        return DrawConvexMesh(pRawMesh, meshId, id, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, DEFAULT_COLOR, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::FColor &color, float_t time) {
        return DrawConvexMesh(pRawMesh, meshId, id, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, color, time);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::Quaternion &rot, const SR_MATH_NS::FVector3 &scale, const SR_MATH_NS::FColor &color) {
        return DrawConvexMesh(pRawMesh, meshId, SR_ID_INVALID, pos, rot, scale, color, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::Quaternion &rot, const SR_MATH_NS::FVector3 &scale) {
        return DrawConvexMesh(pRawMesh, meshId, SR_ID_INVALID, pos, rot, scale, DEFAULT_COLOR, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::Quaternion &rot) {
        return DrawConvexMesh(pRawMesh, meshId, SR_ID_INVALID, pos, rot, DEFAULT_SCALE, DEFAULT_COLOR, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3 &pos) {
        return DrawConvexMesh(pRawMesh, meshId, SR_ID_INVALID, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, DEFAULT_COLOR, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::FColor &color) {
        return DrawConvexMesh(pRawMesh, meshId, id, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, color, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3 &pos, float_t time) {
        return DrawConvexMesh(pRawMesh, meshId, id, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, DEFAULT_COLOR, time);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3 &pos, const SR_MATH_NS::Quaternion &rot, const SR_MATH_NS::FVector3 &scale, const SR_MATH_NS::FColor &color, float_t time) {
        return DrawConvexMesh(pRawMesh, meshId, SR_ID_INVALID, pos, rot, scale, color, time);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::FColor& color, float_t time) {
        return DrawConvexMesh( pRawMesh, meshId, SR_ID_INVALID, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, color, time);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::FColor& color) {
        return DrawConvexMesh( pRawMesh, meshId, SR_ID_INVALID, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, color, DEFAULT_DURATION);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, float_t time) {
        return DrawConvexMesh( pRawMesh, meshId, SR_ID_INVALID, pos, DEFAULT_QUATERNION, DEFAULT_SCALE, DEFAULT_COLOR, time);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id) {
        return DrawConvexMesh(pRawMesh, meshId, id, DEFAULT_POSITION, DEFAULT_QUATERNION, DEFAULT_SCALE, DEFAULT_COLOR, 0.f);
    }

    uint64_t DebugDraw::DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId) {
        return DrawConvexMesh(pRawMesh, meshId, SR_ID_INVALID, DEFAULT_POSITION, DEFAULT_QUATERNION, DEFAULT_SCALE, DEFAULT_COLOR, DEFAULT_DURATION);
    }
