...
const int32_t RTL_USCRIPT_PROPS = 1 << 24;
...
const int32_t SCRIPT_PROPS[] = {
    ...
    0x0628 | RECOMMENDED | RTL_USCRIPT_PROPS,  // Arab
    ...
    0x05D0 | RECOMMENDED | RTL_USCRIPT_PROPS,  // Hebr
    ...
    0x0710 | LIMITED_USE | RTL_USCRIPT_PROPS,  // Syrc
    0x0B95 | RECOMMENDED,  // Taml
    0x0C15 | RECOMMENDED,  // Telu
    0x078C | RECOMMENDED | RTL_USCRIPT_PROPS,  // Thaa
    ...
    0x280E | UNKNOWN,  // Brai
    0x10800 | EXCLUSION | RTL_USCRIPT_PROPS,  // Cprt
    ...
    0x10A00 | EXCLUSION | RTL_USCRIPT_PROPS,  // Khar
    ...
    0x10CA1 | EXCLUSION | RTL_USCRIPT_PROPS | CASED,  // Hung
    0,
    ...
    0x0840 | LIMITED_USE | RTL_USCRIPT_PROPS,  // Mand
    0,
    0x10980 | EXCLUSION | RTL_USCRIPT_PROPS,  // Mero
    0x07CA | LIMITED_USE | RTL_USCRIPT_PROPS,  // Nkoo
    0x10C00 | EXCLUSION | RTL_USCRIPT_PROPS,  // Orkh
    0x1036B | EXCLUSION,  // Perm
    0xA840 | EXCLUSION,  // Phag
    0x10900 | EXCLUSION | RTL_USCRIPT_PROPS,  // Phnx
    ...
    0x10920 | EXCLUSION | RTL_USCRIPT_PROPS,  // Lydi
    ...
    0x10840 | EXCLUSION | RTL_USCRIPT_PROPS,  // Armi
    0x10B00 | EXCLUSION | RTL_USCRIPT_PROPS,  // Avst
    0x11103 | LIMITED_USE,  // Cakm
    0xAC00 | RECOMMENDED,  // Kore
    0x11083 | EXCLUSION,  // Kthi
    0x10AD8 | EXCLUSION | RTL_USCRIPT_PROPS,  // Mani
    0x10B60 | EXCLUSION | RTL_USCRIPT_PROPS,  // Phli
    0x10B8F | EXCLUSION | RTL_USCRIPT_PROPS,  // Phlp
    0,
    0x10B40 | EXCLUSION | RTL_USCRIPT_PROPS,  // Prti
    0x0800 | EXCLUSION | RTL_USCRIPT_PROPS,  // Samr
    ...
    0,
    0x10A60 | EXCLUSION | RTL_USCRIPT_PROPS,  // Sarb
    ...
    0,
    0,
    0x1E802 | EXCLUSION | RTL_USCRIPT_PROPS,  // Mend
    0x109A0 | EXCLUSION | RTL_USCRIPT_PROPS,  // Merc
    0x10A95 | EXCLUSION | RTL_USCRIPT_PROPS,  // Narb
    0x10896 | EXCLUSION | RTL_USCRIPT_PROPS,  // Nbat
    0x10873 | EXCLUSION | RTL_USCRIPT_PROPS,  // Palm
    ...
    0x108F4 | EXCLUSION | RTL_USCRIPT_PROPS,  // Hatr
    0x1160E | EXCLUSION,  // Modi
    0x1128F | EXCLUSION,  // Mult
    0x11AC0 | EXCLUSION,  // Pauc
    0x1158E | EXCLUSION,  // Sidd
    0x1E909 | LIMITED_USE | RTL_USCRIPT_PROPS | CASED,  // Adlm
    ...
    0x10D12 | LIMITED_USE | RTL_USCRIPT_PROPS,  // Rohg
    0x10F42 | EXCLUSION | RTL_USCRIPT_PROPS,  // Sogd
    0x10F19 | EXCLUSION | RTL_USCRIPT_PROPS,  // Sogo
    0x10FF1 | EXCLUSION | RTL_USCRIPT_PROPS,  // Elym
    0x1E108 | LIMITED_USE,  // Hmnp
    0x119CE | EXCLUSION,  // Nand
    0x1E2E1 | LIMITED_USE,  // Wcho
    0x10FBF | EXCLUSION | RTL_USCRIPT_PROPS,  // Chrs
    0x1190C | EXCLUSION,  // Diak
    0x18C65 | EXCLUSION | LB_LETTERS,  // Kits
    0x10E88 | EXCLUSION | RTL_USCRIPT_PROPS,  // Yezi
    0x12FE5 | EXCLUSION,  // Cpmn
    0x10F7C | EXCLUSION | RTL_USCRIPT_PROPS,  // Ougr
...
uscript_isRightToLeft(UScriptCode script) {
    return (getScriptProps(script) & RTL_USCRIPT_PROPS) != 0;
}
