...
static const icu::UnicodeString *gRBBIEmptyString = nullptr;
...
UBool U_CALLCONV rbbi_cleanup(void) {
    ...
    delete gRBBIEmptyString;
    gRBBIEmptyString = nullptr;
...
static void U_CALLCONV rbbiInit() {
    gRBBIEmptyString = new UnicodeString();
