...
_enumPropertyStartsRangeUBIDI(const void *context, UChar32 start, UChar32 end, uint32_t value) {
    (void)end;
    (void)value;
...
ubidi_addPropertyStarts(const USetAdder *sa, UErrorCode *pErrorCode) {
    ...
    utrie2_enum(&ubidi_props_singleton.trie, NULL, _enumPropertyStartsRangeUBIDI, sa);
