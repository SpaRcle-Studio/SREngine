...
_enumPropertyStartsRangeUCASE(const void *context, UChar32 start, UChar32 /*end*/, uint32_t /*value*/) {
...
ucase_addPropertyStarts(const USetAdder *sa, UErrorCode *pErrorCode) {
    ...
    utrie2_enum(&ucase_props_singleton.trie, NULL, _enumPropertyStartsRangeUCASE, sa);
