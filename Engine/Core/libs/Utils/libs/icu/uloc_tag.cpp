...
static const char EMPTY_ULOC_TAG[] = "";
...
_initializeULanguageTag(ULanguageTag* langtag) {
    ...
    langtag->language = EMPTY_ULOC_TAG;
    for (i = 0; i < MAXEXTLANG; i++) {
        langtag->extlang[i] = NULL;
    }

    langtag->script = EMPTY_ULOC_TAG;
    langtag->region = EMPTY_ULOC_TAG;

    langtag->variants = NULL;
    langtag->extensions = NULL;

    langtag->legacy = EMPTY_ULOC_TAG;
    langtag->privateuse = EMPTY_ULOC_TAG;
}
