...
#ifndef SR_ENGINE_DEBUGDRAW_H
#define SR_ENGINE_DEBUGDRAW_H
...
namespace SR_UTILS_NS {
    ...
    public:
        ...
        using DrawConvexMeshCallback = SR_HTYPES_NS::Function<uint64_t(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale, const SR_MATH_NS::FColor& color, float_t time)>;
        ...
        struct Callbacks {
            ...
            DrawConvexMeshCallback drawConvexMeshCallback;
        };
    ...
    public:
        ...
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale, const SR_MATH_NS::FColor& color, float_t time);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale, const SR_MATH_NS::FColor& color);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::FColor& color, float_t time);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::FColor& color);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos, float_t time);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id, const SR_MATH_NS::FVector3& pos);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale, const SR_MATH_NS::FColor& color, float_t time);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale, const SR_MATH_NS::FColor& color);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot, const SR_MATH_NS::FVector3& scale);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::Quaternion& rot);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::FColor& color, float_t time);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, const SR_MATH_NS::FColor& color);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos, float_t time);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, const SR_MATH_NS::FVector3& pos);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId, uint64_t id);
        uint64_t DrawConvexMesh(SR_HTYPES_NS::RawMesh* pRawMesh, int32_t meshId);
