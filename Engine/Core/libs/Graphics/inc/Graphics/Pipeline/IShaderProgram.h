...
namespace SR_GRAPH_NS {
    ...
    static constexpr uint64_t SHADER_SLICED_TEXTURE_BORDER = SR_COMPILE_TIME_CRC32_STR("SLICED_TEXTURE_BORDER");
    static constexpr uint64_t SHADER_SLICED_WINDOW_BORDER = SR_COMPILE_TIME_CRC32_STR("SLICED_WINDOW_BORDER");
