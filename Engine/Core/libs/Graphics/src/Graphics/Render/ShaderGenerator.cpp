...
#include <Graphics/Render/ShaderGenerator.h>
...
{
    auto modulesFolder = Framework::Helper::ResourceManager::Instance().GetResPath().Concat("/Shaders/Modules/").Concat(name).Concat("/");
