...
namespace SR_GRAPH_GUI_NS {
    bool DrawStandardProperty(SR_UTILS_NS::StandardProperty* pProperty) {
        const bool isReadOnly = pProperty->GetPublicity() == SR_UTILS_NS::PropertyPublicity::ReadOnly;
        ...
        switch (pProperty->GetStandardType()) {
            ...
            case SR_UTILS_NS::StandardType::Path:
    ...
    bool DrawProperty(SR_UTILS_NS::Property* pProperty) {
        ...
        if (auto&& pStandardProperty = dynamic_cast<SR_UTILS_NS::StandardProperty*>(pProperty)) {
            return DrawStandardProperty(pStandardProperty);
        }
