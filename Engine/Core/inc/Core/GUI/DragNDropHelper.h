...
namespace SR_CORE_GUI_NS {
    ...
    SR_MAYBE_UNUSED bool DragDropTargetEntityRef(EditorGUI* pContext, SR_UTILS_NS::EntityRef& entityRef, const char* payloadType, const char* id, int32_t index, float_t width = 300.f);
}
