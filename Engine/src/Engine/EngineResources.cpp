...
namespace SR_CORE_NS::Resources {
    bool RegisterResources(const SR_HTYPES_NS::SharedPtr<Engine>& pEngine) {
        ...
        // resourcesManager.RegisterReloader<SR_SCRIPTING_NS::EvoBehaviour,
        // SR_SCRIPTING_NS::EvoScriptResourceReloader>();
        ...
        resourcesManager.RegisterReloader<SR_GRAPH_NS::FileMaterialResource, SR_CORE_NS::GraphicsResourceReloader>(
            contextGetter
        );
