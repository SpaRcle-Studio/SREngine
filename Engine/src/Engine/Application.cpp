...
namespace SR_CORE_NS {
        ...
        : Super(this, SR_UTILS_NS::SharedPtrPolicy::Automatic)
    {
        std::vector<std::string> paths {
            // кастомщина
            "Engine/Configs/Tags.xml",
            "Engine/Configs/Layers.xml",
            "Engine/Bin/..//Layers.xml",
            "Engine/Bin/../Layers.xml",
            "Engine/Configs/LogLevels.xml",
            "Engine/../LogLevels.xml",
            "C:/../LogLevels.xml",
            "C:/../some/../LogLevels.xml",
            "C:/some/../LogLevels.xml",
            "C:/some/LogLevels.xml",
            "/some/LogLevels.xml",
            "/../LogLevels.xml",
            ...
            // относительные нормальные
            "Engine/Configs/Tags.xml",
            "Engine/Configs/Layers.xml",
            "Engine/Configs/LogLevels.xml",

            // относительные с подъемами
            "Engine/Bin/..//Layers.xml",
            "Engine/Bin/../Layers.xml",
            "Engine/../LogLevels.xml",
            ...
            // абсолютные unix пути
            "/some/LogLevels.xml",
            "/some/../LogLevels.xml",
            "/../LogLevels.xml",

            // относительные с точками
            "./some/../LogLevels.xml",
            "./some/LogLevels.xml",
            "./LogLevels.xml",
            ...
            // комбинации точек и подъемов
            "foo/./../bar",
            "C:/foo/.././bar",
            "/foo/.././bar",

            // путь без сегментов, но с диском
            "C:",
            "C:.",
            "C:..",
            ...
            // подряд несколько слэшей
            "foo//bar///baz"
        };

        //static const std::vector<std::string> potentialPaths = { "", "..", "../..", "../../..", "../../../.." };
        //for (const auto& potentialPath : potentialPaths) {
        //    std::string exePathes = {
        //        "C:/bin/res/2/name.exe",
        //    };
        //
        //}
        ...
        /*for (auto& path : paths) {
            std::cout << path << "\t\t";
            auto def = SR_UTILS_NS::Path(path).ToString();

            SR_UTILS_NS::FileSystem::NormalizePathInPlace(path);
            std::cout << path << std::endl;
            if (def != path) {
                std::cout << "FAILED: '" << def << "'" << std::endl;
            }
            else {
