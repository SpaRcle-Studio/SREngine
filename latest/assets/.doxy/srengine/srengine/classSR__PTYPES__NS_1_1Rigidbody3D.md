...
|  void | [**AddForce**](#function-addforce) (const SR\_MATH\_NS::FVector3 & force) <br> |
|  void | [**AddLinearVelocity**](#function-addlinearvelocity) (const SR\_MATH\_NS::FVector3 & velocity) <br> |
|  void | [**AddTorque**](#function-addtorque) (const SR\_MATH\_NS::FVector3 & torque) <br> |
...
```C++
void SR_PTYPES_NS::Rigidbody3D::AddForce (
    const SR_MATH_NS::FVector3 & force
) 
```
...
```C++
void SR_PTYPES_NS::Rigidbody3D::AddTorque (
    const SR_MATH_NS::FVector3 & torque
) 
```
