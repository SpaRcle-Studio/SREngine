...
# Class SR\_CORE\_GUI\_NS::MarginPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**MarginPropertyDrawer**](classSR__CORE__GUI__NS_1_1MarginPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**MarginPropertyDrawer**](classSR__CORE__GUI__NS_1_1MarginPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_CORE_GUI_NS::MarginPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<MarginPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::MarginPropertyDrawer::Draw (
...
------------------------------
The documentation for this class was generated from the following file `Engine/inc/Engine/GUI/PropertyDrawers/RectPropertyDrawer.h`
