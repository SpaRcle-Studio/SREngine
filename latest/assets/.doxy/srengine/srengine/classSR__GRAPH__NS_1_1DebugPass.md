...
# Class SR\_GRAPH\_NS::DebugPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**DebugPass**](classSR__GRAPH__NS_1_1DebugPass.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**BuildQueues**](#function-buildqueues) () <br> |
| virtual void | [**DeInit**](#function-deinit) () override<br> |
|  void | [**DrawQueue**](#function-drawqueue) ([**Pipeline**](classSR__GRAPH__NS_1_1Pipeline.md) & pipeline, const std::vector&lt; [**DebugRenderer::DrawInfo**](structSR__GRAPH__NS_1_1DebugRenderer_1_1DrawInfo.md) &gt; & queue, [**DebugPassShaderInfo**](structSR__GRAPH__NS_1_1DebugPassShaderInfo.md) & shaderInfo, uint32\_t indicesCount) <br> |
...
|  void | [**UpdateUBO**](#function-updateubo) ([**DebugPassShaderInfo**](structSR__GRAPH__NS_1_1DebugPassShaderInfo.md) & shaderInfo, DebugRenderer::DrawType type) <br> |
...
```C++
void SR_GRAPH_NS::DebugPass::BuildQueues () 
```
...
```C++
virtual void SR_GRAPH_NS::DebugPass::DeInit () override
```
...
```C++
void SR_GRAPH_NS::DebugPass::DrawQueue (
    Pipeline & pipeline,
    const std::vector< DebugRenderer::DrawInfo > & queue,
    DebugPassShaderInfo & shaderInfo,
...
```C++
virtual bool SR_GRAPH_NS::DebugPass::Init () override
```
...
```C++
virtual void SR_GRAPH_NS::DebugPass::OnResize (
...
```C++
virtual void SR_GRAPH_NS::DebugPass::Prepare () override
```
...
```C++
virtual bool SR_GRAPH_NS::DebugPass::Render () override
```
...
```C++
virtual void SR_GRAPH_NS::DebugPass::Update () override
```
...
```C++
void SR_GRAPH_NS::DebugPass::UpdateUBO (
    DebugPassShaderInfo & shaderInfo,
    DebugRenderer::DrawType type
) 
```
