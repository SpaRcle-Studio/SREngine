...
# Class SR\_SRLM\_NS::ConvertorNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**ConvertorNode**](classSR__SRLM__NS_1_1ConvertorNode.md)
...
Inherits the following classes: [SR\_SRLM\_NS::IComputeNode](classSR__SRLM__NS_1_1IComputeNode.md)
...
|  SR\_NODISCARD uint64\_t | [**GetInputHashName**](#function-getinputhashname) () noexcept const<br> |
|  SR\_NODISCARD std::string | [**GetInputTypeName**](#function-getinputtypename) () noexcept const<br> |
...
|  SR\_NODISCARD uint64\_t | [**GetOutputHashName**](#function-getoutputhashname) () noexcept const<br> |
|  SR\_NODISCARD std::string | [**GetOutputTypeName**](#function-getoutputtypename) () noexcept const<br> |
| virtual void | [**InitNode**](#function-initnode) () override<br> |
|  void | [**SetInitInputTypeHashName**](#function-setinitinputtypehashname) (uint64\_t hashName) <br> |
|  void | [**SetInitOutputTypeHashName**](#function-setinitoutputtypehashname) (uint64\_t hashName) <br> |


## Public Functions inherited from SR_SRLM_NS::IComputeNode

See [SR\_SRLM\_NS::IComputeNode](classSR__SRLM__NS_1_1IComputeNode.md)

| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD const [**DataType**](classSR__SRLM__NS_1_1DataType.md) \* | [**GetOutput**](classSR__SRLM__NS_1_1IComputeNode.md#function-getoutput) (uint32\_t index) override<br> |
| virtual void | [**MarkDirty**](classSR__SRLM__NS_1_1IComputeNode.md#function-markdirty) () override<br> |
...
## Protected Types inherited from SR_SRLM_NS::IComputeNode

See [SR\_SRLM\_NS::IComputeNode](classSR__SRLM__NS_1_1IComputeNode.md)

| Type | Name |
| ---: | :--- |
| typedef [**IExecutableNode**](classSR__SRLM__NS_1_1IExecutableNode.md) | [**Base**](classSR__SRLM__NS_1_1IComputeNode.md#typedef-base)  <br> |
...
## Protected Attributes inherited from SR_SRLM_NS::IComputeNode

See [SR\_SRLM\_NS::IComputeNode](classSR__SRLM__NS_1_1IComputeNode.md)

| Type | Name |
| ---: | :--- |
|  bool | [**m\_dirty**](classSR__SRLM__NS_1_1IComputeNode.md#variable-m_dirty)   = `true`<br> |
...
## Protected Functions inherited from SR_SRLM_NS::IComputeNode

See [SR\_SRLM\_NS::IComputeNode](classSR__SRLM__NS_1_1IComputeNode.md)

| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD LogicalNodeType | [**GetType**](classSR__SRLM__NS_1_1IComputeNode.md#function-gettype) () noexcept const<br> |
| virtual SR\_NODISCARD bool | [**IsDirty**](classSR__SRLM__NS_1_1IComputeNode.md#function-isdirty) () noexcept override const<br> |
...
```C++
virtual void SR_SRLM_NS::ConvertorNode::Execute (
    float_t dt
) override
```
...
### function GetInputHashName 

```C++
SR_NODISCARD uint64_t SR_SRLM_NS::ConvertorNode::GetInputHashName () noexcept const
```
...
```C++
SR_NODISCARD std::string SR_SRLM_NS::ConvertorNode::GetInputTypeName () noexcept const
```
...
```C++
virtual SR_NODISCARD uint64_t SR_SRLM_NS::ConvertorNode::GetNodeHashName () noexcept override const
```



Implements [*SR\_SRLM\_NS::LogicalNode::GetNodeHashName*](classSR__SRLM__NS_1_1LogicalNode.md#function-getnodehashname)
...
```C++
virtual SR_NODISCARD std::string SR_SRLM_NS::ConvertorNode::GetNodeName () noexcept override const
```



Implements [*SR\_SRLM\_NS::LogicalNode::GetNodeName*](classSR__SRLM__NS_1_1LogicalNode.md#function-getnodename)
...
### function GetOutputHashName 

```C++
SR_NODISCARD uint64_t SR_SRLM_NS::ConvertorNode::GetOutputHashName () noexcept const
```
...
```C++
SR_NODISCARD std::string SR_SRLM_NS::ConvertorNode::GetOutputTypeName () noexcept const
```
...
```C++
virtual void SR_SRLM_NS::ConvertorNode::InitNode () override
```
...
### function SetInitInputTypeHashName 

```C++
inline void SR_SRLM_NS::ConvertorNode::SetInitInputTypeHashName (
    uint64_t hashName
) 
```
...
### function SetInitOutputTypeHashName 

```C++
inline void SR_SRLM_NS::ConvertorNode::SetInitOutputTypeHashName (
    uint64_t hashName
) 
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/SRLM/ConvertorNode.h`
