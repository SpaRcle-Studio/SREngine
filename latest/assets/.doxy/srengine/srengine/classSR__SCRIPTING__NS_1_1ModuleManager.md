...
# Class SR\_SCRIPTING\_NS::ModuleManager



[**ClassList**](annotated.md) **>** [**SR\_SCRIPTING\_NS**](namespaceSR__SCRIPTING__NS.md) **>** [**ModuleManager**](classSR__SCRIPTING__NS_1_1ModuleManager.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**CppBehaviourInstance**](classSR__SCRIPTING__NS_1_1CppBehaviourInstance.md) \* | [**AllocateBehaviourInstance**](#function-allocatebehaviourinstance) (const [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) & behaviourName) <br> |
|  void | [**FreeBehaviourInstance**](#function-freebehaviourinstance) ([**CppBehaviourInstance**](classSR__SCRIPTING__NS_1_1CppBehaviourInstance.md) \* pInstance) <br> |
|  bool | [**Init**](#function-init) () <br> |
|   | [**ModuleManager**](#function-modulemanager) ([**ScriptSystem**](classSR__SCRIPTING__NS_1_1ScriptSystem.md) \* pScriptSystem) <br> |
|  SR\_NODISCARD bool | [**ReloadModule**](#function-reloadmodule) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
|   | [**~ModuleManager**](#function-modulemanager) () override<br> |
...
### function AllocateBehaviourInstance 

```C++
SR_NODISCARD CppBehaviourInstance * SR_SCRIPTING_NS::ModuleManager::AllocateBehaviourInstance (
    const SR_UTILS_NS::StringAtom & behaviourName
) 
```
...
### function FreeBehaviourInstance 

```C++
void SR_SCRIPTING_NS::ModuleManager::FreeBehaviourInstance (
    CppBehaviourInstance * pInstance
) 
```
...
```C++
bool SR_SCRIPTING_NS::ModuleManager::Init () 
```
...
```C++
inline SR_SCRIPTING_NS::ModuleManager::ModuleManager (
...
```C++
SR_NODISCARD bool SR_SCRIPTING_NS::ModuleManager::ReloadModule (
...
```C++
SR_SCRIPTING_NS::ModuleManager::~ModuleManager () override
```
