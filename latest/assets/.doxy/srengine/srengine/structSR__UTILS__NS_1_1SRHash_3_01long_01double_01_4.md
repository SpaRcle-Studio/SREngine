...
# Struct SR\_UTILS\_NS::SRHash&lt; long double &gt;

**template &lt;&gt;**



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**SRHash&lt; long double &gt;**](structSR__UTILS__NS_1_1SRHash_3_01long_01double_01_4.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD constexpr size\_t | [**operator()**](#function-operator()) (const long double keyVal) noexcept const<br> |
...
| Type | Name |
| ---: | :--- |
|  uint64\_t | [**DoHash**](#function-dohash) (const long double & value) noexcept<br> |
...
```C++
inline SR_NODISCARD constexpr size_t SR_UTILS_NS::SRHash< long double >::operator() (
    const long double keyVal
) noexcept const
```
...
```C++
static inline uint64_t SR_UTILS_NS::SRHash< long double >::DoHash (
