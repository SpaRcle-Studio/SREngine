...
# Class SR\_CORE\_GUI\_NS::CreateNewProject



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**CreateNewProject**](classSR__CORE__GUI__NS_1_1CreateNewProject.md)
...
| Type | Name |
| ---: | :--- |
|   | [**CreateNewProject**](#function-createnewproject) () <br> |
...
```C++
SR_CORE_GUI_NS::CreateNewProject::CreateNewProject () 
```
...
```C++
virtual void SR_CORE_GUI_NS::CreateNewProject::Draw () override
```
...
```C++
virtual void SR_CORE_GUI_NS::CreateNewProject::OnOpen () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/inc/Engine/GUI/CreateNewProject.h`
