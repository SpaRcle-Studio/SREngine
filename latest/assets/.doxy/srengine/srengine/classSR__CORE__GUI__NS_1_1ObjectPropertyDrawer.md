...
# Class SR\_CORE\_GUI\_NS::ObjectPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**ObjectPropertyDrawer**](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md)
...
Inherited by the following classes: [SR\_CORE\_GUI\_NS::MaterialDataPropertyDrawer](classSR__CORE__GUI__NS_1_1MaterialDataPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**ObjectPropertyDrawer**](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**DrawCustomProperties**](#function-drawcustomproperties) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) <br> |
...
```C++
using SR_CORE_GUI_NS::ObjectPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<ObjectPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::ObjectPropertyDrawer::Draw (
...
```C++
inline virtual PropertyDrawerFeedback SR_CORE_GUI_NS::ObjectPropertyDrawer::DrawCustomProperties (
    const PropertyDrawerContext & context
) 
```
