...
# Class SR\_CORE\_GUI\_NS::MaterialDataPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**MaterialDataPropertyDrawer**](classSR__CORE__GUI__NS_1_1MaterialDataPropertyDrawer.md)
...
|   | [**MaterialDataPropertyDrawer**](#function-materialdatapropertydrawer) () <br> |
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::MaterialDataPropertyDrawer::DrawCustomProperties (
...
### function MaterialDataPropertyDrawer 

```C++
SR_CORE_GUI_NS::MaterialDataPropertyDrawer::MaterialDataPropertyDrawer () 
```
