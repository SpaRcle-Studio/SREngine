...
# Class SR\_SRLM\_NS::CreateStructNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**CreateStructNode**](classSR__SRLM__NS_1_1CreateStructNode.md)
...
|  void | [**SetStructHashName**](#function-setstructhashname) (uint64\_t hash) <br> |
...
```C++
virtual void SR_SRLM_NS::CreateStructNode::Execute (
    float_t dt
) override
```
...
```C++
virtual void SR_SRLM_NS::CreateStructNode::InitNode () override
```
...
```C++
inline void SR_SRLM_NS::CreateStructNode::SetStructHashName (
    uint64_t hash
) 
```
