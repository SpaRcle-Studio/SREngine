...
# Class SR\_ANIMATIONS\_NS::Animator



[**ClassList**](annotated.md) **>** [**SR\_ANIMATIONS\_NS**](namespaceSR__ANIMATIONS__NS.md) **>** [**Animator**](classSR__ANIMATIONS__NS_1_1Animator.md)
...
|  SR\_NODISCARD [**AnimationGraph**](classSR__ANIMATIONS__NS_1_1AnimationGraph.md) \* | [**GetGraph**](#function-getgraph) () noexcept const<br> |
|  SR\_NODISCARD [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) | [**GetGraphPath**](#function-getgraphpath) () noexcept const<br> |
|  SR\_NODISCARD [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Skeleton**](classSR__ANIMATIONS__NS_1_1Skeleton.md) &gt; & | [**GetSkeleton**](#function-getskeleton) () noexcept<br> |
...
|  void | [**SetGraph**](#function-setgraph) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
| virtual void | [**Start**](#function-start) () override<br> |
| virtual void | [**Update**](#function-update) (float\_t dt) override<br> |
|   | [**~Animator**](#function-animator) () override<br> |
...
```C++
virtual void SR_ANIMATIONS_NS::Animator::FixedUpdate () override
```
...
```C++
inline SR_NODISCARD AnimationGraph * SR_ANIMATIONS_NS::Animator::GetGraph () noexcept const
```
...
```C++
SR_NODISCARD SR_UTILS_NS::Path SR_ANIMATIONS_NS::Animator::GetGraphPath () noexcept const
```
...
```C++
inline SR_NODISCARD SR_HTYPES_NS::SharedPtr < Skeleton > & SR_ANIMATIONS_NS::Animator::GetSkeleton () noexcept
```
...
```C++
virtual void SR_ANIMATIONS_NS::Animator::OnAttached () override
```
...
```C++
virtual void SR_ANIMATIONS_NS::Animator::OnDestroy () override
```
...
```C++
void SR_ANIMATIONS_NS::Animator::SetGraph (
...
```C++
virtual void SR_ANIMATIONS_NS::Animator::Start () override
```
...
```C++
virtual void SR_ANIMATIONS_NS::Animator::Update (
    float_t dt
) override
```
...
```C++
SR_ANIMATIONS_NS::Animator::~Animator () override
```
