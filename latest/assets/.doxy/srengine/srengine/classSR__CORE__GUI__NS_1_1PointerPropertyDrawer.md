...
# Class SR\_CORE\_GUI\_NS::PointerPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**PointerPropertyDrawer**](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md)
...
Inherited by the following classes: [SR\_CORE\_GUI\_NS::MaterialPropertyDrawer](classSR__CORE__GUI__NS_1_1MaterialPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**PointerPropertyDrawer**](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| virtual void | [**OnObjectReplaced**](#function-onobjectreplaced) (SRClass \* pOld, SRClass \* pNew) <br> |
...
```C++
using SR_CORE_GUI_NS::PointerPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<PointerPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::PointerPropertyDrawer::Draw (
...
```C++
inline virtual void SR_CORE_GUI_NS::PointerPropertyDrawer::OnObjectReplaced (
    SRClass * pOld,
    SRClass * pNew
) 
```
