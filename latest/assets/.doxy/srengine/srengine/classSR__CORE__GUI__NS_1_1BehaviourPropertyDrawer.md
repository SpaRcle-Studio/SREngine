...
# Class SR\_CORE\_GUI\_NS::BehaviourPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**BehaviourPropertyDrawer**](classSR__CORE__GUI__NS_1_1BehaviourPropertyDrawer.md)
...
Inherits the following classes: [SR\_CORE\_GUI\_NS::ObjectPropertyDrawer](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md)
...
## Public Types inherited from SR_CORE_GUI_NS::ObjectPropertyDrawer

See [SR\_CORE\_GUI\_NS::ObjectPropertyDrawer](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md)

| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**ObjectPropertyDrawer**](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md) &gt; | [**Ptr**](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md#typedef-ptr)  <br> |


## Public Types inherited from SR_CORE_GUI_NS::PropertyDrawerBase

See [SR\_CORE\_GUI\_NS::PropertyDrawerBase](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md)

| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**PropertyDrawerBase**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md) &gt; | [**Ptr**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**BehaviourPropertyDrawer**](#function-behaviourpropertydrawer) () <br> |
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**DrawCustomProperties**](#function-drawcustomproperties) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) override<br> |


## Public Functions inherited from SR_CORE_GUI_NS::ObjectPropertyDrawer

See [SR\_CORE\_GUI\_NS::ObjectPropertyDrawer](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md)

| Type | Name |
| ---: | :--- |
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**Draw**](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md#function-draw) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) override<br> |
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**DrawCustomProperties**](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md#function-drawcustomproperties) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) <br> |


## Public Functions inherited from SR_CORE_GUI_NS::PropertyDrawerBase

See [SR\_CORE\_GUI\_NS::PropertyDrawerBase](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md)

| Type | Name |
| ---: | :--- |
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**Draw**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-draw) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) = 0<br> |
|   | [**PropertyDrawerBase**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-propertydrawerbase) () <br> |
...
## Public Static Functions inherited from SR_CORE_GUI_NS::PropertyDrawerBase

See [SR\_CORE\_GUI\_NS::PropertyDrawerBase](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md)

| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD bool | [**CheckSearchMatch**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-checksearchmatch) (std::string\_view searchBuffer, std::string\_view text) <br> |
...
## Protected Functions inherited from SR_CORE_GUI_NS::PropertyDrawerBase

See [SR\_CORE\_GUI\_NS::PropertyDrawerBase](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md)

| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD SR\_GRAPH\_NS::RenderContext::Ptr | [**GetRenderContext**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-getrendercontext) () const<br> |
...
## Protected Static Functions inherited from SR_CORE_GUI_NS::PropertyDrawerBase

See [SR\_CORE\_GUI\_NS::PropertyDrawerBase](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md)

| Type | Name |
| ---: | :--- |
|  void | [**SetMappedValue**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-setmappedvalue) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context, [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) & feedback, MappedVal pMapped, NewVal value, bool drag=false) <br> |
|  void | [**SetReflectedValue**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-setreflectedvalue) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context, [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) & feedback, const [**SR\_UTILS\_NS::Reflection::Value**](classSR__UTILS__NS_1_1Reflection_1_1Value.md) & value, bool drag=false) <br> |
|  void | [**SetValue**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-setvalue) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context, const [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) & feedback, const [**SR\_UTILS\_NS::Reflection::Value**](classSR__UTILS__NS_1_1Reflection_1_1Value.md) & value) <br> |
...
### function BehaviourPropertyDrawer 

```C++
SR_CORE_GUI_NS::BehaviourPropertyDrawer::BehaviourPropertyDrawer () 
```
...
### function DrawCustomProperties 

```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::BehaviourPropertyDrawer::DrawCustomProperties (
...
Implements [*SR\_CORE\_GUI\_NS::ObjectPropertyDrawer::DrawCustomProperties*](classSR__CORE__GUI__NS_1_1ObjectPropertyDrawer.md#function-drawcustomproperties)


<hr>

------------------------------
The documentation for this class was generated from the following file `Engine/Core/inc/Core/GUI/PropertyDrawers/BehaviourPropertyDrawer.h`
