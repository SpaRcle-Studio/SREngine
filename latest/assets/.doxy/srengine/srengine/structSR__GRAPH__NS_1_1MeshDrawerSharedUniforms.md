...
# Struct SR\_GRAPH\_NS::MeshDrawerSharedUniforms



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**MeshDrawerSharedUniforms**](structSR__GRAPH__NS_1_1MeshDrawerSharedUniforms.md)
...
| Type | Name |
| ---: | :--- |
|  bool | [**camera**](#variable-camera)   = `true`<br> |
|  bool | [**light**](#variable-light)   = `true`<br> |
|  bool | [**time**](#variable-time)   = `true`<br> |
|  std::set&lt; [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) &gt; | [**useFromPass**](#variable-usefrompass)  <br> |
...
```C++
bool SR_GRAPH_NS::MeshDrawerSharedUniforms::camera;
```
...
```C++
bool SR_GRAPH_NS::MeshDrawerSharedUniforms::light;
```
...
```C++
bool SR_GRAPH_NS::MeshDrawerSharedUniforms::time;
```
...
### variable useFromPass 

```C++
std::set<SR_UTILS_NS::StringAtom> SR_GRAPH_NS::MeshDrawerSharedUniforms::useFromPass;
```
