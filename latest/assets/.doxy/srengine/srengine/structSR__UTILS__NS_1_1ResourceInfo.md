...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**IResource**](classSR__UTILS__NS_1_1IResource.md) \* | [**GetFirstResource**](#function-getfirstresource) () const<br> |
|  SR\_NODISCARD [**IResourceReloader**](classSR__UTILS__NS_1_1IResourceReloader.md) \* | [**GetReloader**](#function-getreloader) () const<br> |
|  SR\_NODISCARD [**IResource**](classSR__UTILS__NS_1_1IResource.md) \* | [**GetResource**](#function-getresource) () const<br> |
...
```C++
SR_NODISCARD IResource * SR_UTILS_NS::ResourceInfo::GetFirstResource () const
```
...
```C++
SR_NODISCARD IResource * SR_UTILS_NS::ResourceInfo::GetResource () const
```
