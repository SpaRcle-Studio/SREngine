...
# Class SR\_CORE\_NS::ProjectSettings



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**ProjectSettings**](classSR__CORE__NS_1_1ProjectSettings.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**ProjectSettings**](classSR__CORE__NS_1_1ProjectSettings.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**projectName**](#variable-projectname)   = `"New Project"`<br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_INLINE const char \* | [**EXTENSION\_NAME**](#variable-extension_name)   = `"srproject"`<br> |
...
```C++
using SR_CORE_NS::ProjectSettings::Ptr =  SR_HTYPES_NS::SharedPtr<ProjectSettings>;
```
...
```C++
SR_UTILS_NS::StringAtom SR_CORE_NS::ProjectSettings::projectName;
```
...
```C++
SR_INLINE const char* SR_CORE_NS::ProjectSettings::EXTENSION_NAME;
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/inc/Engine/Settings/ProjectSettings.h`
