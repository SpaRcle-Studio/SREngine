...
# Class SR\_UTILS\_NS::AutoTests::ManuallySharedPtrTestClass



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**AutoTests**](namespaceSR__UTILS__NS_1_1AutoTests.md) **>** [**ManuallySharedPtrTestClass**](classSR__UTILS__NS_1_1AutoTests_1_1ManuallySharedPtrTestClass.md)
...
Inherited by the following classes: [SR\_UTILS\_NS::AutoTests::ManuallySharedPtrTestClassInherit](classSR__UTILS__NS_1_1AutoTests_1_1ManuallySharedPtrTestClassInherit.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**DoSomething**](#function-dosomething) () <br> |
|   | [**ManuallySharedPtrTestClass**](#function-manuallysharedptrtestclass) () <br> |
| virtual  | [**~ManuallySharedPtrTestClass**](#function-manuallysharedptrtestclass) () = default<br> |
...
```C++
inline void SR_UTILS_NS::AutoTests::ManuallySharedPtrTestClass::DoSomething () 
```
...
### function ManuallySharedPtrTestClass 

```C++
inline SR_UTILS_NS::AutoTests::ManuallySharedPtrTestClass::ManuallySharedPtrTestClass () 
```
...
```C++
virtual SR_UTILS_NS::AutoTests::ManuallySharedPtrTestClass::~ManuallySharedPtrTestClass () = default
```
