...
# Class SR\_CORE\_NS::ChunkSystemState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**ChunkSystemState**](classSR__CORE__NS_1_1ChunkSystemState.md)
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::ChunkSystemState::ExecuteImpl () override
```
