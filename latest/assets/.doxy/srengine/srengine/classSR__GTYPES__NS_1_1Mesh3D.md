...
# Class SR\_GTYPES\_NS::Mesh3D



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**Mesh3D**](classSR__GTYPES__NS_1_1Mesh3D.md)
...
|   | [**Mesh3D**](#function-mesh3d) () = default<br> |
...
```C++
typedef Vertices::StaticMeshVertex SR_GTYPES_NS::Mesh3D::VertexType;
```
...
```C++
virtual SR_NODISCARD const SR_HTYPES_NS::FastMemoryArray < uint32_t > & SR_GTYPES_NS::Mesh3D::GetIndices () override const
```
...
```C++
virtual SR_NODISCARD std::string SR_GTYPES_NS::Mesh3D::GetMeshIdentifier () override const
```
...
```C++
inline virtual SR_NODISCARD MeshType SR_GTYPES_NS::Mesh3D::GetMeshType () noexcept override const
```
...
```C++
virtual SR_NODISCARD bool SR_GTYPES_NS::Mesh3D::IsCalculatable () override const
```
...
```C++
SR_GTYPES_NS::Mesh3D::Mesh3D () = default
```
...
```C++
virtual void SR_GTYPES_NS::Mesh3D::OnRawMeshChanged () override
```
...
```C++
virtual bool SR_GTYPES_NS::Mesh3D::OnResourceReloaded (
...
```C++
virtual void SR_GTYPES_NS::Mesh3D::UseMaterial () override
```
...
```C++
virtual void SR_GTYPES_NS::Mesh3D::UseModelMatrix () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Types/Geometry/Mesh3D.h`
