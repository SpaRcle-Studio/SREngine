...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**ResourceContainer**](classSR__UTILS__NS_1_1ResourceContainer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  void | [**AddDependency**](#function-adddependency) (const ResourceContainer::Ptr & pContainer) <br> |
|  SR\_NODISCARD const std::unordered\_set&lt; ResourceContainer::Ptr &gt; & | [**GetContainerParents**](#function-getcontainerparents) () const<br> |
|  void | [**RemoveDependency**](#function-removedependency) (const ResourceContainer::Ptr & pContainer) <br> |
...
```C++
using SR_UTILS_NS::ResourceContainer::Ptr =  SR_HTYPES_NS::SharedPtr<ResourceContainer>;
```
...
void SR_UTILS_NS::ResourceContainer::AddDependency (
    const ResourceContainer::Ptr & pContainer
) 
```
...
```C++
inline SR_NODISCARD const std::unordered_set< ResourceContainer::Ptr > & SR_UTILS_NS::ResourceContainer::GetContainerParents () const
```
...
```C++
SR_UTILS_NS::ResourceContainer::ResourceContainer () 
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Utils/inc/Utils/Resources/ResourceContainer.h`
