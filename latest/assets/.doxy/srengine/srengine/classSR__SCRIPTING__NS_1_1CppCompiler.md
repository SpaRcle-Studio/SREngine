...
# Class SR\_SCRIPTING\_NS::CppCompiler



[**ClassList**](annotated.md) **>** [**SR\_SCRIPTING\_NS**](namespaceSR__SCRIPTING__NS.md) **>** [**CppCompiler**](classSR__SCRIPTING__NS_1_1CppCompiler.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**CppCompiler**](classSR__SCRIPTING__NS_1_1CppCompiler.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD bool | [**Compile**](#function-compile) (const [**CppCompilerContext**](structSR__SCRIPTING__NS_1_1CppCompilerContext.md) & context) <br> |
|   | [**CppCompiler**](#function-cppcompiler) ([**ScriptSystem**](classSR__SCRIPTING__NS_1_1ScriptSystem.md) \* pScriptSystem) <br> |
|  SR\_NODISCARD std::string | [**GetCompilerVersion**](#function-getcompilerversion) () const<br> |
|  SR\_NODISCARD bool | [**Init**](#function-init) () <br> |
|  SR\_NODISCARD bool | [**IsCompilerAvailable**](#function-iscompileravailable) () const<br> |
|   | [**~CppCompiler**](#function-cppcompiler) () override<br> |
...
```C++
using SR_SCRIPTING_NS::CppCompiler::Ptr =  SR_HTYPES_NS::SharedPtr<CppCompiler>;
```
...
```C++
SR_NODISCARD bool SR_SCRIPTING_NS::CppCompiler::Compile (
    const CppCompilerContext & context
) 
```
...
```C++
inline SR_SCRIPTING_NS::CppCompiler::CppCompiler (
...
```C++
SR_NODISCARD std::string SR_SCRIPTING_NS::CppCompiler::GetCompilerVersion () const
```
...
```C++
SR_NODISCARD bool SR_SCRIPTING_NS::CppCompiler::Init () 
```
...
```C++
SR_NODISCARD bool SR_SCRIPTING_NS::CppCompiler::IsCompilerAvailable () const
```
...
```C++
SR_SCRIPTING_NS::CppCompiler::~CppCompiler () override
```
