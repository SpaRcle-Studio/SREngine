...
# Class SR\_GRAPH\_NS::ProbeLight



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**ProbeLight**](classSR__GRAPH__NS_1_1ProbeLight.md)
...
```C++
float_t SR_GRAPH_NS::ProbeLight::m_distance;
```
...
```C++
float_t SR_GRAPH_NS::ProbeLight::m_radius;
```
