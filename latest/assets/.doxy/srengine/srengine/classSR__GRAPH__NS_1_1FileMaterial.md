...
|  SR\_NODISCARD void | [**SetMaterialPath**](#function-setmaterialpath) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) noexcept<br> |
...
```C++
SR_NODISCARD void SR_GRAPH_NS::FileMaterial::SetMaterialPath (
