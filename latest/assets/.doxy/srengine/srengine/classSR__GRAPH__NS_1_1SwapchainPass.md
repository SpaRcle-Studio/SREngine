...
```C++
virtual void SR_GRAPH_NS::SwapchainPass::InitNode () override
```
...
```C++
virtual bool SR_GRAPH_NS::SwapchainPass::Load (
...
Implements [*SR\_GRAPH\_NS::GroupPass::Load*](classSR__GRAPH__NS_1_1GroupPass.md#function-load)
...
```C++
virtual void SR_GRAPH_NS::SwapchainPass::Update () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Pass/SwapchainPass.h`
