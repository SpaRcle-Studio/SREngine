...
# Class SR\_GRAPH\_NS::CascadedShadowMapPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**CascadedShadowMapPass**](classSR__GRAPH__NS_1_1CascadedShadowMapPass.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::MeshDrawerPass](classSR__GRAPH__NS_1_1MeshDrawerPass.md)


Inherited by the following classes: [SR\_GRAPH\_NS::VarianceShadowMapPass](classSR__GRAPH__NS_1_1VarianceShadowMapPass.md)
...
|  SR\_NODISCARD uint8\_t | [**GetLayersCount**](classSR__GRAPH__NS_1_1MeshDrawerPass.md#function-getlayerscount) () noexcept const<br> |
...
|  SR\_NODISCARD const [**SR\_SRSL\_NS::ShaderMacrosParams**](structSR__SRSL__NS_1_1ShaderMacrosParams.md) & | [**GetShaderMacros**](classSR__GRAPH__NS_1_1MeshDrawerPass.md#function-getshadermacros) () noexcept const<br> |
...
| virtual void | [**UseSamplers**](classSR__GRAPH__NS_1_1MeshDrawerPass.md#function-usesamplers) ([**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) \* pShader) override<br> |
| virtual void | [**UseSharedUniforms**](classSR__GRAPH__NS_1_1MeshDrawerPass.md#function-useshareduniforms) ([**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) \* pShader) <br> |
| virtual void | [**UseUniforms**](classSR__GRAPH__NS_1_1MeshDrawerPass.md#function-useuniforms) ([**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) \* pShader, MeshPtr pMesh) <br> |
...
### function GetCascadeMatrices 

```C++
inline SR_NODISCARD const std::vector< SR_MATH_NS::Matrix4x4 > & SR_GRAPH_NS::CascadedShadowMapPass::GetCascadeMatrices () const
```
...
### function GetSplitDepths 

```C++
inline SR_NODISCARD const std::vector< float_t > & SR_GRAPH_NS::CascadedShadowMapPass::GetSplitDepths () const
```
...
```C++
virtual void SR_GRAPH_NS::CascadedShadowMapPass::UseConstants (
...
```C++
virtual void SR_GRAPH_NS::CascadedShadowMapPass::UseSharedUniforms (
    SR_GTYPES_NS::Shader * pShader
) override
```
...
```C++
virtual void SR_GRAPH_NS::CascadedShadowMapPass::UseUniformsFromAnotherPass (
    SR_GTYPES_NS::Shader * pShader
) override
```
...
Implements [*SR\_GRAPH\_NS::BasePass::UseUniformsFromAnotherPass*](classSR__GRAPH__NS_1_1BasePass.md#function-useuniformsfromanotherpass)
...
### variable m\_cameraPosition 

```C++
SR_MATH_NS::FVector3 SR_GRAPH_NS::CascadedShadowMapPass::m_cameraPosition;
```
...
### variable m\_cascadeMatrices 

```C++
std::vector<SR_MATH_NS::Matrix4x4> SR_GRAPH_NS::CascadedShadowMapPass::m_cascadeMatrices;
```
...
### variable m\_cascadeRadii 

```C++
std::vector<float_t> SR_GRAPH_NS::CascadedShadowMapPass::m_cascadeRadii;
```
...
### variable m\_cascadeSplitDepths 

```C++
std::vector<float_t> SR_GRAPH_NS::CascadedShadowMapPass::m_cascadeSplitDepths;
```
...
### variable m\_cascadeSplitLambda 

```C++
float_t SR_GRAPH_NS::CascadedShadowMapPass::m_cascadeSplitLambda;
```
...
```C++
float_t SR_GRAPH_NS::CascadedShadowMapPass::m_far;
```
...
```C++
float_t SR_GRAPH_NS::CascadedShadowMapPass::m_near;
```
...
```C++
bool SR_GRAPH_NS::CascadedShadowMapPass::CheckCamera () 
```
