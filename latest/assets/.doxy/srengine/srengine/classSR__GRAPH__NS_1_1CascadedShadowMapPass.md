...
Inherits the following classes: [SR\_GRAPH\_NS::OffScreenMeshDrawerPass](classSR__GRAPH__NS_1_1OffScreenMeshDrawerPass.md)
...
|  float\_t | [**m\_far**](#variable-m_far)   = `0.f`<br> |
|  float\_t | [**m\_near**](#variable-m_near)   = `0.f`<br> |
...
| virtual void | [**UseSharedUniforms**](#function-useshareduniforms) ([**ShaderUseInfo**](structSR__GRAPH__NS_1_1ShaderUseInfo.md) info) override<br> |
...
```C++
virtual bool SR_GRAPH_NS::CascadedShadowMapPass::Load (
