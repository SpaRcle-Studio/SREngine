...
# Class SR\_CORE\_NS::InitializeState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**InitializeState**](classSR__CORE__NS_1_1InitializeState.md)
...
| virtual void | [**FinalizeImpl**](#function-finalizeimpl) () override<br> |
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::InitializeState::ExecuteImpl () override
```
...
```C++
virtual void SR_CORE_NS::InitializeState::FinalizeImpl () override
```



Implements [*SR\_UTILS\_NS::ThreadWorkerStateBase::FinalizeImpl*](classSR__UTILS__NS_1_1ThreadWorkerStateBase.md#function-finalizeimpl)
