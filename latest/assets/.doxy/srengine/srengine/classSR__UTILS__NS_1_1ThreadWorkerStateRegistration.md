...
# Class SR\_UTILS\_NS::ThreadWorkerStateRegistration



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**ThreadWorkerStateRegistration**](classSR__UTILS__NS_1_1ThreadWorkerStateRegistration.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**ThreadWorkerStateBase::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**AllocateState**](#function-allocatestate) ([**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name) <br> |
| virtual bool | [**IsSingletonCanBeDestroyed**](#function-issingletoncanbedestroyed) () override const<br> |
|  bool | [**RegisterState**](#function-registerstate) ([**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name, AllocateFn && allocateFn) <br> |
...
```C++
SR_NODISCARD ThreadWorkerStateBase::Ptr SR_UTILS_NS::ThreadWorkerStateRegistration::AllocateState (
...
```C++
inline virtual bool SR_UTILS_NS::ThreadWorkerStateRegistration::IsSingletonCanBeDestroyed () override const
```
...
```C++
bool SR_UTILS_NS::ThreadWorkerStateRegistration::RegisterState (
    SR_UTILS_NS::StringAtom name,
