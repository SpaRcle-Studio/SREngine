...
# Class SR\_GRAPH\_NS::RenderSettings



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**RenderSettings**](classSR__GRAPH__NS_1_1RenderSettings.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**RenderSettings**](classSR__GRAPH__NS_1_1RenderSettings.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD const [**RenderSettingsPreset**](structSR__GRAPH__NS_1_1RenderSettingsPreset.md) & | [**GetPreset**](#function-getpreset) ([**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name) const<br> |
...
|  [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; AssetT &gt; | [**LoadOrCreate**](classSR__UTILS__NS_1_1Asset.md#function-loadorcreate-12) (const [**Path**](classSR__UTILS__NS_1_1Path.md) & rawPath) <br> |
...
|  SR\_NODISCARD [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; AssetT &gt; | [**LoadOrCreate**](classSR__UTILS__NS_1_1Asset.md#function-loadorcreate-22) (const [**Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
```C++
using SR_GRAPH_NS::RenderSettings::Ptr =  SR_HTYPES_NS::SharedPtr<RenderSettings>;
```
...
```C++
SR_UTILS_NS::StringAtom SR_GRAPH_NS::RenderSettings::appName;
```
...
```C++
SR_UTILS_NS::StringAtom SR_GRAPH_NS::RenderSettings::engineName;
```
...
### variable overlayRenderTechnique 

```C++
SR_UTILS_NS::Path SR_GRAPH_NS::RenderSettings::overlayRenderTechnique;
```
...
```C++
std::vector<RenderSettingsPreset> SR_GRAPH_NS::RenderSettings::presets;
```
...
```C++
SR_NODISCARD const RenderSettingsPreset & SR_GRAPH_NS::RenderSettings::GetPreset (
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Settings/RenderSettings.h`
