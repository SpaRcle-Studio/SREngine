...
# Class SR\_GRAPH\_NS::GroupPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**GroupPass**](classSR__GRAPH__NS_1_1GroupPass.md)
...
Inherited by the following classes: [SR\_GRAPH\_NS::FramebufferPass](classSR__GRAPH__NS_1_1FramebufferPass.md),  [SR\_GRAPH\_NS::IRenderTechnique](classSR__GRAPH__NS_1_1IRenderTechnique.md),  [SR\_GRAPH\_NS::SwapchainPass](classSR__GRAPH__NS_1_1SwapchainPass.md)
...
|  SR\_NODISCARD [**BasePass**](classSR__GRAPH__NS_1_1BasePass.md) \* | [**FindPass**](#function-findpass-13) (const [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) & name) const<br> |
|  SR\_NODISCARD T \* | [**FindPass**](#function-findpass-23) () const<br> |
|  T \* | [**FindPass**](#function-findpass-33) () const<br> |
|  bool | [**ForEachPass**](#function-foreachpass) (const [**SR\_HTYPES\_NS::Function**](classSR__HTYPES__NS_1_1Function.md)&lt; bool([**BasePass**](classSR__GRAPH__NS_1_1BasePass.md) \*)&gt; & callback) const<br> |
| virtual bool | [**Init**](#function-init) () override<br> |
| virtual bool | [**Load**](#function-load) (const SR\_XML\_NS::Node & passNode) override<br> |
| virtual void SR\_FASTCALL | [**OnMeshAdded**](#function-onmeshadded) ([**SR\_GTYPES\_NS::Mesh**](classSR__GTYPES__NS_1_1Mesh.md) \* pMesh, bool transparent) override<br> |
| virtual void SR\_FASTCALL | [**OnMeshRemoved**](#function-onmeshremoved) ([**SR\_GTYPES\_NS::Mesh**](classSR__GTYPES__NS_1_1Mesh.md) \* pMesh, bool transparent) override<br> |
...
| virtual bool | [**PostRender**](#function-postrender) () override<br>_Вызывается только во время построения_  |
...
|   | [**~GroupPass**](#function-grouppass) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  std::vector&lt; [**BasePass**](classSR__GRAPH__NS_1_1BasePass.md) \* &gt; | [**m\_passes**](#variable-m_passes)  <br> |
...
```C++
virtual void SR_GRAPH_NS::GroupPass::DeInit () override
```
...
### function FindPass [1/3]

```C++
SR_NODISCARD BasePass * SR_GRAPH_NS::GroupPass::FindPass (
...
### function FindPass [2/3]

```C++
template<typename T>
SR_NODISCARD T * SR_GRAPH_NS::GroupPass::FindPass () const
```
...
### function FindPass [3/3]

```C++
template<typename T>
T * SR_GRAPH_NS::GroupPass::FindPass () const
```
...
```C++
bool SR_GRAPH_NS::GroupPass::ForEachPass (
    const SR_HTYPES_NS::Function < bool( BasePass *)> & callback
) const
```
...
```C++
virtual bool SR_GRAPH_NS::GroupPass::Init () override
```
...
```C++
virtual bool SR_GRAPH_NS::GroupPass::Load (
...
```C++
virtual void SR_FASTCALL SR_GRAPH_NS::GroupPass::OnMeshAdded (
...
Implements [*SR\_GRAPH\_NS::BasePass::OnMeshAdded*](classSR__GRAPH__NS_1_1BasePass.md#function-onmeshadded)
...
```C++
virtual void SR_FASTCALL SR_GRAPH_NS::GroupPass::OnMeshRemoved (
    SR_GTYPES_NS::Mesh * pMesh,
    bool transparent
) override
```
...
Implements [*SR\_GRAPH\_NS::BasePass::OnMeshRemoved*](classSR__GRAPH__NS_1_1BasePass.md#function-onmeshremoved)
...
```C++
virtual void SR_GRAPH_NS::GroupPass::OnMultisampleChanged () override
```
...
```C++
virtual void SR_GRAPH_NS::GroupPass::OnResize (
...
```C++
virtual bool SR_GRAPH_NS::GroupPass::Overlay () override
```



Implements [*SR\_GRAPH\_NS::BasePass::Overlay*](classSR__GRAPH__NS_1_1BasePass.md#function-overlay)
...
```C++
virtual bool SR_GRAPH_NS::GroupPass::PostRender () override
```



Implements [*SR\_GRAPH\_NS::BasePass::PostRender*](classSR__GRAPH__NS_1_1BasePass.md#function-postrender)
...
```C++
virtual void SR_GRAPH_NS::GroupPass::PostUpdate () override
```
...
_Вызывается только во время построения_ 
```C++
virtual bool SR_GRAPH_NS::GroupPass::PreRender () override
```
...
```C++
virtual void SR_GRAPH_NS::GroupPass::Prepare () override
```
...
_Вызывается только во время построения_ 
```C++
virtual bool SR_GRAPH_NS::GroupPass::Render () override
```
...
```C++
virtual void SR_GRAPH_NS::GroupPass::SetRenderTechnique (
...
```C++
virtual void SR_GRAPH_NS::GroupPass::Update () override
```
...
```C++
SR_GRAPH_NS::GroupPass::~GroupPass () override
```
...
```C++
std::vector<BasePass*> SR_GRAPH_NS::GroupPass::m_passes;
```
