...
# Class SR\_NETWORK\_NS::Socket



[**ClassList**](annotated.md) **>** [**SR\_NETWORK\_NS**](namespaceSR__NETWORK__NS.md) **>** [**Socket**](classSR__NETWORK__NS_1_1Socket.md)
...
Inherited by the following classes: [SR\_NETWORK\_NS::AsioICMPSocket](classSR__NETWORK__NS_1_1AsioICMPSocket.md),  [SR\_NETWORK\_NS::AsioTCPSocket](classSR__NETWORK__NS_1_1AsioTCPSocket.md)
...
| Type | Name |
| ---: | :--- |
|  bool | [**AsyncReceive**](#function-asyncreceive-12) (uint64\_t size) <br> |
| virtual SR\_NODISCARD uint64\_t | [**AsyncReceive**](#function-asyncreceive-22) (void \* data, std::function&lt; void(uint64\_t bytesReceived)&gt; callback) = 0<br> |
| virtual bool | [**Close**](#function-close) () = 0<br> |
| virtual SR\_NODISCARD bool | [**Connect**](#function-connect) (const std::string & address, uint16\_t port) = 0<br> |
|  SR\_NODISCARD const [**Context::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) & | [**GetContext**](#function-getcontext) () const<br> |
...
|  SR\_NODISCARD const ReceiveCallback & | [**GetReceiveCallback**](#function-getreceivecallback) () const<br> |
|  SR\_NODISCARD const [**DataPackage::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) & | [**GetReceivedAsyncData**](#function-getreceivedasyncdata) () const<br> |
|  SR\_NODISCARD const [**DataPackage::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) & | [**GetReceivedData**](#function-getreceiveddata) () const<br> |
...
|  SR\_NODISCARD SocketType | [**GetType**](#function-gettype) () const<br> |
| virtual SR\_NODISCARD bool | [**IsOpen**](#function-isopen) () const = 0<br> |
|  SR\_NODISCARD bool | [**IsReceiveRepeated**](#function-isreceiverepeated) () const<br> |
|  SR\_NODISCARD [**DataPackage::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**Receive**](#function-receive-12) (uint64\_t size) <br> |
| virtual SR\_NODISCARD uint64\_t | [**Receive**](#function-receive-22) (void \* data, size\_t size) = 0<br> |
| virtual bool | [**Send**](#function-send) (const void \* data, size\_t size) = 0<br> |
| virtual bool | [**SendTo**](#function-sendto) (const void \* data, uint64\_t size, const std::string & address, uint16\_t port) = 0<br> |
|  void | [**SetReceiveCallback**](#function-setreceivecallback) (ReceiveCallback && callback) <br> |
|  void | [**SetWaitingReceive**](#function-setwaitingreceive) (bool isWaiting) <br> |
| virtual  | [**~Socket**](#function-socket) () = default<br> |
...
|  bool | [**m\_isReceiveRepeated**](#variable-m_isreceiverepeated)   = `true`<br> |
|  bool | [**m\_isWaitingReceive**](#variable-m_iswaitingreceive)   = `false`<br> |
|  ReceiveCallback | [**m\_receiveCallback**](#variable-m_receivecallback)  <br> |
|  [**DataPackage::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**m\_receivedAsyncData**](#variable-m_receivedasyncdata)  <br> |
|  [**DataPackage::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**m\_receivedData**](#variable-m_receiveddata)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual bool | [**ReceiveAsyncInternal**](#function-receiveasyncinternal) () = 0<br> |
|   | [**Socket**](#function-socket) (SocketType type, [**Context::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) context) <br> |
...
### function AsyncReceive [1/2]

```C++
bool SR_NETWORK_NS::Socket::AsyncReceive (
    uint64_t size
) 
```
...
### function AsyncReceive [2/2]

```C++
virtual SR_NODISCARD uint64_t SR_NETWORK_NS::Socket::AsyncReceive (
    void * data,
...
```C++
virtual bool SR_NETWORK_NS::Socket::Close () = 0
```
...
```C++
virtual SR_NODISCARD bool SR_NETWORK_NS::Socket::Connect (
...
```C++
inline SR_NODISCARD const Context::Ptr & SR_NETWORK_NS::Socket::GetContext () const
```
...
```C++
virtual SR_NODISCARD std::string SR_NETWORK_NS::Socket::GetLocalAddress () const = 0
```
...
```C++
virtual SR_NODISCARD uint16_t SR_NETWORK_NS::Socket::GetLocalPort () const = 0
```
...
### function GetReceiveCallback 

```C++
inline SR_NODISCARD const ReceiveCallback & SR_NETWORK_NS::Socket::GetReceiveCallback () const
```
...
### function GetReceivedAsyncData 

```C++
inline SR_NODISCARD const DataPackage::Ptr & SR_NETWORK_NS::Socket::GetReceivedAsyncData () const
```
...
```C++
inline SR_NODISCARD const DataPackage::Ptr & SR_NETWORK_NS::Socket::GetReceivedData () const
```
...
```C++
virtual SR_NODISCARD std::string SR_NETWORK_NS::Socket::GetRemoteAddress () const = 0
```
...
```C++
virtual SR_NODISCARD uint16_t SR_NETWORK_NS::Socket::GetRemotePort () const = 0
```
...
```C++
inline SR_NODISCARD SocketType SR_NETWORK_NS::Socket::GetType () const
```
...
```C++
virtual SR_NODISCARD bool SR_NETWORK_NS::Socket::IsOpen () const = 0
```
...
### function IsReceiveRepeated 

```C++
inline SR_NODISCARD bool SR_NETWORK_NS::Socket::IsReceiveRepeated () const
```
...
```C++
SR_NODISCARD DataPackage::Ptr SR_NETWORK_NS::Socket::Receive (
    uint64_t size
) 
```
...
```C++
virtual SR_NODISCARD uint64_t SR_NETWORK_NS::Socket::Receive (
    void * data,
    size_t size
) = 0
```
...
```C++
virtual bool SR_NETWORK_NS::Socket::Send (
    const void * data,
    size_t size
) = 0
```
...
```C++
virtual bool SR_NETWORK_NS::Socket::SendTo (
    const void * data,
    uint64_t size,
    const std::string & address,
    uint16_t port
...
```C++
inline void SR_NETWORK_NS::Socket::SetReceiveCallback (
...
### function SetWaitingReceive 

```C++
inline void SR_NETWORK_NS::Socket::SetWaitingReceive (
    bool isWaiting
) 
```
...
```C++
virtual SR_NETWORK_NS::Socket::~Socket () = default
```
...
```C++
Context::Ptr SR_NETWORK_NS::Socket::m_context;
```
...
### variable m\_isReceiveRepeated 

```C++
bool SR_NETWORK_NS::Socket::m_isReceiveRepeated;
```
...
### variable m\_isWaitingReceive 

```C++
bool SR_NETWORK_NS::Socket::m_isWaitingReceive;
```
...
### variable m\_receiveCallback 

```C++
ReceiveCallback SR_NETWORK_NS::Socket::m_receiveCallback;
```
...
### variable m\_receivedAsyncData 

```C++
DataPackage::Ptr SR_NETWORK_NS::Socket::m_receivedAsyncData;
```
...
### variable m\_receivedData 

```C++
DataPackage::Ptr SR_NETWORK_NS::Socket::m_receivedData;
```
...
```C++
const SocketType SR_NETWORK_NS::Socket::m_type;
```
...
```C++
virtual bool SR_NETWORK_NS::Socket::ReceiveAsyncInternal () = 0
```
...
```C++
explicit SR_NETWORK_NS::Socket::Socket (
    SocketType type,
    Context::Ptr context
) 
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/Network/Socket.h`
