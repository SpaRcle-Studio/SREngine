...
| Type | Name |
| ---: | :--- |
|  SR\_INLINE SR\_MATH\_NS::FVector3 | [**FORWARD**](#variable-forward)   = `SR\_MATH\_NS::FVector3(0, 0, 1)`<br> |
|  SR\_INLINE SR\_MATH\_NS::FVector3 | [**RIGHT**](#variable-right)   = `SR\_MATH\_NS::FVector3(1, 0, 0)`<br> |
|  SR\_INLINE SR\_MATH\_NS::FVector3 | [**UP**](#variable-up)   = `SR\_MATH\_NS::FVector3(0, 1, 0)`<br> |
...
| virtual void | [**RotateAround**](#function-rotatearound) (const SR\_MATH\_NS::FVector3 & point, const SR\_MATH\_NS::FVector3 & eulers) override<br> |
| virtual void | [**RotateAroundParent**](#function-rotatearoundparent) (const SR\_MATH\_NS::FVector3 & eulers) override<br> |
...
```C++
SR_INLINE SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::FORWARD;
```
...
```C++
SR_INLINE SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::RIGHT;
```
...
```C++
SR_INLINE SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::UP;
```
...
```C++
virtual void SR_UTILS_NS::Transform3D::RotateAround (
...
Implements [*SR\_UTILS\_NS::Transform::RotateAround*](classSR__UTILS__NS_1_1Transform.md#function-rotatearound)
...
```C++
virtual void SR_UTILS_NS::Transform3D::RotateAroundParent (
    const SR_MATH_NS::FVector3 & eulers
) override
```
...
Implements [*SR\_UTILS\_NS::Transform::RotateAroundParent*](classSR__UTILS__NS_1_1Transform.md#function-rotatearoundparent)
