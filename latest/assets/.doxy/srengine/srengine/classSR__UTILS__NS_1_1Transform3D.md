...
# Class SR\_UTILS\_NS::Transform3D



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**Transform3D**](classSR__UTILS__NS_1_1Transform3D.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_INLINE constexpr SR\_MATH\_NS::FVector3 | [**FORWARD**](#variable-forward)   = `SR\_MATH\_NS::FVector3(0, 0, 1)`<br> |
|  SR\_INLINE constexpr SR\_MATH\_NS::FVector3 | [**RIGHT**](#variable-right)   = `SR\_MATH\_NS::FVector3(1, 0, 0)`<br> |
|  SR\_INLINE constexpr SR\_MATH\_NS::FVector3 | [**UP**](#variable-up)   = `SR\_MATH\_NS::FVector3(0, 1, 0)`<br> |
...
| virtual SR\_NODISCARD [**SR\_MATH\_NS::Quaternion**](classSR__MATH__NS_1_1Quaternion.md) | [**GetQuaternion**](#function-getquaternion) () override const<br> |
...
| virtual void | [**LookAt**](#function-lookat-12) (const SR\_MATH\_NS::FVector3 & position) override<br> |
| virtual void | [**LookAt**](#function-lookat-22) (const SR\_MATH\_NS::FVector3 & position, LookAtAxis axis) override<br> |
| virtual void | [**Rotate**](#function-rotate-12) (const SR\_MATH\_NS::FVector3 & eulers) override<br> |
| virtual void | [**Rotate**](#function-rotate-22) (const [**SR\_MATH\_NS::Quaternion**](classSR__MATH__NS_1_1Quaternion.md) & q) override<br> |
|  void | [**RotateAround**](#function-rotatearound) (const SR\_MATH\_NS::FVector3 & point, const SR\_MATH\_NS::FVector3 & eulers) override<br> |
|  void | [**RotateAroundParent**](#function-rotatearoundparent) (const SR\_MATH\_NS::FVector3 & eulers) override<br> |
...
| virtual void | [**SetMatrix**](#function-setmatrix) (const std::optional&lt; SR\_MATH\_NS::FVector3 &gt; & translation, const std::optional&lt; [**SR\_MATH\_NS::Quaternion**](classSR__MATH__NS_1_1Quaternion.md) &gt; & rotation, const std::optional&lt; SR\_MATH\_NS::FVector3 &gt; & scale) override<br> |
...
|  SR\_NODISCARD SR\_MATH\_NS::FVector3 | [**TransformDirection**](#function-transformdirection) (const SR\_MATH\_NS::FVector3 & direction) const<br>_Transforms direction from local space to world space._  |
...
| virtual void | [**RotateAround**](classSR__UTILS__NS_1_1Transform.md#function-rotatearound) (const Math::FVector3 & point, const Math::FVector3 & eulers) <br> |
| virtual void | [**RotateAroundParent**](classSR__UTILS__NS_1_1Transform.md#function-rotatearoundparent) (const Math::FVector3 & eulers) <br> |
...
| Type | Name |
| ---: | :--- |
|  bool | [**m\_eulersDirty**](#variable-m_eulersdirty)   = `true`<br> |
...
```C++
SR_INLINE constexpr SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::FORWARD;
```
...
```C++
SR_INLINE constexpr SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::RIGHT;
```
...
```C++
SR_INLINE constexpr SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::UP;
```
...
```C++
virtual SR_NODISCARD const SR_MATH_NS::Matrix4x4 & SR_UTILS_NS::Transform3D::GetMatrix () override const
```
...
```C++
inline virtual SR_NODISCARD Measurement SR_UTILS_NS::Transform3D::GetMeasurement () override const
```
...
```C++
inline virtual SR_NODISCARD SR_MATH_NS::Quaternion SR_UTILS_NS::Transform3D::GetQuaternion () override const
```



Implements [*SR\_UTILS\_NS::Transform::GetQuaternion*](classSR__UTILS__NS_1_1Transform.md#function-getquaternion)
...
```C++
inline virtual SR_NODISCARD SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::GetRotation () override const
```
...
```C++
inline virtual SR_NODISCARD SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::GetScale () override const
```
...
```C++
inline virtual SR_NODISCARD SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::GetSkew () override const
```
...
```C++
inline virtual SR_NODISCARD SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::GetTranslation () override const
```
...
```C++
virtual void SR_UTILS_NS::Transform3D::LookAt (
...
Implements [*SR\_UTILS\_NS::Transform::LookAt*](classSR__UTILS__NS_1_1Transform.md#function-lookat-12)
...
Implements [*SR\_UTILS\_NS::Transform::LookAt*](classSR__UTILS__NS_1_1Transform.md#function-lookat-22)
...
```C++
virtual void SR_UTILS_NS::Transform3D::Rotate (
...
Implements [*SR\_UTILS\_NS::Transform::Rotate*](classSR__UTILS__NS_1_1Transform.md#function-rotate-13)
...
```C++
void SR_UTILS_NS::Transform3D::RotateAround (
...
```C++
void SR_UTILS_NS::Transform3D::RotateAroundParent (
    const SR_MATH_NS::FVector3 & eulers
) override
```
...
```C++
virtual void SR_UTILS_NS::Transform3D::Scale (
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetGlobalRotation (
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetGlobalTranslation (
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetMatrix (
...
Implements [*SR\_UTILS\_NS::Transform::SetMatrix*](classSR__UTILS__NS_1_1Transform.md#function-setmatrix)
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetRotation (
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetScale (
    const SR_MATH_NS::FVector3 & scale
) override
```
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetSkew (
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetTranslation (
    const SR_MATH_NS::FVector3 & translation
) override
```
...
```C++
virtual void SR_UTILS_NS::Transform3D::SetTranslationAndRotation (
    const SR_MATH_NS::FVector3 & translation,
    const SR_MATH_NS::FVector3 & euler
) override
```
...
_Transforms direction from local space to world space._ 
```C++
SR_NODISCARD SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::TransformDirection (
...
```C++
virtual void SR_UTILS_NS::Transform3D::Translate (
    const SR_MATH_NS::FVector3 & translation
) override
```
...
### variable m\_eulersDirty 

```C++
bool SR_UTILS_NS::Transform3D::m_eulersDirty;
```
...
```C++
SR_MATH_NS::Matrix4x4 SR_UTILS_NS::Transform3D::m_localMatrix;
```
...
```C++
SR_MATH_NS::Matrix4x4 SR_UTILS_NS::Transform3D::m_matrix;
```
...
```C++
SR_MATH_NS::Quaternion SR_UTILS_NS::Transform3D::m_quaternion;
```
...
```C++
SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::m_rotation;
```
...
```C++
SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::m_scale;
```
...
```C++
SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::m_skew;
```
...
```C++
SR_MATH_NS::FVector3 SR_UTILS_NS::Transform3D::m_translation;
```
