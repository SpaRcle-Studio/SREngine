...
# Class SR\_PHYSICS\_NS::Box2DLibraryImpl



[**ClassList**](annotated.md) **>** [**SR\_PHYSICS\_NS**](namespaceSR__PHYSICS__NS.md) **>** [**Box2DLibraryImpl**](classSR__PHYSICS__NS_1_1Box2DLibraryImpl.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Box2DLibraryImpl**](#function-box2dlibraryimpl) () = default<br> |
...
|  SR\_NODISCARD [**SR\_PTYPES\_NS::Rigidbody2D**](classSR__PTYPES__NS_1_1Rigidbody2D.md) \* | [**CreateRigidbody2D**](#function-createrigidbody2d) () override<br> |
...
|   | [**~Box2DLibraryImpl**](#function-box2dlibraryimpl) () override<br> |
...
### function Box2DLibraryImpl 

```C++
SR_PHYSICS_NS::Box2DLibraryImpl::Box2DLibraryImpl () = default
```
...
```C++
SR_NODISCARD SR_PTYPES_NS::CollisionShape * SR_PHYSICS_NS::Box2DLibraryImpl::CreateCollisionShape () override
```
...
```C++
virtual SR_NODISCARD SR_PHYSICS_NS::PhysicsWorld * SR_PHYSICS_NS::Box2DLibraryImpl::CreatePhysicsWorld (
    Space space
) override
```
...
### function CreateRigidbody2D 

```C++
SR_NODISCARD SR_PTYPES_NS::Rigidbody2D * SR_PHYSICS_NS::Box2DLibraryImpl::CreateRigidbody2D () override
```
...
```C++
inline virtual SR_NODISCARD ShapeType SR_PHYSICS_NS::Box2DLibraryImpl::GetDefaultShape () override const
```
...
```C++
virtual SR_NODISCARD bool SR_PHYSICS_NS::Box2DLibraryImpl::Initialize () override
```
...
```C++
virtual SR_NODISCARD bool SR_PHYSICS_NS::Box2DLibraryImpl::IsShapeSupported (
    ShapeType type
) override const
```
...
```C++
SR_PHYSICS_NS::Box2DLibraryImpl::~Box2DLibraryImpl () override
```
