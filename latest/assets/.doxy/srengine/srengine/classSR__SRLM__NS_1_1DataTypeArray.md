...
# Class SR\_SRLM\_NS::DataTypeArray



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**DataTypeArray**](classSR__SRLM__NS_1_1DataTypeArray.md)
...
|   | [**~DataTypeArray**](#function-datatypearray) () override<br> |
...
```C++
virtual void SR_SRLM_NS::DataTypeArray::CopyTo (
    DataType * pData
) override const
```
...
```C++
virtual SR_NODISCARD Meta SR_SRLM_NS::DataTypeArray::GetMeta () noexcept override const
```



Implements [*SR\_SRLM\_NS::DataType::GetMeta*](classSR__SRLM__NS_1_1DataType.md#function-getmeta)
...
```C++
virtual void SR_SRLM_NS::DataTypeArray::Reset () override
```
...
```C++
void SR_SRLM_NS::DataTypeArray::SetType (
    DataType * pData
) 
```
...
```C++
SR_SRLM_NS::DataTypeArray::~DataTypeArray () override
```
