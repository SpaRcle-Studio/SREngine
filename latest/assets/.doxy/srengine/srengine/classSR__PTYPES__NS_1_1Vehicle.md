...
# Class SR\_PTYPES\_NS::Vehicle



[**ClassList**](annotated.md) **>** [**SR\_PTYPES\_NS**](namespaceSR__PTYPES__NS.md) **>** [**Vehicle**](classSR__PTYPES__NS_1_1Vehicle.md)
...
Inherited by the following classes: [SR\_PTYPES\_NS::Vehicle4W3D](classSR__PTYPES__NS_1_1Vehicle4W3D.md)
...
| virtual SR\_NODISCARD SR\_UTILS\_NS::Measurement | [**GetMeasurement**](#function-getmeasurement) () const<br> |
|  SR\_NODISCARD [**VehicleInternalData**](structSR__PTYPES__NS_1_1VehicleInternalData.md) & | [**GetVehicleData**](#function-getvehicledata) () <br> |
| virtual bool | [**InitVehicle**](#function-initvehicle) () <br> |
...
```C++
virtual SR_NODISCARD void * SR_PTYPES_NS::Vehicle::GetHandle () noexcept const = 0
```
...
```C++
virtual SR_NODISCARD SR_UTILS_NS::Measurement SR_PTYPES_NS::Vehicle::GetMeasurement () const
```
...
```C++
inline SR_NODISCARD VehicleInternalData & SR_PTYPES_NS::Vehicle::GetVehicleData () 
```
...
```C++
virtual bool SR_PTYPES_NS::Vehicle::InitVehicle () 
```
...
```C++
virtual void SR_PTYPES_NS::Vehicle::OnDestroy () override
```
...
```C++
using SR_PTYPES_NS::Vehicle::LibraryPtr =  SR_PHYSICS_NS::LibraryImpl*;
```
...
```C++
using SR_PTYPES_NS::Vehicle::PhysicsScenePtr =  SR_HTYPES_NS::SafePtr<PhysicsScene>;
```
...
```C++
using SR_PTYPES_NS::Vehicle::Super =  SR_UTILS_NS::Component;
```
