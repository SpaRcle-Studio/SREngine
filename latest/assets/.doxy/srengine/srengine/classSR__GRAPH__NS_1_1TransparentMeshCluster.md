...
# Class SR\_GRAPH\_NS::TransparentMeshCluster



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**TransparentMeshCluster**](classSR__GRAPH__NS_1_1TransparentMeshCluster.md)
...
| Type | Name |
| ---: | :--- |
|   | [**TransparentMeshCluster**](#function-transparentmeshcluster) ([**OpaqueMeshCluster**](classSR__GRAPH__NS_1_1OpaqueMeshCluster.md) \* pOpaqueCluster) <br> |
|   | [**~TransparentMeshCluster**](#function-transparentmeshcluster) () override<br> |
...
### function TransparentMeshCluster 

```C++
inline explicit SR_GRAPH_NS::TransparentMeshCluster::TransparentMeshCluster (
    OpaqueMeshCluster * pOpaqueCluster
) 
```
...
```C++
SR_GRAPH_NS::TransparentMeshCluster::~TransparentMeshCluster () override
```
