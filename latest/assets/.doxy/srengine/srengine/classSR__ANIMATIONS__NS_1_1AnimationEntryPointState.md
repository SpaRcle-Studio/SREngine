...
# Class SR\_ANIMATIONS\_NS::AnimationEntryPointState



[**ClassList**](annotated.md) **>** [**SR\_ANIMATIONS\_NS**](namespaceSR__ANIMATIONS__NS.md) **>** [**AnimationEntryPointState**](classSR__ANIMATIONS__NS_1_1AnimationEntryPointState.md)
...
```C++
inline virtual SR_NODISCARD SR_UTILS_NS::StringAtom SR_ANIMATIONS_NS::AnimationEntryPointState::GetName () noexcept override const
```
