...
# Class SR\_SRLM\_NS::StartNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**StartNode**](classSR__SRLM__NS_1_1StartNode.md)
...
| virtual SR\_NODISCARD bool | [**IsEntryPoint**](#function-isentrypoint) () noexcept override const<br> |
...
```C++
virtual void SR_SRLM_NS::StartNode::Execute (
    float_t dt
) override
```
...
```C++
virtual void SR_SRLM_NS::StartNode::InitNode () override
```
...
```C++
inline virtual SR_NODISCARD bool SR_SRLM_NS::StartNode::IsEntryPoint () noexcept override const
```



Implements [*SR\_SRLM\_NS::LogicalNode::IsEntryPoint*](classSR__SRLM__NS_1_1LogicalNode.md#function-isentrypoint)
