...
# Struct SR\_GRAPH\_NS::MeshDrawerMaterialUniforms



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**MeshDrawerMaterialUniforms**](structSR__GRAPH__NS_1_1MeshDrawerMaterialUniforms.md)
...
| Type | Name |
| ---: | :--- |
|  bool | [**modelMatrix**](#variable-modelmatrix)   = `true`<br> |
|  bool | [**useMaterial**](#variable-usematerial)   = `true`<br> |
...
```C++
bool SR_GRAPH_NS::MeshDrawerMaterialUniforms::modelMatrix;
```
...
### variable useMaterial 

```C++
bool SR_GRAPH_NS::MeshDrawerMaterialUniforms::useMaterial;
```
