...
# Class SR\_SRLM\_NS::LogicalNodeManager



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**LogicalNodeManager**](classSR__SRLM__NS_1_1LogicalNodeManager.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**LogicalNode**](classSR__SRLM__NS_1_1LogicalNode.md) \* | [**CreateByName**](#function-createbyname-12) (Hash hashName) <br> |
|  SR\_NODISCARD [**LogicalNode**](classSR__SRLM__NS_1_1LogicalNode.md) \* | [**CreateByName**](#function-createbyname-22) (const std::string & name) <br> |
|  SR\_NODISCARD const NodeConstructors & | [**GetNodeConstructors**](#function-getnodeconstructors) () <br> |
|  void | [**InitializeTypes**](#function-initializetypes) () <br> |
| virtual SR\_NODISCARD bool | [**IsSingletonCanBeDestroyed**](#function-issingletoncanbedestroyed) () override const<br> |
|  bool | [**Register**](#function-register) (Hash hashName, const Constructor & constructor, const Category & category) <br> |
...
```C++
SR_NODISCARD LogicalNode * SR_SRLM_NS::LogicalNodeManager::CreateByName (
    Hash hashName
) 
```
...
### function GetNodeConstructors 

```C++
inline SR_NODISCARD const NodeConstructors & SR_SRLM_NS::LogicalNodeManager::GetNodeConstructors () 
```
...
```C++
void SR_SRLM_NS::LogicalNodeManager::InitializeTypes () 
```
...
```C++
inline virtual SR_NODISCARD bool SR_SRLM_NS::LogicalNodeManager::IsSingletonCanBeDestroyed () override const
```
...
```C++
bool SR_SRLM_NS::LogicalNodeManager::Register (
    Hash hashName,
