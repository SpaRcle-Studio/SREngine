...
# Class SR\_GRAPH\_NS::OpaquePass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**OpaquePass**](classSR__GRAPH__NS_1_1OpaquePass.md)
...
```C++
virtual SR_NODISCARD MeshClusterType SR_GRAPH_NS::OpaquePass::GetClusterType () noexcept override const
```
...
```C++
virtual void SR_GRAPH_NS::OpaquePass::UseSharedUniforms (
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Pass/OpaquePass.h`
