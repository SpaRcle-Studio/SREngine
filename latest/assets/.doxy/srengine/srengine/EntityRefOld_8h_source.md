...
[**File List**](files.md) **>** [**ECS**](dir_df4674c010a45d2af7a2a452a0d36896.md) **>** [**EntityRefOld.h**](EntityRefOld_8h.md)

[Go to the documentation of this file](EntityRefOld_8h.md)
...
#ifndef SR_ENGINE_UTILS_ENTITY_REF_OLD_H
#define SR_ENGINE_UTILS_ENTITY_REF_OLD_H
...
namespace SR_UTILS_NS {
    ...
    class EntityRefOld final : public SR_UTILS_NS::Serializable {
        SR_CLASS()
    public:
        EntityRefOld() = default;
        explicit EntityRefOld(EntityRefUtils::OwnerRef owner);

    public:
        void OnPreSave() override;

        SR_NODISCARD EntityRefOld Copy(const EntityRefUtils::OwnerRef& owner) const;
        ...
        EntityRefOld& SetPathTo(const SR_HTYPES_NS::SharedPtr<Entity>& pEntity);
    ...
    public:
        ...
        SR_UTILS_NS::EntityRefOld& GetEntityRef() noexcept { return m_entityRef; }

    private:
        SR_UTILS_NS::EntityRefOld m_entityRef;

    };
}

#endif //SR_ENGINE_UTILS_ENTITY_REF_OLD_H
```
