...
# Class SR\_SRLM\_NS::DataTypeNone



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**DataTypeNone**](classSR__SRLM__NS_1_1DataTypeNone.md)
...
```C++
inline virtual void SR_SRLM_NS::DataTypeNone::CopyTo (
    DataType * pData
) override const
```
...
```C++
inline virtual void SR_SRLM_NS::DataTypeNone::Reset () override
```
