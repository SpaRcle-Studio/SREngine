...
# Class SR\_UTILS\_NS::SharedPtrTest



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**SharedPtrTest**](classSR__UTILS__NS_1_1SharedPtrTest.md)
...
```C++
inline virtual SR_UTILS_NS::TestExecutionResult SR_UTILS_NS::SharedPtrTest::Run () override
```
