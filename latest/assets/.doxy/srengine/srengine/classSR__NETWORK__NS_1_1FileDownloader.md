...
# Class SR\_NETWORK\_NS::FileDownloader



[**ClassList**](annotated.md) **>** [**SR\_NETWORK\_NS**](namespaceSR__NETWORK__NS.md) **>** [**FileDownloader**](classSR__NETWORK__NS_1_1FileDownloader.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD bool | [**DownloadFile**](#function-downloadfile) (const std::string & url, const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & filePath) <br> |
...
```C++
SR_NODISCARD bool SR_NETWORK_NS::FileDownloader::DownloadFile (
