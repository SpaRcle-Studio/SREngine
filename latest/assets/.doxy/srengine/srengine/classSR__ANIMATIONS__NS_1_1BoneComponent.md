...
# Class SR\_ANIMATIONS\_NS::BoneComponent



[**ClassList**](annotated.md) **>** [**SR\_ANIMATIONS\_NS**](namespaceSR__ANIMATIONS__NS.md) **>** [**BoneComponent**](classSR__ANIMATIONS__NS_1_1BoneComponent.md)
...
| Type | Name |
| ---: | :--- |
|   | [**BoneComponent**](#function-bonecomponent) () <br> |
| virtual SR\_NODISCARD bool | [**ExecuteInEditMode**](#function-executeineditmode) () override const<br> |
|  void | [**Initialize**](#function-initialize) ([**Skeleton**](classSR__ANIMATIONS__NS_1_1Skeleton.md) \* pSkeleton, uint16\_t boneIndex) <br> |
...
```C++
SR_ANIMATIONS_NS::BoneComponent::BoneComponent () 
```
...
```C++
inline virtual SR_NODISCARD bool SR_ANIMATIONS_NS::BoneComponent::ExecuteInEditMode () override const
```
...
```C++
void SR_ANIMATIONS_NS::BoneComponent::Initialize (
    Skeleton * pSkeleton,
    uint16_t boneIndex
) 
```
