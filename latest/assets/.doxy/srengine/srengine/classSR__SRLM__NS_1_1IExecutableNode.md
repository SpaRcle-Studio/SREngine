...
# Class SR\_SRLM\_NS::IExecutableNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**IExecutableNode**](classSR__SRLM__NS_1_1IExecutableNode.md)
...
| Type | Name |
| ---: | :--- |
|   | [**IExecutableNode**](#function-iexecutablenode) () = default<br> |
...
```C++
inline virtual SR_NODISCARD LogicalNodeType SR_SRLM_NS::IExecutableNode::GetType () noexcept const
```
...
```C++
using SR_SRLM_NS::IExecutableNode::Base =  IExecutableNode;
```
...
### function IExecutableNode 

```C++
SR_SRLM_NS::IExecutableNode::IExecutableNode () = default
```
