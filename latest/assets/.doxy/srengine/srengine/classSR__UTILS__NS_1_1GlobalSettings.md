...
# Class SR\_UTILS\_NS::GlobalSettings

**template &lt;typename T&gt;**



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**GlobalSettings**](classSR__UTILS__NS_1_1GlobalSettings.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_MAYBE\_UNUSED void | [**DestroySettings**](#function-destroysettings) () <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**~GlobalSettings**](#function-globalsettings) () override<br> |
...
```C++
static inline SR_MAYBE_UNUSED void SR_UTILS_NS::GlobalSettings::DestroySettings () 
```
...
```C++
SR_UTILS_NS::GlobalSettings::~GlobalSettings () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/Settings.h`
