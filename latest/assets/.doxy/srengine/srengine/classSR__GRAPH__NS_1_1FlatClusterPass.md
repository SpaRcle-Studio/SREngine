...
# Class SR\_GRAPH\_NS::FlatClusterPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**FlatClusterPass**](classSR__GRAPH__NS_1_1FlatClusterPass.md)
...
```C++
virtual SR_NODISCARD MeshClusterType SR_GRAPH_NS::FlatClusterPass::GetClusterType () noexcept override const
```
...
```C++
virtual void SR_GRAPH_NS::FlatClusterPass::OnClusterDirty () override
```
...
```C++
virtual bool SR_GRAPH_NS::FlatClusterPass::Render () override
```
...
```C++
virtual void SR_GRAPH_NS::FlatClusterPass::Update () override
```
...
```C++
virtual void SR_GRAPH_NS::FlatClusterPass::UseSharedUniforms (
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Pass/FlatClusterPass.h`
