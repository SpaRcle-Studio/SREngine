...
# Class SR\_CORE\_GUI\_NS::FColorPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**FColorPropertyDrawer**](classSR__CORE__GUI__NS_1_1FColorPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**FColorPropertyDrawer**](classSR__CORE__GUI__NS_1_1FColorPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_CORE_GUI_NS::FColorPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<FColorPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::FColorPropertyDrawer::Draw (
