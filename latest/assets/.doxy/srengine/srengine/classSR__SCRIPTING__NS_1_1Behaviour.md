...
|  T \* | [**GetBehaviour**](#function-getbehaviour) () <br> |
...
```C++
virtual SR_NODISCARD bool SR_SCRIPTING_NS::Behaviour::ExecuteInEditMode () override const
```
...
```C++
template<typename T>
inline T * SR_SCRIPTING_NS::Behaviour::GetBehaviour () 
```
...
```C++
SR_NODISCARD bool SR_SCRIPTING_NS::Behaviour::IsInstanceValid () noexcept const
```
