...
# Class SR\_UTILS\_NS::EnumProperty



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**EnumProperty**](classSR__UTILS__NS_1_1EnumProperty.md)



_---------------------------------------_  __[_**EnumProperty**_](classSR__UTILS__NS_1_1EnumProperty.md) _-----------------------------------------------------_ __
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**GetEnum**](#function-getenum) () noexcept const<br> |
|  SR\_NODISCARD [**SR\_UTILS\_NS::EnumReflector**](classSR__UTILS__NS_1_1EnumReflector.md) \* | [**GetEnumReflector**](#function-getenumreflector) () noexcept const<br> |
|  SR\_NODISCARD const FilterFn & | [**GetFilter**](#function-getfilter) () noexcept const<br> |
...
|  [**EnumProperty**](classSR__UTILS__NS_1_1EnumProperty.md) & | [**SetEnum**](#function-setenum) (const [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) & value) noexcept<br> |
|  [**EnumProperty**](classSR__UTILS__NS_1_1EnumProperty.md) & | [**SetEnumReflector**](#function-setenumreflector) ([**SR\_UTILS\_NS::EnumReflector**](classSR__UTILS__NS_1_1EnumReflector.md) \* pReflector) noexcept<br> |
|  [**EnumProperty**](classSR__UTILS__NS_1_1EnumProperty.md) & | [**SetFilter**](#function-setfilter) (const FilterFn & value) <br> |
|  [**EnumProperty**](classSR__UTILS__NS_1_1EnumProperty.md) & | [**SetGetter**](#function-setgetter) (const GetterFn & value) <br> |
|  [**EnumProperty**](classSR__UTILS__NS_1_1EnumProperty.md) & | [**SetSetter**](#function-setsetter) (const SetterFn & value) <br> |
...
```C++
SR_NODISCARD SR_UTILS_NS::StringAtom SR_UTILS_NS::EnumProperty::GetEnum () noexcept const
```
...
### function GetEnumReflector 

```C++
inline SR_NODISCARD SR_UTILS_NS::EnumReflector * SR_UTILS_NS::EnumProperty::GetEnumReflector () noexcept const
```
...
```C++
inline SR_NODISCARD const FilterFn & SR_UTILS_NS::EnumProperty::GetFilter () noexcept const
```
...
```C++
virtual void SR_UTILS_NS::EnumProperty::LoadProperty (
    MarshalRef marshal
) noexcept override
```
...
```C++
virtual void SR_UTILS_NS::EnumProperty::SaveProperty (
    MarshalRef marshal
...
```C++
EnumProperty & SR_UTILS_NS::EnumProperty::SetEnum (
...
### function SetEnumReflector 

```C++
inline EnumProperty & SR_UTILS_NS::EnumProperty::SetEnumReflector (
...
```C++
inline EnumProperty & SR_UTILS_NS::EnumProperty::SetFilter (
...
```C++
inline EnumProperty & SR_UTILS_NS::EnumProperty::SetGetter (
...
```C++
inline EnumProperty & SR_UTILS_NS::EnumProperty::SetSetter (
