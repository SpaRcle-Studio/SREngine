...
# Class SR\_UTILS\_NS::TaskManager



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**TaskManager**](classSR__UTILS__NS_1_1TaskManager.md)
...
| Type | Name |
| ---: | :--- |
|  TaskId | [**Execute**](#function-execute-12) ([**Task**](classSR__UTILS__NS_1_1Task.md) && task) <br> |
|  TaskId | [**Execute**](#function-execute-22) (const TaskFn & function, bool createThread=false) <br> |
|  Task::State | [**GetResult**](#function-getresult) (TaskId taskId) const<br> |
|   | [**~TaskManager**](#function-taskmanager) () override<br> |
...
```C++
TaskId SR_UTILS_NS::TaskManager::Execute (
    Task && task
) 
```
...
```C++
Task::State SR_UTILS_NS::TaskManager::GetResult (
    TaskId taskId
) const
```
...
```C++
SR_UTILS_NS::TaskManager::~TaskManager () override
```
