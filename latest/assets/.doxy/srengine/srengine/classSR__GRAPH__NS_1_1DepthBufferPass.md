...
# Class SR\_GRAPH\_NS::DepthBufferPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**DepthBufferPass**](classSR__GRAPH__NS_1_1DepthBufferPass.md)
...
```C++
virtual void SR_GRAPH_NS::DepthBufferPass::UseSharedUniforms (
    ShaderPtr pShader
) override
```
...
Implements [*SR\_GRAPH\_NS::IMeshClusterPass::UseSharedUniforms*](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-useshareduniforms)
...
```C++
virtual void SR_GRAPH_NS::DepthBufferPass::UseUniforms (
    ShaderPtr pShader,
    MeshPtr pMesh
) override
```
