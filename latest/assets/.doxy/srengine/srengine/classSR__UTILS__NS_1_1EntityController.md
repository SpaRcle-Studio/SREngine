...
# Class SR\_UTILS\_NS::EntityController



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**EntityController**](classSR__UTILS__NS_1_1EntityController.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**EntityController**](classSR__UTILS__NS_1_1EntityController.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**EntityController**](#function-entitycontroller) () <br> |
|  SR\_NODISCARD Entity::Ptr | [**FindById**](#function-findbyid) (const EntityId & id) const<br> |
|  SR\_NODISCARD Entity::Ptr | [**GetReserved**](#function-getreserved) (const EntityId & id, const EntityAllocator & allocator) <br> |
...
|   | [**~EntityController**](#function-entitycontroller) () override<br> |
...
```C++
using SR_UTILS_NS::EntityController::Ptr =  SR_HTYPES_NS::SharedPtr<EntityController>;
```
...
```C++
SR_UTILS_NS::EntityController::EntityController () 
```
...
```C++
SR_NODISCARD Entity::Ptr SR_UTILS_NS::EntityController::FindById (
    const EntityId & id
) const
```
...
```C++
SR_NODISCARD Entity::Ptr SR_UTILS_NS::EntityController::GetReserved (
    const EntityId & id,
    const EntityAllocator & allocator
) 
```
...
```C++
SR_NODISCARD bool SR_UTILS_NS::EntityController::IsIdUsed (
    const EntityId & id
) const
```
...
```C++
EntityId SR_UTILS_NS::EntityController::Register (
    const Entity::Ptr & pEntity,
    EntityId wantedId=SR_ID_INVALID
) 
```
...
```C++
bool SR_UTILS_NS::EntityController::Reserve (
    const EntityId & id
) 
```
...
```C++
bool SR_UTILS_NS::EntityController::TryUnReserve (
    const EntityId & id
) 
```
...
```C++
bool SR_UTILS_NS::EntityController::UnReserve (
    const EntityId & id
) 
```
...
```C++
void SR_UTILS_NS::EntityController::Unregister (
    const EntityId & id
) 
```
