...
# Class SR\_UTILS\_NS::Web::CSSParser



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**Web**](namespaceSR__UTILS__NS_1_1Web.md) **>** [**CSSParser**](classSR__UTILS__NS_1_1Web_1_1CSSParser.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD CSS::Ptr | [**Parse**](#function-parse-12) (const [**Path**](classSR__UTILS__NS_1_1Path.md) & path, const [**CSSParserContext**](structSR__UTILS__NS_1_1Web_1_1CSSParserContext.md) & context=CSSParserContext::GetDefault()) <br> |
|  SR\_NODISCARD CSS::Ptr | [**Parse**](#function-parse-22) (const std::string & data, const [**CSSParserContext**](structSR__UTILS__NS_1_1Web_1_1CSSParserContext.md) & context=CSSParserContext::GetDefault()) <br> |
...
```C++
SR_NODISCARD CSS::Ptr SR_UTILS_NS::Web::CSSParser::Parse (
    const Path & path,
    const CSSParserContext & context=CSSParserContext::GetDefault()
) 
```
