...
# Class SR\_UTILS\_NS::UI::UIModifierComponent



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**UI**](namespaceSR__UTILS__NS_1_1UI.md) **>** [**UIModifierComponent**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md)



_@hidden_ 

* `#include <UIModifier.h>`
...
Inherited by the following classes: [SR\_GRAPH\_UI\_NS::UICanvasComponent](classSR__GRAPH__UI__NS_1_1UICanvasComponent.md),  [SR\_GRAPH\_UI\_NS::UISizeComponent](classSR__GRAPH__UI__NS_1_1UISizeComponent.md)
...
| Type | Name |
| ---: | :--- |
| virtual void | [**ApplyChild**](#function-applychild) ([**UIModifierContext**](structSR__UTILS__NS_1_1UI_1_1UIModifierContext.md) & context) const<br> |
...
| virtual void | [**PostProcess**](#function-postprocess) ([**UIModifierContext**](structSR__UTILS__NS_1_1UI_1_1UIModifierContext.md) & context) const<br> |
| virtual void | [**Prepare**](#function-prepare) ([**UIModifierContext**](structSR__UTILS__NS_1_1UI_1_1UIModifierContext.md) & context) const<br> |
|   | [**~UIModifierComponent**](#function-uimodifiercomponent) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  void | [**SetUITreeDirty**](#function-setuitreedirty) () <br> |
...
```C++
inline virtual void SR_UTILS_NS::UI::UIModifierComponent::ApplyChild (
    UIModifierContext & context
) const
```
...
```C++
inline virtual SR_NODISCARD bool SR_UTILS_NS::UI::UIModifierComponent::ExecuteInEditMode () override const
```
...
```C++
virtual void SR_UTILS_NS::UI::UIModifierComponent::OnAttached () override
```
...
```C++
virtual void SR_UTILS_NS::UI::UIModifierComponent::OnDestroy () override
```
...
```C++
virtual void SR_UTILS_NS::UI::UIModifierComponent::OnDetached () override
```
...
```C++
virtual void SR_UTILS_NS::UI::UIModifierComponent::OnTransformSet () override
```
...
```C++
inline virtual void SR_UTILS_NS::UI::UIModifierComponent::PostProcess (
    UIModifierContext & context
) const
```
...
```C++
inline virtual void SR_UTILS_NS::UI::UIModifierComponent::Prepare (
    UIModifierContext & context
) const
```
...
### function ~UIModifierComponent 

```C++
SR_UTILS_NS::UI::UIModifierComponent::~UIModifierComponent () override
```
...
### function SetUITreeDirty 

```C++
void SR_UTILS_NS::UI::UIModifierComponent::SetUITreeDirty () 
```
