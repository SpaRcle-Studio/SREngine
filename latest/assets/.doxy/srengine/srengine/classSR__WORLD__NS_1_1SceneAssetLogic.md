...
# Class SR\_WORLD\_NS::SceneAssetLogic



[**ClassList**](annotated.md) **>** [**SR\_WORLD\_NS**](namespaceSR__WORLD__NS.md) **>** [**SceneAssetLogic**](classSR__WORLD__NS_1_1SceneAssetLogic.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SceneAssetLogic**](classSR__WORLD__NS_1_1SceneAssetLogic.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_WORLD_NS::SceneAssetLogic::Ptr =  SR_HTYPES_NS::SharedPtr<SceneAssetLogic>;
```
...
```C++
inline virtual SR_NODISCARD StringAtom SR_WORLD_NS::SceneAssetLogic::GetSceneExtension () noexcept override const
```
...
```C++
inline virtual SR_NODISCARD SceneLogicType SR_WORLD_NS::SceneAssetLogic::GetType () noexcept override const
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/World/SceneAssetLogic.h`
