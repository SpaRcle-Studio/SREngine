...
| Type | Name |
| ---: | :--- |
|  [**Font**](classSR__GTYPES__NS_1_1Font.md) \* | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath) <br> |
...
```C++
static Font * SR_GTYPES_NS::Font::Load (
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Font/Font.h`
