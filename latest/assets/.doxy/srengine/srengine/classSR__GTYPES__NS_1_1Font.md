...
# Class SR\_GTYPES\_NS::Font



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**Font**](classSR__GTYPES__NS_1_1Font.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Font**](classSR__GTYPES__NS_1_1Font.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
|  SR\_NODISCARD FT\_Glyph | [**GetGlyph**](#function-getglyph-12) (char32\_t code, FT\_Render\_Mode renderMode, FT\_Int32 charLoad, FT\_Int32 glyphLoad) const<br> |
...
|   | [**~Font**](#function-font) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  Font::Ptr | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath) <br> |
...
```C++
using SR_GTYPES_NS::Font::Ptr =  SR_HTYPES_NS::SharedPtr<Font>;
```
...
```C++
virtual SR_NODISCARD SR_UTILS_NS::Path SR_GTYPES_NS::Font::GetAssociatedPath () override const
```
...
### function GetGlyph [1/2]

```C++
SR_NODISCARD FT_Glyph SR_GTYPES_NS::Font::GetGlyph (
    char32_t code,
...
```C++
SR_NODISCARD FT_Pos SR_GTYPES_NS::Font::GetKerning (
    uint32_t leftCharCode,
    uint32_t rightCharCode
) const
```
...
```C++
inline SR_NODISCARD bool SR_GTYPES_NS::Font::HasColor () noexcept const
```
...
### function IsColorEmoji 

```C++
inline SR_NODISCARD bool SR_GTYPES_NS::Font::IsColorEmoji () noexcept const
```
...
```C++
bool SR_GTYPES_NS::Font::SetCharSize (
    uint32_t w,
    uint32_t h,
    uint32_t wRes,
    uint32_t hRes
...
```C++
bool SR_GTYPES_NS::Font::SetPixelSizes (
    uint32_t w,
    uint32_t h
) 
```
...
```C++
SR_GTYPES_NS::Font::~Font () override
```
...
```C++
static Font::Ptr SR_GTYPES_NS::Font::Load (
...
```C++
virtual bool SR_GTYPES_NS::Font::Load () override
```
...
```C++
virtual bool SR_GTYPES_NS::Font::Unload () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Font/Font.h`
