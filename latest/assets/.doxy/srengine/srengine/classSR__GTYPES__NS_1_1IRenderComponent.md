...
# Class SR\_GTYPES\_NS::IRenderComponent



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**IRenderComponent**](classSR__GTYPES__NS_1_1IRenderComponent.md)
...
Inherited by the following classes: [SR\_CORE\_UI\_NS::IButton](classSR__CORE__UI__NS_1_1IButton.md),  [SR\_GRAPH\_NS::ILightComponent](classSR__GRAPH__NS_1_1ILightComponent.md),  [SR\_GRAPH\_UI\_NS::Gizmo](classSR__GRAPH__UI__NS_1_1Gizmo.md),  [SR\_GTYPES\_NS::Mesh](classSR__GTYPES__NS_1_1Mesh.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Camera**](classSR__GTYPES__NS_1_1Camera.md) &gt; | [**CameraPtr**](#typedef-cameraptr)  <br> |
| typedef RenderScene \* | [**RenderScenePtr**](#typedef-rendersceneptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD CameraPtr | [**GetCamera**](#function-getcamera) () const<br> |
...
| Type | Name |
| ---: | :--- |
|  RenderScenePtr | [**m\_renderScene**](#variable-m_renderscene)   = `nullptr`<br> |
...
```C++
using SR_GTYPES_NS::IRenderComponent::CameraPtr =  SR_HTYPES_NS::SharedPtr<Camera>;
```
...
```C++
using SR_GTYPES_NS::IRenderComponent::RenderScenePtr =  RenderScene*;
```
...
```C++
SR_NODISCARD CameraPtr SR_GTYPES_NS::IRenderComponent::GetCamera () const
```
...
```C++
SR_NODISCARD RenderScenePtr SR_GTYPES_NS::IRenderComponent::GetRenderScene () const
```
...
```C++
virtual void SR_GTYPES_NS::IRenderComponent::OnDisable () override
```
...
```C++
virtual void SR_GTYPES_NS::IRenderComponent::OnEnable () override
```
...
```C++
SR_NODISCARD RenderScenePtr SR_GTYPES_NS::IRenderComponent::TryGetRenderScene () const
```
...
```C++
RenderScenePtr SR_GTYPES_NS::IRenderComponent::m_renderScene;
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Types/IRenderComponent.h`
