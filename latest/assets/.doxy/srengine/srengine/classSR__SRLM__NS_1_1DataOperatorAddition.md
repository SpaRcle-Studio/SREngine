...
# Class SR\_SRLM\_NS::DataOperatorAddition



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**DataOperatorAddition**](classSR__SRLM__NS_1_1DataOperatorAddition.md)
...
```C++
virtual SR_NODISCARD DataType * SR_SRLM_NS::DataOperatorAddition::Calculate (
    DataType * pFirst,
    DataType * pSecond
) override
```
