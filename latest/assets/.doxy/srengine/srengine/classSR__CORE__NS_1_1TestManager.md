...
# Class SR\_CORE\_NS::TestManager



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**TestManager**](classSR__CORE__NS_1_1TestManager.md)
...
```C++
inline void SR_CORE_NS::TestManager::AddEngineTest (
    const TestFn & test,
...
```C++
inline void SR_CORE_NS::TestManager::AddTest (
    const TestFn & test,
    const std::string & name
) 
```
...
```C++
inline virtual bool SR_CORE_NS::TestManager::IsSingletonCanBeDestroyed () override const
```
