...
# Struct SR\_CORE\_NS::EditorSettingsIconInfo



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**EditorSettingsIconInfo**](structSR__CORE__NS_1_1EditorSettingsIconInfo.md)
...
| Type | Name |
| ---: | :--- |
|  std::string | [**extensions**](#variable-extensions)  <br> |
...
```C++
std::string SR_CORE_NS::EditorSettingsIconInfo::extensions;
```
...
```C++
SR_UTILS_NS::Path SR_CORE_NS::EditorSettingsIconInfo::path;
```
