...
# Class SR\_GRAPH\_NS::IRenderer



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**IRenderer**](classSR__GRAPH__NS_1_1IRenderer.md)
...
Inherited by the following classes: [SR\_GRAPH\_NS::DebugRenderer](classSR__GRAPH__NS_1_1DebugRenderer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**IRenderer**](classSR__GRAPH__NS_1_1IRenderer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual void | [**Clear**](#function-clear) () <br> |
| virtual void | [**DeInit**](#function-deinit) () <br> |
|  SR\_NODISCARD [**RenderScene**](classSR__GRAPH__NS_1_1RenderScene.md) \* | [**GetRenderScene**](#function-getrenderscene) () noexcept const<br> |
|   | [**IRenderer**](#function-irenderer) () <br> |
| virtual void | [**Init**](#function-init) () <br> |
| virtual bool | [**IsEmpty**](#function-isempty) () noexcept const<br> |
| virtual void | [**PostUpdate**](#function-postupdate) () <br> |
| virtual void | [**Prepare**](#function-prepare) () <br> |
|  void | [**SetRenderScene**](#function-setrenderscene) ([**RenderScene**](classSR__GRAPH__NS_1_1RenderScene.md) \* pRenderScene) noexcept<br> |
...
```C++
using SR_GRAPH_NS::IRenderer::Ptr =  SR_HTYPES_NS::SharedPtr<IRenderer>;
```
...
```C++
inline virtual void SR_GRAPH_NS::IRenderer::Clear () 
```
...
```C++
inline virtual void SR_GRAPH_NS::IRenderer::DeInit () 
```
...
```C++
inline SR_NODISCARD RenderScene * SR_GRAPH_NS::IRenderer::GetRenderScene () noexcept const
```
...
```C++
inline explicit SR_GRAPH_NS::IRenderer::IRenderer () 
```
...
```C++
inline virtual void SR_GRAPH_NS::IRenderer::Init () 
```
...
```C++
inline virtual bool SR_GRAPH_NS::IRenderer::IsEmpty () noexcept const
```
...
```C++
inline virtual void SR_GRAPH_NS::IRenderer::PostUpdate () 
```
...
```C++
inline virtual void SR_GRAPH_NS::IRenderer::Prepare () 
```
...
```C++
inline void SR_GRAPH_NS::IRenderer::SetRenderScene (
...
```C++
std::recursive_mutex SR_GRAPH_NS::IRenderer::m_mutex;
```
