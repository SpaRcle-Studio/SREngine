...
# Class SR\_CORE\_NS::SceneUpdateState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**SceneUpdateState**](classSR__CORE__NS_1_1SceneUpdateState.md)
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::SceneUpdateState::ExecuteImpl () override
```
