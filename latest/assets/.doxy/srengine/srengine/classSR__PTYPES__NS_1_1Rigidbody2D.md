...
# Class SR\_PTYPES\_NS::Rigidbody2D



[**ClassList**](annotated.md) **>** [**SR\_PTYPES\_NS**](namespaceSR__PTYPES__NS.md) **>** [**Rigidbody2D**](classSR__PTYPES__NS_1_1Rigidbody2D.md)
...
```C++
virtual SR_NODISCARD SR_UTILS_NS::Measurement SR_PTYPES_NS::Rigidbody2D::GetMeasurement () override const
```
