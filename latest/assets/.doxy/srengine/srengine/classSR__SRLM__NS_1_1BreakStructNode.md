...
# Class SR\_SRLM\_NS::BreakStructNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**BreakStructNode**](classSR__SRLM__NS_1_1BreakStructNode.md)
...
```C++
virtual void SR_SRLM_NS::BreakStructNode::Execute (
    float_t dt
) override
```
...
```C++
virtual void SR_SRLM_NS::BreakStructNode::InitNode () override
```
...
```C++
inline void SR_SRLM_NS::BreakStructNode::SetStructHashName (
    uint64_t hash
) 
```
