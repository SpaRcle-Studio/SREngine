...
# Class SR\_SRLM\_NS::SynchronizeNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**SynchronizeNode**](classSR__SRLM__NS_1_1SynchronizeNode.md)
...
```C++
virtual void SR_SRLM_NS::SynchronizeNode::Execute (
    float_t dt
) override
```
...
```C++
virtual void SR_SRLM_NS::SynchronizeNode::InitNode () override
```
