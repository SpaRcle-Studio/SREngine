...
# Class SR\_AUDIO\_NS::Sound



[**ClassList**](annotated.md) **>** [**SR\_AUDIO\_NS**](namespaceSR__AUDIO__NS.md) **>** [**Sound**](classSR__AUDIO__NS_1_1Sound.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Sound**](classSR__AUDIO__NS_1_1Sound.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD uint8\_t | [**GetBitsPerSample**](#function-getbitspersample) () const<br> |
|  SR\_NODISCARD const uint8\_t \* | [**GetBufferData**](#function-getbufferdata) () const<br> |
|  SR\_NODISCARD uint64\_t | [**GetBufferSize**](#function-getbuffersize) () const<br> |
|  SR\_NODISCARD uint8\_t | [**GetChannels**](#function-getchannels) () const<br> |
|  SR\_NODISCARD [**SoundData**](structSR__AUDIO__NS_1_1SoundData.md) \* | [**GetData**](#function-getdata) () const<br> |
| virtual SR\_NODISCARD uint64\_t | [**GetFileHash**](#function-getfilehash) () override const<br> |
|  SR\_NODISCARD uint32\_t | [**GetSampleRate**](#function-getsamplerate) () const<br> |
| virtual SR\_NODISCARD bool | [**IsAllowedToRevive**](#function-isallowedtorevive) () override const<br> |
|  Handle | [**Play**](#function-play-12) (const [**PlayParams**](structSR__AUDIO__NS_1_1PlayParams.md) & params) <br> |
|  Handle | [**Play**](#function-play-22) () <br> |
|   | [**Sound**](#function-sound) () <br> |
|   | [**~Sound**](#function-sound) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  Sound::Ptr | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
```C++
using SR_AUDIO_NS::Sound::Ptr =  SR_HTYPES_NS::SharedPtr<Sound>;
```
...
```C++
SR_NODISCARD uint8_t SR_AUDIO_NS::Sound::GetBitsPerSample () const
```
...
```C++
SR_NODISCARD const uint8_t * SR_AUDIO_NS::Sound::GetBufferData () const
```
...
```C++
SR_NODISCARD uint64_t SR_AUDIO_NS::Sound::GetBufferSize () const
```
...
```C++
SR_NODISCARD uint8_t SR_AUDIO_NS::Sound::GetChannels () const
```
...
```C++
SR_NODISCARD SoundData * SR_AUDIO_NS::Sound::GetData () const
```
...
```C++
inline virtual SR_NODISCARD uint64_t SR_AUDIO_NS::Sound::GetFileHash () override const
```
...
```C++
SR_NODISCARD uint32_t SR_AUDIO_NS::Sound::GetSampleRate () const
```
...
```C++
virtual SR_NODISCARD bool SR_AUDIO_NS::Sound::IsAllowedToRevive () override const
```
...
```C++
SR_AUDIO_NS::Sound::~Sound () override
```
...
```C++
static Sound::Ptr SR_AUDIO_NS::Sound::Load (
...
```C++
virtual bool SR_AUDIO_NS::Sound::Load () override
```
...
```C++
virtual bool SR_AUDIO_NS::Sound::Reload () override
```
...
```C++
virtual bool SR_AUDIO_NS::Sound::Unload () override
```
