...
| Type | Name |
| ---: | :--- |
|  [**Sound**](classSR__AUDIO__NS_1_1Sound.md) \* | [**Load**](#function-load-22) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
```C++
static Sound * SR_AUDIO_NS::Sound::Load (
