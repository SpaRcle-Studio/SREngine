...
# Class SR\_UTILS\_NS::LockPositionComponent



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**LockPositionComponent**](classSR__UTILS__NS_1_1LockPositionComponent.md)
...
| virtual void | [**Update**](#function-update) (float\_t) override<br> |
...
```C++
virtual void SR_UTILS_NS::LockPositionComponent::Awake () override
```
...
```C++
virtual void SR_UTILS_NS::LockPositionComponent::Update (
    float_t
) override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Utils/inc/Utils/Game/LockPositionComponent.h`
