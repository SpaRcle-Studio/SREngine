...
# Class SR\_SRLM\_NS::PlusNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**PlusNode**](classSR__SRLM__NS_1_1PlusNode.md)
...
```C++
virtual void SR_SRLM_NS::PlusNode::Execute (
    float_t dt
) override
```
