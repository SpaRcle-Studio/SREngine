...
# Class SR\_GRAPH\_NS::AreaLight



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**AreaLight**](classSR__GRAPH__NS_1_1AreaLight.md)
...
```C++
inline virtual SR_NODISCARD LightType SR_GRAPH_NS::AreaLight::GetLightType () override const
```
...
```C++
float_t SR_GRAPH_NS::AreaLight::m_distance;
```
...
```C++
float_t SR_GRAPH_NS::AreaLight::m_radius;
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Lighting/AreaLight.h`
