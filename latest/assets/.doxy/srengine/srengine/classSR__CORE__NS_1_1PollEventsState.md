...
# Class SR\_CORE\_NS::PollEventsState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**PollEventsState**](classSR__CORE__NS_1_1PollEventsState.md)
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::PollEventsState::ExecuteImpl () override
```
