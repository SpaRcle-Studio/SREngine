...
# Class SR\_SRLM\_NS::IComputeNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**IComputeNode**](classSR__SRLM__NS_1_1IComputeNode.md)
...
Inherited by the following classes: [SR\_SRLM\_NS::BreakStructNode](classSR__SRLM__NS_1_1BreakStructNode.md),  [SR\_SRLM\_NS::ConstructorNode](classSR__SRLM__NS_1_1ConstructorNode.md),  [SR\_SRLM\_NS::ConvertorNode](classSR__SRLM__NS_1_1ConvertorNode.md),  [SR\_SRLM\_NS::CreateStructNode](classSR__SRLM__NS_1_1CreateStructNode.md),  [SR\_SRLM\_NS::PlusNode](classSR__SRLM__NS_1_1PlusNode.md)
...
| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD const [**DataType**](classSR__SRLM__NS_1_1DataType.md) \* | [**GetOutput**](#function-getoutput) (uint32\_t index) override<br> |
| virtual void | [**MarkDirty**](#function-markdirty) () override<br> |
...
| Type | Name |
| ---: | :--- |
| typedef [**IExecutableNode**](classSR__SRLM__NS_1_1IExecutableNode.md) | [**Base**](#typedef-base)  <br> |
...
| Type | Name |
| ---: | :--- |
|  bool | [**m\_dirty**](#variable-m_dirty)   = `true`<br> |
...
| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD LogicalNodeType | [**GetType**](#function-gettype) () noexcept const<br> |
| virtual SR\_NODISCARD bool | [**IsDirty**](#function-isdirty) () noexcept override const<br> |
...
```C++
virtual SR_NODISCARD const DataType * SR_SRLM_NS::IComputeNode::GetOutput (
    uint32_t index
) override
```
...
Implements [*SR\_SRLM\_NS::LogicalNode::GetOutput*](classSR__SRLM__NS_1_1LogicalNode.md#function-getoutput)
...
```C++
virtual void SR_SRLM_NS::IComputeNode::MarkDirty () override
```



Implements [*SR\_SRLM\_NS::LogicalNode::MarkDirty*](classSR__SRLM__NS_1_1LogicalNode.md#function-markdirty)
...
```C++
using SR_SRLM_NS::IComputeNode::Base =  IExecutableNode;
```
...
```C++
bool SR_SRLM_NS::IComputeNode::m_dirty;
```
...
```C++
inline virtual SR_NODISCARD LogicalNodeType SR_SRLM_NS::IComputeNode::GetType () noexcept const
```



Implements [*SR\_SRLM\_NS::LogicalNode::GetType*](classSR__SRLM__NS_1_1LogicalNode.md#function-gettype)
...
```C++
inline virtual SR_NODISCARD bool SR_SRLM_NS::IComputeNode::IsDirty () noexcept override const
```



Implements [*SR\_SRLM\_NS::LogicalNode::IsDirty*](classSR__SRLM__NS_1_1LogicalNode.md#function-isdirty)
