...
# Class SR\_NETWORK\_NS::Server



[**ClassList**](annotated.md) **>** [**SR\_NETWORK\_NS**](namespaceSR__NETWORK__NS.md) **>** [**Server**](classSR__NETWORK__NS_1_1Server.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Server**](#function-server) (SocketType type, int32\_t domain, int32\_t service, int32\_t protocol, uint64\_t interface, int32\_t port, int32\_t backlog) <br> |
...
```C++
bool SR_NETWORK_NS::Server::Start () 
```
...
```C++
bool SR_NETWORK_NS::Server::Stop () 
```
