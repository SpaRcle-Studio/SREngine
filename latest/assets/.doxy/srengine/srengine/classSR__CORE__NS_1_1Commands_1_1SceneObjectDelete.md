...
# Class SR\_CORE\_NS::Commands::SceneObjectDelete



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**SceneObjectDelete**](classSR__CORE__NS_1_1Commands_1_1SceneObjectDelete.md)
...
|   | [**SceneObjectDelete**](#function-sceneobjectdelete) (const EnginePtr & pEngine, const SR\_UTILS\_NS::SceneObject::Ptr & pSO) <br> |
| virtual bool | [**Undo**](#function-undo) () override<br> |
|   | [**~SceneObjectDelete**](#function-sceneobjectdelete) () override<br> |
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectDelete::Redo () override
```
...
### function SceneObjectDelete 

```C++
SR_CORE_NS::Commands::SceneObjectDelete::SceneObjectDelete (
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectDelete::Undo () override
```
...
```C++
SR_CORE_NS::Commands::SceneObjectDelete::~SceneObjectDelete () override
```
