...
| Type | Name |
| ---: | :--- |
|  std::vector&lt; [**AnimationClip**](classSR__ANIMATIONS__NS_1_1AnimationClip.md) \* &gt; | [**Load**](#function-load-13) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path, const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & skeleton) <br> |
|  [**AnimationClip**](classSR__ANIMATIONS__NS_1_1AnimationClip.md) \* | [**Load**](#function-load-23) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path, const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & skeleton, [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name) <br> |
...
```C++
static std::vector< AnimationClip * > SR_ANIMATIONS_NS::AnimationClip::Load (
...
```C++
static AnimationClip * SR_ANIMATIONS_NS::AnimationClip::Load (
    const SR_UTILS_NS::Path & path,
    const SR_UTILS_NS::Path & skeleton,
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Animations/AnimationClip.h`
