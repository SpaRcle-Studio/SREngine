...
# Class SR\_ANIMATIONS\_NS::AnimationClip



[**ClassList**](annotated.md) **>** [**SR\_ANIMATIONS\_NS**](namespaceSR__ANIMATIONS__NS.md) **>** [**AnimationClip**](classSR__ANIMATIONS__NS_1_1AnimationClip.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**AnimationClip**](classSR__ANIMATIONS__NS_1_1AnimationClip.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**AnimationClip**](#function-animationclip) () <br> |
|  SR\_NODISCARD const std::vector&lt; [**AnimationChannel**](classSR__ANIMATIONS__NS_1_1AnimationChannel.md) \* &gt; & | [**GetChannels**](#function-getchannels) () const<br> |
|  SR\_NODISCARD [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**GetClipName**](#function-getclipname) () noexcept const<br> |
...
| Type | Name |
| ---: | :--- |
|  std::vector&lt; AnimationClip::Ptr &gt; | [**Load**](#function-load-13) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path, const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & skeleton) <br> |
|  AnimationClip::Ptr | [**Load**](#function-load-23) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path, const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & skeleton, [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name) <br> |
...
```C++
using SR_ANIMATIONS_NS::AnimationClip::Ptr =  SR_HTYPES_NS::SharedPtr<AnimationClip>;
```
...
```C++
SR_ANIMATIONS_NS::AnimationClip::AnimationClip () 
```
...
```C++
inline SR_NODISCARD const std::vector< AnimationChannel * > & SR_ANIMATIONS_NS::AnimationClip::GetChannels () const
```
...
```C++
SR_NODISCARD SR_UTILS_NS::StringAtom SR_ANIMATIONS_NS::AnimationClip::GetClipName () noexcept const
```
...
```C++
inline SR_NODISCARD float_t SR_ANIMATIONS_NS::AnimationClip::GetDuration () noexcept const
```
...
```C++
inline SR_NODISCARD uint32_t SR_ANIMATIONS_NS::AnimationClip::GetMaxKeyFrame () noexcept const
```
...
```C++
virtual SR_NODISCARD SR_UTILS_NS::Path SR_ANIMATIONS_NS::AnimationClip::InitializeResourcePath () override const
```
...
```C++
inline virtual SR_NODISCARD bool SR_ANIMATIONS_NS::AnimationClip::IsAllowedToRevive () override const
```
...
```C++
SR_ANIMATIONS_NS::AnimationClip::~AnimationClip () override
```
...
```C++
static std::vector< AnimationClip::Ptr > SR_ANIMATIONS_NS::AnimationClip::Load (
    const SR_UTILS_NS::Path & path,
    const SR_UTILS_NS::Path & skeleton
) 
```
...
```C++
static AnimationClip::Ptr SR_ANIMATIONS_NS::AnimationClip::Load (
    const SR_UTILS_NS::Path & path,
    const SR_UTILS_NS::Path & skeleton,
...
```C++
virtual bool SR_ANIMATIONS_NS::AnimationClip::Load () override
```
...
```C++
virtual bool SR_ANIMATIONS_NS::AnimationClip::Unload () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Animations/AnimationClip.h`
