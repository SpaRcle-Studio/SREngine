...
# Struct SR\_ANIMATIONS\_NS::Bone



[**ClassList**](annotated.md) **>** [**SR\_ANIMATIONS\_NS**](namespaceSR__ANIMATIONS__NS.md) **>** [**Bone**](structSR__ANIMATIONS__NS_1_1Bone.md)
...
| Type | Name |
| ---: | :--- |
|  std::vector&lt; [**Bone::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) &gt; | [**bones**](#variable-bones)  <br> |
|  [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SR\_UTILS\_NS::GameObject**](classSR__UTILS__NS_1_1GameObject.md) &gt; | [**gameObject**](#variable-gameobject)  <br> |
|  bool | [**hasError**](#variable-haserror)   = `false`<br> |
|  [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**name**](#variable-name)  <br> |
|  [**Bone**](structSR__ANIMATIONS__NS_1_1Bone.md) \* | [**pParent**](#variable-pparent)   = `nullptr`<br> |
|  [**Bone**](structSR__ANIMATIONS__NS_1_1Bone.md) \* | [**pRoot**](#variable-proot)   = `nullptr`<br> |
|  [**Skeleton**](classSR__ANIMATIONS__NS_1_1Skeleton.md) \* | [**pSkeleton**](#variable-pskeleton)   = `nullptr`<br> |
...
| Type | Name |
| ---: | :--- |
|   | [**Bone**](#function-bone) () <br> |
|  void | [**InitTreeIfNeed**](#function-inittreeifneed) () <br> |
|  bool | [**Initialize**](#function-initialize) () <br> |
|  void | [**SetSkeleton**](#function-setskeleton) ([**Skeleton**](classSR__ANIMATIONS__NS_1_1Skeleton.md) \* pSkeleton) <br> |
...
```C++
std::vector<Bone::Ptr> SR_ANIMATIONS_NS::Bone::bones;
```
...
```C++
SR_HTYPES_NS::SharedPtr<SR_UTILS_NS::GameObject> SR_ANIMATIONS_NS::Bone::gameObject;
```
...
```C++
bool SR_ANIMATIONS_NS::Bone::hasError;
```
...
```C++
SR_UTILS_NS::StringAtom SR_ANIMATIONS_NS::Bone::name;
```
...
```C++
Bone* SR_ANIMATIONS_NS::Bone::pParent;
```
...
```C++
Bone* SR_ANIMATIONS_NS::Bone::pRoot;
```
...
```C++
Skeleton* SR_ANIMATIONS_NS::Bone::pSkeleton;
```
...
```C++
inline SR_ANIMATIONS_NS::Bone::Bone () 
```
...
### function InitTreeIfNeed 

```C++
void SR_ANIMATIONS_NS::Bone::InitTreeIfNeed () 
```
...
```C++
bool SR_ANIMATIONS_NS::Bone::Initialize () 
```
...
```C++
inline void SR_ANIMATIONS_NS::Bone::SetSkeleton (
    Skeleton * pSkeleton
) 
```
