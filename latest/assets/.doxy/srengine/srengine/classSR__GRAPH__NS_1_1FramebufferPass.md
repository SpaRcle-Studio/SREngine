...
# Class SR\_GRAPH\_NS::FramebufferPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**FramebufferPass**](classSR__GRAPH__NS_1_1FramebufferPass.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::GroupPass](classSR__GRAPH__NS_1_1GroupPass.md),  [SR\_GRAPH\_NS::IFramebufferPass](classSR__GRAPH__NS_1_1IFramebufferPass.md)
...
```C++
virtual SR_NODISCARD IRenderTechnique * SR_GRAPH_NS::FramebufferPass::GetFrameBufferRenderTechnique () override const
```
...
```C++
virtual SR_NODISCARD std::vector< SR_GTYPES_NS::Framebuffer * > SR_GRAPH_NS::FramebufferPass::GetFrameBuffers () override const
```
...
```C++
virtual bool SR_GRAPH_NS::FramebufferPass::Init () override
```
...
```C++
virtual bool SR_GRAPH_NS::FramebufferPass::Load (
...
```C++
virtual void SR_GRAPH_NS::FramebufferPass::OnResize (
...
```C++
virtual bool SR_GRAPH_NS::FramebufferPass::PostRender () override
```
...
_Вызывается только во время построения_ 
```C++
virtual bool SR_GRAPH_NS::FramebufferPass::PreRender () override
```
...
_Вызывается только во время построения_ 
```C++
virtual bool SR_GRAPH_NS::FramebufferPass::Render () override
```
...
```C++
virtual void SR_GRAPH_NS::FramebufferPass::Update () override
```
