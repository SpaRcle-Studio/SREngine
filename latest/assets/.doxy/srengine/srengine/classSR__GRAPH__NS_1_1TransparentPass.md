...
# Class SR\_GRAPH\_NS::TransparentPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**TransparentPass**](classSR__GRAPH__NS_1_1TransparentPass.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::IMesh3DClusterPass](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md)
...
```C++
virtual SR_NODISCARD MeshClusterType SR_GRAPH_NS::TransparentPass::GetClusterType () noexcept override const
```
...
```C++
virtual void SR_GRAPH_NS::TransparentPass::UseSharedUniforms (
    ShaderPtr pShader
) override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Pass/TransparentPass.h`
