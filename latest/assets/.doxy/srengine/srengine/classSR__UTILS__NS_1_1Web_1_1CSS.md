...
# Class SR\_UTILS\_NS::Web::CSS



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**Web**](namespaceSR__UTILS__NS_1_1Web.md) **>** [**CSS**](classSR__UTILS__NS_1_1Web_1_1CSS.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**CSS**](classSR__UTILS__NS_1_1Web_1_1CSS.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  void | [**AddClassStyle**](#function-addclassstyle) (std::string && token, const [**CSSStyle**](structSR__UTILS__NS_1_1Web_1_1CSSStyle.md) & style) <br> |
|  void | [**AddTagStyle**](#function-addtagstyle) (std::string && token, const [**CSSStyle**](structSR__UTILS__NS_1_1Web_1_1CSSStyle.md) & style) <br> |
|   | [**CSS**](#function-css) () <br> |
|  SR\_NODISCARD const [**CSSStyle**](structSR__UTILS__NS_1_1Web_1_1CSSStyle.md) \* | [**GetClassStyle**](#function-getclassstyle) (const std::string & token) const<br> |
|  SR\_NODISCARD const [**CSSStyle**](structSR__UTILS__NS_1_1Web_1_1CSSStyle.md) \* | [**GetGlobalStyle**](#function-getglobalstyle) () const<br> |
|  SR\_NODISCARD [**CSSStyle**](structSR__UTILS__NS_1_1Web_1_1CSSStyle.md) \* | [**GetOrCreateStyle**](#function-getorcreatestyle) (std::string\_view token, bool isClass) <br> |
|  SR\_NODISCARD const [**CSSStyle**](structSR__UTILS__NS_1_1Web_1_1CSSStyle.md) \* | [**GetTagStyle**](#function-gettagstyle) (const std::string & token) const<br> |
...
```C++
using SR_UTILS_NS::Web::CSS::Ptr =  SR_HTYPES_NS::SharedPtr<CSS>;
```
...
```C++
inline void SR_UTILS_NS::Web::CSS::AddClassStyle (
    std::string && token,
...
```C++
inline void SR_UTILS_NS::Web::CSS::AddTagStyle (
    std::string && token,
    const CSSStyle & style
) 
```
...
```C++
inline SR_NODISCARD const CSSStyle * SR_UTILS_NS::Web::CSS::GetClassStyle (
...
```C++
inline SR_NODISCARD const CSSStyle * SR_UTILS_NS::Web::CSS::GetGlobalStyle () const
```
...
```C++
inline SR_NODISCARD CSSStyle * SR_UTILS_NS::Web::CSS::GetOrCreateStyle (
...
```C++
inline SR_NODISCARD const CSSStyle * SR_UTILS_NS::Web::CSS::GetTagStyle (
    const std::string & token
) const
```
...
```C++
SR_NODISCARD std::string SR_UTILS_NS::Web::CSS::ToString (
    uint16_t depth=0
) const
```
