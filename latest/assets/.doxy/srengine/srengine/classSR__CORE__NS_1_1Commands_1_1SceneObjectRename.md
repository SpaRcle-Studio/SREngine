...
# Class SR\_CORE\_NS::Commands::SceneObjectRename



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**SceneObjectRename**](classSR__CORE__NS_1_1Commands_1_1SceneObjectRename.md)
...
|   | [**SceneObjectRename**](#function-sceneobjectrename) (const EnginePtr & pEngine, const SR\_UTILS\_NS::SceneObject::Ptr & pSO, SR\_UTILS\_NS::SceneObject::ObjectNameT newName) <br> |
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectRename::Redo () override
```
...
### function SceneObjectRename 

```C++
SR_CORE_NS::Commands::SceneObjectRename::SceneObjectRename (
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectRename::Undo () override
```
