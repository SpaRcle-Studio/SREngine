...
# Class SR\_GRAPH\_NS::StartPassNode



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**StartPassNode**](classSR__GRAPH__NS_1_1StartPassNode.md)
...
```C++
virtual void SR_GRAPH_NS::StartPassNode::InitNode () override
```
