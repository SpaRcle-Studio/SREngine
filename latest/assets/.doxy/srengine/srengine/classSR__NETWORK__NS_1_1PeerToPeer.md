...
# Class SR\_NETWORK\_NS::PeerToPeer



[**ClassList**](annotated.md) **>** [**SR\_NETWORK\_NS**](namespaceSR__NETWORK__NS.md) **>** [**PeerToPeer**](classSR__NETWORK__NS_1_1PeerToPeer.md)
...
|  bool | [**Connect**](#function-connect) (const std::string & address, uint16\_t port) <br> |
|  SR\_NODISCARD const [**Acceptor::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) & | [**GetAcceptor**](#function-getacceptor) () const<br> |
|  SR\_NODISCARD uint32\_t | [**GetConnectionsCount**](#function-getconnectionscount) () const<br> |
|  SR\_NODISCARD uint32\_t | [**GetNewPeersCount**](#function-getnewpeerscount) () const<br> |
|  SR\_NODISCARD bool | [**HasConnection**](#function-hasconnection) (uint32\_t address, uint16\_t port) const<br> |
|  SR\_NODISCARD bool | [**IsOpen**](#function-isopen) () const<br> |
|  bool | [**Run**](#function-run) () <br> |
|  bool | [**SendKnownHosts**](#function-sendknownhosts) (const [**Socket::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) & pSocket) <br> |
|  void | [**SetOnAcceptCallback**](#function-setonacceptcallback) (Callback && callback) <br> |
| virtual  | [**~PeerToPeer**](#function-peertopeer) () = default<br> |
...
```C++
void SR_NETWORK_NS::PeerToPeer::Close () 
```
...
```C++
bool SR_NETWORK_NS::PeerToPeer::Connect (
...
```C++
inline SR_NODISCARD const Acceptor::Ptr & SR_NETWORK_NS::PeerToPeer::GetAcceptor () const
```
...
```C++
inline SR_NODISCARD uint32_t SR_NETWORK_NS::PeerToPeer::GetConnectionsCount () const
```
...
### function GetNewPeersCount 

```C++
inline SR_NODISCARD uint32_t SR_NETWORK_NS::PeerToPeer::GetNewPeersCount () const
```
...
```C++
SR_NODISCARD bool SR_NETWORK_NS::PeerToPeer::HasConnection (
    uint32_t address,
    uint16_t port
) const
```
...
```C++
inline SR_NODISCARD bool SR_NETWORK_NS::PeerToPeer::IsOpen () const
```
...
```C++
bool SR_NETWORK_NS::PeerToPeer::Run () 
```
...
### function SendKnownHosts 

```C++
bool SR_NETWORK_NS::PeerToPeer::SendKnownHosts (
    const Socket::Ptr & pSocket
) 
```
...
### function SetOnAcceptCallback 

```C++
inline void SR_NETWORK_NS::PeerToPeer::SetOnAcceptCallback (
    Callback && callback
) 
```
...
```C++
virtual SR_NETWORK_NS::PeerToPeer::~PeerToPeer () = default
```
