...
# Class SR\_CORE\_NS::Commands::EntityEnable



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**EntityEnable**](classSR__CORE__NS_1_1Commands_1_1EntityEnable.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EntityEnable**](#function-entityenable) (const EnginePtr & pEngine, const SR\_UTILS\_NS::Entity::Ptr & pEntity, bool newEnabled) <br> |
...
```C++
SR_CORE_NS::Commands::EntityEnable::EntityEnable (
    const EnginePtr & pEngine,
    const SR_UTILS_NS::Entity::Ptr & pEntity,
    bool newEnabled
) 
```
...
```C++
virtual bool SR_CORE_NS::Commands::EntityEnable::Redo () override
```
...
```C++
virtual bool SR_CORE_NS::Commands::EntityEnable::Undo () override
```
