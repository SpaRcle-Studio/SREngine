...
# Class SR\_CORE\_GUI\_NS::SceneTools



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**SceneTools**](classSR__CORE__GUI__NS_1_1SceneTools.md)
...
Inherits the following classes: [SR\_GRAPH\_GUI\_NS::WidgetContainer](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD float\_t | [**GetCameraVelocityFactor**](#function-getcameravelocityfactor) () noexcept const<br> |
|  SR\_NODISCARD SR\_GRAPH\_UI\_NS::GizmoMode | [**GetGizmoMode**](#function-getgizmomode) () noexcept const<br> |
|  SR\_NODISCARD SR\_GRAPH\_UI\_NS::GizmoOperation | [**GetGizmoOperation**](#function-getgizmooperation) () noexcept const<br> |
|  SR\_NODISCARD EditorSceneViewMode | [**GetViewMode**](#function-getviewmode) () noexcept const<br> |
| virtual void | [**Init**](#function-init) () override<br> |
|  SR\_NODISCARD bool | [**IsGizmo3D**](#function-isgizmo3d) () noexcept const<br> |
...
|   | [**SceneTools**](#function-scenetools) () <br> |


## Public Functions inherited from SR_GRAPH_GUI_NS::WidgetContainer

See [SR\_GRAPH\_GUI\_NS::WidgetContainer](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md)

| Type | Name |
| ---: | :--- |
|  [**WidgetContainerElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainerElement.md) & | [**AddElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md#function-addelement-13) ([**WidgetContainerElement::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) pElement) <br> |
|  [**WidgetContainerElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainerElement.md) & | [**AddElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md#function-addelement-23) () <br> |
|  [**WidgetContainerElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainerElement.md) & | [**AddElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md#function-addelement-33) (std::string text) <br> |
| virtual void | [**Draw**](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md#function-draw) () <br> |
|   | [**WidgetContainer**](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md#function-widgetcontainer) (std::string name) <br> |
...
## Protected Attributes inherited from SR_GRAPH_GUI_NS::WidgetContainer

See [SR\_GRAPH\_GUI\_NS::WidgetContainer](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md)

| Type | Name |
| ---: | :--- |
|  std::vector&lt; [**WidgetContainerElement::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) &gt; | [**m\_elements**](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md#variable-m_elements)  <br> |
...
### function GetCameraVelocityFactor 

```C++
inline SR_NODISCARD float_t SR_CORE_GUI_NS::SceneTools::GetCameraVelocityFactor () noexcept const
```
...
```C++
inline SR_NODISCARD SR_GRAPH_UI_NS::GizmoMode SR_CORE_GUI_NS::SceneTools::GetGizmoMode () noexcept const
```
...
### function GetGizmoOperation 

```C++
inline SR_NODISCARD SR_GRAPH_UI_NS::GizmoOperation SR_CORE_GUI_NS::SceneTools::GetGizmoOperation () noexcept const
```
...
```C++
inline SR_NODISCARD EditorSceneViewMode SR_CORE_GUI_NS::SceneTools::GetViewMode () noexcept const
```
...
```C++
virtual void SR_CORE_GUI_NS::SceneTools::Init () override
```
...
```C++
inline SR_NODISCARD bool SR_CORE_GUI_NS::SceneTools::IsGizmo3D () noexcept const
```
...
```C++
virtual void SR_CORE_GUI_NS::SceneTools::OnKeyDown (
...
```C++
inline SR_CORE_GUI_NS::SceneTools::SceneTools () 
```
