...
# Class SR\_CORE\_GUI\_NS::MaterialPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**MaterialPropertyDrawer**](classSR__CORE__GUI__NS_1_1MaterialPropertyDrawer.md)
...
Inherits the following classes: [SR\_CORE\_GUI\_NS::PointerPropertyDrawer](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md)
...
## Public Types inherited from SR_CORE_GUI_NS::PointerPropertyDrawer

See [SR\_CORE\_GUI\_NS::PointerPropertyDrawer](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md)

| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**PointerPropertyDrawer**](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md) &gt; | [**Ptr**](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual void | [**OnObjectReplaced**](#function-onobjectreplaced) (SRClass \* pOld, SRClass \* pNew) override<br> |


## Public Functions inherited from SR_CORE_GUI_NS::PointerPropertyDrawer

See [SR\_CORE\_GUI\_NS::PointerPropertyDrawer](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md)

| Type | Name |
| ---: | :--- |
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**Draw**](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md#function-draw) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) override<br> |
| virtual void | [**OnObjectReplaced**](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md#function-onobjectreplaced) (SRClass \* pOld, SRClass \* pNew) <br> |
...
### function OnObjectReplaced 

```C++
virtual void SR_CORE_GUI_NS::MaterialPropertyDrawer::OnObjectReplaced (
    SRClass * pOld,
    SRClass * pNew
) override
```
...
Implements [*SR\_CORE\_GUI\_NS::PointerPropertyDrawer::OnObjectReplaced*](classSR__CORE__GUI__NS_1_1PointerPropertyDrawer.md#function-onobjectreplaced)
