...
# Class SR\_GRAPH\_NS::IMeshClusterPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**IMeshClusterPass**](classSR__GRAPH__NS_1_1IMeshClusterPass.md)
...
Inherited by the following classes: [SR\_GRAPH\_NS::FlatClusterPass](classSR__GRAPH__NS_1_1FlatClusterPass.md),  [SR\_GRAPH\_NS::IMesh3DClusterPass](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md)
...
| Type | Name |
| ---: | :--- |
| struct | [**Sampler**](structSR__GRAPH__NS_1_1IMeshClusterPass_1_1Sampler.md) <br> |
...
| typedef std::vector&lt; [**Sampler**](structSR__GRAPH__NS_1_1IMeshClusterPass_1_1Sampler.md) &gt; | [**Samplers**](#typedef-samplers)  <br> |
...
| Type | Name |
| ---: | :--- |
|  bool | [**m\_dirtySamplers**](#variable-m_dirtysamplers)   = `true`<br> |
|  bool | [**m\_hasRendered**](#variable-m_hasrendered)   = `false`<br> |
|  MeshClusterType | [**m\_meshClusters**](#variable-m_meshclusters)   = `MeshClusterType::None`<br> |
|  bool | [**m\_needUpdateMeshes**](#variable-m_needupdatemeshes)   = `false`<br> |
|  Samplers | [**m\_samplers**](#variable-m_samplers)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD MeshClusterType | [**GetClusterType**](#function-getclustertype) () noexcept const<br> |
| virtual SR\_NODISCARD ShaderPtr | [**GetShader**](#function-getshader) (SR\_SRSL\_NS::ShaderType shaderType) const<br> |
| virtual void | [**OnClusterDirty**](#function-onclusterdirty) () <br> |
| virtual void | [**PrepareFBODependencies**](#function-preparefbodependencies) () <br> |
| virtual void | [**PrepareSamplers**](#function-preparesamplers) () <br> |
| virtual void | [**UseConstants**](#function-useconstants) (ShaderPtr pShader) <br> |
| virtual void | [**UseSamplers**](#function-usesamplers) (ShaderPtr pShader) <br> |
| virtual void | [**UseSharedUniforms**](#function-useshareduniforms) (ShaderPtr pShader) <br> |
| virtual void | [**UseUniforms**](#function-useuniforms) (ShaderPtr pShader, MeshPtr pMesh) <br> |
...
```C++
using SR_GRAPH_NS::IMeshClusterPass::FramebufferPtr =  SR_GTYPES_NS::Framebuffer*;
```
...
```C++
using SR_GRAPH_NS::IMeshClusterPass::MeshPtr =  SR_GTYPES_NS::Mesh*;
```
...
```C++
using SR_GRAPH_NS::IMeshClusterPass::Samplers =  std::vector<Sampler>;
```
...
```C++
using SR_GRAPH_NS::IMeshClusterPass::ShaderPtr =  SR_HTYPES_NS::SharedPtr<SR_GTYPES_NS::Shader>;
```
...
```C++
virtual bool SR_GRAPH_NS::IMeshClusterPass::Init () override
```
...
```C++
virtual bool SR_GRAPH_NS::IMeshClusterPass::Load (
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::OnMultisampleChanged () override
```
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::OnResize (
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::Prepare () override
```
...
```C++
virtual bool SR_GRAPH_NS::IMeshClusterPass::Render () override
```
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::Update () override
```
...
### variable m\_dirtySamplers 

```C++
bool SR_GRAPH_NS::IMeshClusterPass::m_dirtySamplers;
```
...
### variable m\_hasRendered 

```C++
bool SR_GRAPH_NS::IMeshClusterPass::m_hasRendered;
```
...
### variable m\_meshClusters 

```C++
MeshClusterType SR_GRAPH_NS::IMeshClusterPass::m_meshClusters;
```
...
### variable m\_needUpdateMeshes 

```C++
bool SR_GRAPH_NS::IMeshClusterPass::m_needUpdateMeshes;
```
...
```C++
Samplers SR_GRAPH_NS::IMeshClusterPass::m_samplers;
```
...
```C++
virtual SR_NODISCARD MeshClusterType SR_GRAPH_NS::IMeshClusterPass::GetClusterType () noexcept const
```
...
```C++
inline virtual SR_NODISCARD ShaderPtr SR_GRAPH_NS::IMeshClusterPass::GetShader (
    SR_SRSL_NS::ShaderType shaderType
) const
```
...
```C++
inline virtual void SR_GRAPH_NS::IMeshClusterPass::OnClusterDirty () 
```
...
### function PrepareFBODependencies 

```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::PrepareFBODependencies () 
```
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::PrepareSamplers () 
```
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::UseConstants (
    ShaderPtr pShader
) 
```
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::UseSamplers (
    ShaderPtr pShader
) 
```
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::UseSharedUniforms (
    ShaderPtr pShader
) 
```
...
```C++
virtual void SR_GRAPH_NS::IMeshClusterPass::UseUniforms (
    ShaderPtr pShader,
    MeshPtr pMesh
) 
```
