...
```C++
virtual void SR_GTYPES_NS::IndexedMesh::FreeVMemory () override
```



Implements [*SR\_GTYPES\_NS::Mesh::FreeVMemory*](classSR__GTYPES__NS_1_1Mesh.md#function-freevmemory)
