...
# Class SR\_GRAPH\_NS::ShadowMapPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**ShadowMapPass**](classSR__GRAPH__NS_1_1ShadowMapPass.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::ShaderOverridePass](classSR__GRAPH__NS_1_1ShaderOverridePass.md)
...
## Public Types inherited from SR_GRAPH_NS::IMeshClusterPass

See [SR\_GRAPH\_NS::IMeshClusterPass](classSR__GRAPH__NS_1_1IMeshClusterPass.md)

| Type | Name |
| ---: | :--- |
| typedef [**SR\_GTYPES\_NS::Framebuffer**](classSR__GTYPES__NS_1_1Framebuffer.md) \* | [**FramebufferPtr**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#typedef-framebufferptr)  <br> |
| typedef [**SR\_GTYPES\_NS::Mesh**](classSR__GTYPES__NS_1_1Mesh.md) \* | [**MeshPtr**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#typedef-meshptr)  <br> |
| typedef std::vector&lt; [**Sampler**](structSR__GRAPH__NS_1_1IMeshClusterPass_1_1Sampler.md) &gt; | [**Samplers**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#typedef-samplers)  <br> |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) &gt; | [**ShaderPtr**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#typedef-shaderptr)  <br> |
...
|  SR\_NODISCARD const [**SR\_MATH\_NS::Matrix4x4**](classSR__MATH__NS_1_1Matrix4x4.md) & | [**GetLightSpaceMatrix**](#function-getlightspacematrix) () noexcept const<br> |
...
## Public Functions inherited from SR_GRAPH_NS::ShaderOverridePass

See [SR\_GRAPH\_NS::ShaderOverridePass](classSR__GRAPH__NS_1_1ShaderOverridePass.md)

| Type | Name |
| ---: | :--- |
| virtual bool | [**Init**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-init) () override<br> |
| virtual bool | [**Load**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-load) (const SR\_XML\_NS::Node & passNode) override<br> |
| virtual void | [**OnResize**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-onresize) (const SR\_MATH\_NS::UVector2 & size) override<br> |
| virtual bool | [**Render**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-render) () override<br>_Вызывается только во время построения_  |
| virtual void | [**Update**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-update) () override<br>_Вызывается постоянно после построения_  |
|   | [**~ShaderOverridePass**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-shaderoverridepass) () override<br> |


## Public Functions inherited from SR_GRAPH_NS::IMesh3DClusterPass

See [SR\_GRAPH\_NS::IMesh3DClusterPass](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md)

| Type | Name |
| ---: | :--- |
| virtual bool | [**Init**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-init) () override<br> |


## Public Functions inherited from SR_GRAPH_NS::IMeshClusterPass

See [SR\_GRAPH\_NS::IMeshClusterPass](classSR__GRAPH__NS_1_1IMeshClusterPass.md)

| Type | Name |
| ---: | :--- |
| virtual bool | [**Init**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-init) () override<br> |
| virtual bool | [**Load**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-load) (const SR\_XML\_NS::Node & passNode) override<br> |
| virtual void | [**OnMultisampleChanged**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-onmultisamplechanged) () override<br> |
| virtual void | [**OnResize**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-onresize) (const SR\_MATH\_NS::UVector2 & size) override<br> |
| virtual void | [**Prepare**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-prepare) () override<br>_Вызывается всегда но полсе оверлея_  |
| virtual bool | [**Render**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-render) () override<br>_Вызывается только во время построения_  |
| virtual void | [**Update**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-update) () override<br>_Вызывается постоянно после построения_  |
...
## Protected Attributes inherited from SR_GRAPH_NS::IMesh3DClusterPass

See [SR\_GRAPH\_NS::IMesh3DClusterPass](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md)

| Type | Name |
| ---: | :--- |
|  [**CascadedShadowMapPass**](classSR__GRAPH__NS_1_1CascadedShadowMapPass.md) \* | [**m\_cascadedShadowMapPass**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#variable-m_cascadedshadowmappass)   = `nullptr`<br> |
|  [**ShadowMapPass**](classSR__GRAPH__NS_1_1ShadowMapPass.md) \* | [**m\_shadowMapPass**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#variable-m_shadowmappass)   = `nullptr`<br> |


## Protected Attributes inherited from SR_GRAPH_NS::IMeshClusterPass

See [SR\_GRAPH\_NS::IMeshClusterPass](classSR__GRAPH__NS_1_1IMeshClusterPass.md)

| Type | Name |
| ---: | :--- |
|  bool | [**m\_dirtySamplers**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#variable-m_dirtysamplers)   = `true`<br> |
|  bool | [**m\_hasRendered**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#variable-m_hasrendered)   = `false`<br> |
|  MeshClusterType | [**m\_meshClusters**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#variable-m_meshclusters)   = `MeshClusterType::None`<br> |
|  bool | [**m\_needUpdateMeshes**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#variable-m_needupdatemeshes)   = `false`<br> |
|  Samplers | [**m\_samplers**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#variable-m_samplers)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD MeshClusterType | [**GetClusterType**](#function-getclustertype) () noexcept override const<br> |
| virtual void | [**UseSharedUniforms**](#function-useshareduniforms) (ShaderPtr pShader) override<br> |
| virtual void | [**UseUniforms**](#function-useuniforms) (ShaderPtr pShader, MeshPtr pMesh) override<br> |


## Protected Functions inherited from SR_GRAPH_NS::ShaderOverridePass

See [SR\_GRAPH\_NS::ShaderOverridePass](classSR__GRAPH__NS_1_1ShaderOverridePass.md)

| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD [**IRenderTechnique**](classSR__GRAPH__NS_1_1IRenderTechnique.md) \* | [**GetFrameBufferRenderTechnique**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-getframebufferrendertechnique) () override const<br> |
| virtual SR\_NODISCARD std::vector&lt; [**SR\_GTYPES\_NS::Framebuffer**](classSR__GTYPES__NS_1_1Framebuffer.md) \* &gt; | [**GetFrameBuffers**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-getframebuffers) () override const<br> |
| virtual SR\_NODISCARD ShaderPtr | [**GetShader**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-getshader) (SR\_SRSL\_NS::ShaderType type) override const<br> |
| virtual void | [**UseSharedUniforms**](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-useshareduniforms) (ShaderPtr pShader) override<br> |


## Protected Functions inherited from SR_GRAPH_NS::IMesh3DClusterPass

See [SR\_GRAPH\_NS::IMesh3DClusterPass](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md)

| Type | Name |
| ---: | :--- |
| virtual void | [**MarkDirtyCluster**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-markdirtycluster) ([**MeshCluster**](classSR__GRAPH__NS_1_1MeshCluster.md) & meshCluster) <br> |
| virtual void | [**OnClusterDirty**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-onclusterdirty) () override<br> |
| virtual bool | [**Render**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-render) () override<br>_Вызывается только во время построения_  |
| virtual bool | [**RenderCluster**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-rendercluster) ([**MeshCluster**](classSR__GRAPH__NS_1_1MeshCluster.md) & meshCluster) <br> |
| virtual void | [**Update**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-update) () override<br>_Вызывается постоянно после построения_  |
| virtual void | [**UpdateCluster**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-updatecluster) ([**MeshCluster**](classSR__GRAPH__NS_1_1MeshCluster.md) & meshCluster) <br> |


## Protected Functions inherited from SR_GRAPH_NS::IMeshClusterPass

See [SR\_GRAPH\_NS::IMeshClusterPass](classSR__GRAPH__NS_1_1IMeshClusterPass.md)

| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD MeshClusterType | [**GetClusterType**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-getclustertype) () noexcept const<br> |
| virtual SR\_NODISCARD ShaderPtr | [**GetShader**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-getshader) (SR\_SRSL\_NS::ShaderType shaderType) const<br> |
| virtual void | [**OnClusterDirty**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-onclusterdirty) () <br> |
| virtual void | [**PrepareFBODependencies**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-preparefbodependencies) () <br> |
| virtual void | [**PrepareSamplers**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-preparesamplers) () <br> |
| virtual void | [**UseConstants**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-useconstants) (ShaderPtr pShader) <br> |
| virtual void | [**UseSamplers**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-usesamplers) (ShaderPtr pShader) <br> |
| virtual void | [**UseSharedUniforms**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-useshareduniforms) (ShaderPtr pShader) <br> |
| virtual void | [**UseUniforms**](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-useuniforms) (ShaderPtr pShader, MeshPtr pMesh) <br> |
...
```C++
virtual void SR_GRAPH_NS::ShadowMapPass::DeInit () override
```
...
```C++
inline SR_NODISCARD const SR_MATH_NS::Matrix4x4 & SR_GRAPH_NS::ShadowMapPass::GetLightSpaceMatrix () noexcept const
```
...
```C++
virtual bool SR_GRAPH_NS::ShadowMapPass::Init () override
```



Implements [*SR\_GRAPH\_NS::ShaderOverridePass::Init*](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-init)
...
```C++
virtual bool SR_GRAPH_NS::ShadowMapPass::Load (
...
Implements [*SR\_GRAPH\_NS::ShaderOverridePass::Load*](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-load)
...
```C++
virtual bool SR_GRAPH_NS::ShadowMapPass::Render () override
```



Implements [*SR\_GRAPH\_NS::ShaderOverridePass::Render*](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-render)
...
```C++
virtual SR_NODISCARD MeshClusterType SR_GRAPH_NS::ShadowMapPass::GetClusterType () noexcept override const
```



Implements [*SR\_GRAPH\_NS::IMeshClusterPass::GetClusterType*](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-getclustertype)
...
```C++
virtual void SR_GRAPH_NS::ShadowMapPass::UseSharedUniforms (
    ShaderPtr pShader
) override
```
...
Implements [*SR\_GRAPH\_NS::ShaderOverridePass::UseSharedUniforms*](classSR__GRAPH__NS_1_1ShaderOverridePass.md#function-useshareduniforms)
...
```C++
virtual void SR_GRAPH_NS::ShadowMapPass::UseUniforms (
    ShaderPtr pShader,
    MeshPtr pMesh
) override
```
...
Implements [*SR\_GRAPH\_NS::IMeshClusterPass::UseUniforms*](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-useuniforms)


<hr>

------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Pass/ShadowMapPass.h`
