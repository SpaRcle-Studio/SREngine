...
# Class SR\_GRAPH\_NS::PointLight



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**PointLight**](classSR__GRAPH__NS_1_1PointLight.md)
...
```C++
inline virtual SR_NODISCARD LightType SR_GRAPH_NS::PointLight::GetLightType () override const
```
...
```C++
float_t SR_GRAPH_NS::PointLight::m_radius;
```
