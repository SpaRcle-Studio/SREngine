...
# Class SR\_UTILS\_NS::TransformHolder



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**TransformHolder**](classSR__UTILS__NS_1_1TransformHolder.md)
...
```C++
inline virtual SR_NODISCARD Measurement SR_UTILS_NS::TransformHolder::GetMeasurement () override const
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/ECS/TransformZero.h`
