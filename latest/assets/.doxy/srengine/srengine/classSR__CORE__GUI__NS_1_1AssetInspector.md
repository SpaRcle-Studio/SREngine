...
# Class SR\_CORE\_GUI\_NS::AssetInspector



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**AssetInspector**](classSR__CORE__GUI__NS_1_1AssetInspector.md)
...
| Type | Name |
| ---: | :--- |
|   | [**AssetInspector**](#function-assetinspector) () <br> |
|  void | [**Inspect**](#function-inspect) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
|   | [**~AssetInspector**](#function-assetinspector) () override<br> |
...
```C++
SR_CORE_GUI_NS::AssetInspector::AssetInspector () 
```
...
```C++
void SR_CORE_GUI_NS::AssetInspector::Inspect (
...
```C++
SR_CORE_GUI_NS::AssetInspector::~AssetInspector () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/inc/Engine/GUI/AssetInspector.h`
