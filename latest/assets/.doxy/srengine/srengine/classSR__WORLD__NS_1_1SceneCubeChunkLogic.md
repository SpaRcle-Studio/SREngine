...
# Class SR\_WORLD\_NS::SceneCubeChunkLogic



[**ClassList**](annotated.md) **>** [**SR\_WORLD\_NS**](namespaceSR__WORLD__NS.md) **>** [**SceneCubeChunkLogic**](classSR__WORLD__NS_1_1SceneCubeChunkLogic.md)
...
|  SR\_NODISCARD [**Chunk**](classSR__WORLD__NS_1_1Chunk.md) \* | [**GetCurrentChunk**](#function-getcurrentchunk) () const<br> |
|  SR\_NODISCARD const std::vector&lt; SceneObject::Ptr &gt; & | [**GetGameObjectsAtChunk**](#function-getgameobjectsatchunk) (const SR\_MATH\_NS::IVector3 & region, const SR\_MATH\_NS::IVector3 & chunk) const<br> |
|  SR\_NODISCARD [**Observer**](classSR__WORLD__NS_1_1Observer.md) \* | [**GetObserver**](#function-getobserver) () const<br> |
|  SR\_NODISCARD [**Region**](classSR__WORLD__NS_1_1Region.md) \* | [**GetOrLoadRegion**](#function-getorloadregion) (const SR\_MATH\_NS::IVector3 & region) <br> |
|  SR\_NODISCARD [**Region**](classSR__WORLD__NS_1_1Region.md) \* | [**GetRegion**](#function-getregion) (const SR\_MATH\_NS::IVector3 & region) const<br> |
|  SR\_NODISCARD std::pair&lt; SR\_MATH\_NS::IVector3, SR\_MATH\_NS::IVector3 &gt; | [**GetRegionAndChunk**](#function-getregionandchunk) (const SR\_MATH\_NS::FVector3 & pos) const<br> |
|  SR\_NODISCARD Path | [**GetRegionsPath**](#function-getregionspath) () const<br> |
| virtual SR\_NODISCARD [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) | [**GetSceneDataPath**](#function-getscenedatapath) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) override const<br> |
...
|  SR\_NODISCARD SR\_MATH\_NS::FVector3 | [**GetWorldPosition**](#function-getworldposition) (const SR\_MATH\_NS::IVector3 & region, const SR\_MATH\_NS::IVector3 & chunk) const<br> |
| virtual void | [**InitLogic**](#function-initlogic) () override<br> |
|  SR\_NODISCARD bool | [**IsChunkLoaded**](#function-ischunkloaded) (const SR\_MATH\_NS::IVector3 & region, const SR\_MATH\_NS::IVector3 & chunk) const<br> |
...
|  bool | [**ReloadChunks**](#function-reloadchunks) () <br> |
| virtual bool | [**SaveLogic**](#function-savelogic) (ISerializer & serializer, const Path & path) override<br> |
|  SR\_NODISCARD bool | [**ScopeCheckFunction**](#function-scopecheckfunction) (int32\_t x, int32\_t y, int32\_t z) const<br> |
|  void | [**SetObserver**](#function-setobserver) (const SceneObject::Ptr & target) <br> |
| virtual void | [**SetScene**](#function-setscene) (const ScenePtr & pScene) override<br> |
|  void | [**SetWorldOffset**](#function-setworldoffset) (const [**SR\_WORLD\_NS::Offset**](structSR__WORLD__NS_1_1Offset.md) & offset) <br> |
| virtual void | [**Update**](#function-update) (float\_t dt) override<br> |
|  void | [**UpdateDebug**](#function-updatedebug) () <br> |
|   | [**~SceneCubeChunkLogic**](#function-scenecubechunklogic) () override<br> |
...
```C++
virtual void SR_WORLD_NS::SceneCubeChunkLogic::Destroy () override
```



Implements [*SR\_WORLD\_NS::SceneLogic::Destroy*](classSR__WORLD__NS_1_1SceneLogic.md#function-destroy)
...
```C++
SR_NODISCARD Chunk * SR_WORLD_NS::SceneCubeChunkLogic::GetCurrentChunk () const
```
...
### function GetGameObjectsAtChunk 

```C++
SR_NODISCARD const std::vector< SceneObject::Ptr > & SR_WORLD_NS::SceneCubeChunkLogic::GetGameObjectsAtChunk (
...
```C++
inline SR_NODISCARD Observer * SR_WORLD_NS::SceneCubeChunkLogic::GetObserver () const
```
...
```C++
SR_NODISCARD Region * SR_WORLD_NS::SceneCubeChunkLogic::GetOrLoadRegion (
    const SR_MATH_NS::IVector3 & region
) 
```
...
```C++
SR_NODISCARD Region * SR_WORLD_NS::SceneCubeChunkLogic::GetRegion (
    const SR_MATH_NS::IVector3 & region
) const
```
...
### function GetRegionAndChunk 

```C++
SR_NODISCARD std::pair< SR_MATH_NS::IVector3, SR_MATH_NS::IVector3 > SR_WORLD_NS::SceneCubeChunkLogic::GetRegionAndChunk (
...
```C++
SR_NODISCARD Path SR_WORLD_NS::SceneCubeChunkLogic::GetRegionsPath () const
```
...
```C++
virtual SR_NODISCARD SR_UTILS_NS::Path SR_WORLD_NS::SceneCubeChunkLogic::GetSceneDataPath (
...
Implements [*SR\_WORLD\_NS::SceneLogic::GetSceneDataPath*](classSR__WORLD__NS_1_1SceneLogic.md#function-getscenedatapath)
...
```C++
inline virtual SR_NODISCARD StringAtom SR_WORLD_NS::SceneCubeChunkLogic::GetSceneExtension () noexcept override const
```
...
```C++
inline virtual SR_NODISCARD SceneLogicType SR_WORLD_NS::SceneCubeChunkLogic::GetType () noexcept override const
```
...
```C++
SR_NODISCARD SR_MATH_NS::FVector3 SR_WORLD_NS::SceneCubeChunkLogic::GetWorldPosition (
    const SR_MATH_NS::IVector3 & region,
    const SR_MATH_NS::IVector3 & chunk
) const
```
...
```C++
virtual void SR_WORLD_NS::SceneCubeChunkLogic::InitLogic () override
```
...
```C++
SR_NODISCARD bool SR_WORLD_NS::SceneCubeChunkLogic::IsChunkLoaded (
    const SR_MATH_NS::IVector3 & region,
    const SR_MATH_NS::IVector3 & chunk
) const
```
...
```C++
virtual bool SR_WORLD_NS::SceneCubeChunkLogic::LoadLogic (
...
```C++
virtual void SR_WORLD_NS::SceneCubeChunkLogic::Prepare () override
```



Implements [*SR\_WORLD\_NS::SceneLogic::Prepare*](classSR__WORLD__NS_1_1SceneLogic.md#function-prepare)
...
```C++
virtual bool SR_WORLD_NS::SceneCubeChunkLogic::Reload () override
```



Implements [*SR\_WORLD\_NS::SceneLogic::Reload*](classSR__WORLD__NS_1_1SceneLogic.md#function-reload)
...
```C++
bool SR_WORLD_NS::SceneCubeChunkLogic::ReloadChunks () 
```
...
```C++
virtual bool SR_WORLD_NS::SceneCubeChunkLogic::SaveLogic (
...
### function ScopeCheckFunction 

```C++
SR_NODISCARD bool SR_WORLD_NS::SceneCubeChunkLogic::ScopeCheckFunction (
    int32_t x,
    int32_t y,
    int32_t z
) const
...
```C++
void SR_WORLD_NS::SceneCubeChunkLogic::SetObserver (
    const SceneObject::Ptr & target
) 
```
...
```C++
virtual void SR_WORLD_NS::SceneCubeChunkLogic::SetScene (
...
Implements [*SR\_WORLD\_NS::SceneLogic::SetScene*](classSR__WORLD__NS_1_1SceneLogic.md#function-setscene)
...
```C++
void SR_WORLD_NS::SceneCubeChunkLogic::SetWorldOffset (
    const SR_WORLD_NS::Offset & offset
) 
```
...
```C++
virtual void SR_WORLD_NS::SceneCubeChunkLogic::Update (
    float_t dt
) override
```
...
Implements [*SR\_WORLD\_NS::SceneLogic::Update*](classSR__WORLD__NS_1_1SceneLogic.md#function-update)
...
```C++
void SR_WORLD_NS::SceneCubeChunkLogic::UpdateDebug () 
```
...
### function ~SceneCubeChunkLogic 

```C++
SR_WORLD_NS::SceneCubeChunkLogic::~SceneCubeChunkLogic () override
```
