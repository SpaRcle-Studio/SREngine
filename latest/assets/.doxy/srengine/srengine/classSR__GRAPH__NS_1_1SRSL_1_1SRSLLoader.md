...
# Class SR\_GRAPH\_NS::SRSL::SRSLLoader



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**SRSL**](namespaceSR__GRAPH__NS_1_1SRSL.md) **>** [**SRSLLoader**](classSR__GRAPH__NS_1_1SRSL_1_1SRSLLoader.md)
...
| Type | Name |
| ---: | :--- |
|  std::optional&lt; [**SRSLUnit**](structSR__GRAPH__NS_1_1SRSL_1_1SRSLUnit.md) &gt; | [**Load**](#function-load) (std::string path) <br> |
...
```C++
std::optional< SRSLUnit > SR_GRAPH_NS::SRSL::SRSLLoader::Load (
    std::string path
) 
```
...
### friend Singleton&lt; SRSLLoader &gt; 

```C++
class SR_GRAPH_NS::SRSL::SRSLLoader::Singleton< SRSLLoader > (
    SR_UTILS_NS::Singleton < SRSLLoader >
) 
```
