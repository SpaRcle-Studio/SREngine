...
# Class SR\_GRAPH\_UI\_NS::UISizeComponent



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_UI\_NS**](namespaceSR__GRAPH__UI__NS.md) **>** [**UISizeComponent**](classSR__GRAPH__UI__NS_1_1UISizeComponent.md)
...
Inherits the following classes: [SR\_UTILS\_NS::UI::UIModifierComponent](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md)
...
| Type | Name |
| ---: | :--- |
| virtual void | [**Prepare**](#function-prepare) ([**SR\_UTILS\_NS::UI::UIModifierContext**](structSR__UTILS__NS_1_1UI_1_1UIModifierContext.md) & context) override const<br> |


## Public Functions inherited from SR_UTILS_NS::UI::UIModifierComponent

See [SR\_UTILS\_NS::UI::UIModifierComponent](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md)

| Type | Name |
| ---: | :--- |
| virtual void | [**ApplyChild**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-applychild) ([**UIModifierContext**](structSR__UTILS__NS_1_1UI_1_1UIModifierContext.md) & context) const<br> |
| virtual SR\_NODISCARD bool | [**ExecuteInEditMode**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-executeineditmode) () override const<br> |
| virtual void | [**OnAttached**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-onattached) () override<br>_Вызывается после добавления компонента к игровому объекту_  |
| virtual void | [**OnDestroy**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-ondestroy) () override<br>_Вызывается когда компонент убирается с объекта, либо объект уничтожается. Может произойти отложенно._  |
| virtual void | [**OnDetached**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-ondetached) () override<br>_Вызывается когда компонент убирается с объекта, но до OnDestroy и только если был OnAttached._  |
| virtual void | [**OnTransformSet**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-ontransformset) () override<br> |
| virtual void | [**PostProcess**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-postprocess) ([**UIModifierContext**](structSR__UTILS__NS_1_1UI_1_1UIModifierContext.md) & context) const<br> |
| virtual void | [**Prepare**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-prepare) ([**UIModifierContext**](structSR__UTILS__NS_1_1UI_1_1UIModifierContext.md) & context) const<br> |
|   | [**~UIModifierComponent**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-uimodifiercomponent) () override<br> |
...
## Protected Functions inherited from SR_UTILS_NS::UI::UIModifierComponent

See [SR\_UTILS\_NS::UI::UIModifierComponent](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md)

| Type | Name |
| ---: | :--- |
|  void | [**SetUITreeDirty**](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-setuitreedirty) () <br> |
...
```C++
virtual void SR_GRAPH_UI_NS::UISizeComponent::Prepare (
    SR_UTILS_NS::UI::UIModifierContext & context
) override const
```



Implements [*SR\_UTILS\_NS::UI::UIModifierComponent::Prepare*](classSR__UTILS__NS_1_1UI_1_1UIModifierComponent.md#function-prepare)
...
```C++
void SR_GRAPH_UI_NS::UISizeComponent::OnChanged () 
```
