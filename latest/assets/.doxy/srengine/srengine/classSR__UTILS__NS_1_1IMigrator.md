...
# Class SR\_UTILS\_NS::IMigrator



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**IMigrator**](classSR__UTILS__NS_1_1IMigrator.md)
...
| Type | Name |
| ---: | :--- |
|   | [**IMigrator**](#function-imigrator) () <br> |
| virtual SR\_NODISCARD MigrationResult | [**Migrate**](#function-migrate) ([**SR\_UTILS\_NS::SerializationNode**](structSR__UTILS__NS_1_1SerializationNode.md) & node) = 0<br> |
...
```C++
inline SR_UTILS_NS::IMigrator::IMigrator () 
```
...
```C++
virtual SR_NODISCARD MigrationResult SR_UTILS_NS::IMigrator::Migrate (
