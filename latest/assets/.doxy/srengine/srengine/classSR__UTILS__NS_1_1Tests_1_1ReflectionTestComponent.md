...
# Class SR\_UTILS\_NS::Tests::ReflectionTestComponent



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**Tests**](namespaceSR__UTILS__NS_1_1Tests.md) **>** [**ReflectionTestComponent**](classSR__UTILS__NS_1_1Tests_1_1ReflectionTestComponent.md)
...
```C++
inline std::vector< float > & SR_UTILS_NS::Tests::ReflectionTestComponent::GetTest () 
```
...
### function IsWidthChangeable 

```C++
inline SR_NODISCARD const bool & SR_UTILS_NS::Tests::ReflectionTestComponent::IsWidthChangeable () const
```
...
```C++
inline void SR_UTILS_NS::Tests::ReflectionTestComponent::OnChanged () 
```
