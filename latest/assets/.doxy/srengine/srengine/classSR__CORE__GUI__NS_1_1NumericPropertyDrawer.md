...
# Class SR\_CORE\_GUI\_NS::NumericPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**NumericPropertyDrawer**](classSR__CORE__GUI__NS_1_1NumericPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**NumericPropertyDrawer**](classSR__CORE__GUI__NS_1_1NumericPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_CORE_GUI_NS::NumericPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<NumericPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::NumericPropertyDrawer::Draw (
