...
# Class SR\_UTILS\_NS::MigrationManager



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**MigrationManager**](classSR__UTILS__NS_1_1MigrationManager.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD MigrationResult | [**Migrate**](#function-migrate) ([**SR\_UTILS\_NS::IDeserializer**](classSR__UTILS__NS_1_1IDeserializer.md) & deserializer, [**SR\_UTILS\_NS::Serializable**](classSR__UTILS__NS_1_1Serializable.md) & obj, Version from, Version to) <br> |
...
```C++
SR_NODISCARD MigrationResult SR_UTILS_NS::MigrationManager::Migrate (
