...
# Class SR\_CORE\_NS::DrawState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**DrawState**](classSR__CORE__NS_1_1DrawState.md)
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::DrawState::ExecuteImpl () override
```
