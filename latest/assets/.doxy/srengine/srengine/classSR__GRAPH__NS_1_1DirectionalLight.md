...
# Class SR\_GRAPH\_NS::DirectionalLight



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**DirectionalLight**](classSR__GRAPH__NS_1_1DirectionalLight.md)
...
```C++
inline virtual SR_NODISCARD LightType SR_GRAPH_NS::DirectionalLight::GetLightType () override const
```
...
```C++
virtual void SR_GRAPH_NS::DirectionalLight::OnAttached () override
```
