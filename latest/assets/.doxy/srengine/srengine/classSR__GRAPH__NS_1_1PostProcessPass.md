...
# Class SR\_GRAPH\_NS::PostProcessPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**PostProcessPass**](classSR__GRAPH__NS_1_1PostProcessPass.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::BasePass](classSR__GRAPH__NS_1_1BasePass.md),  [SR\_GRAPH\_NS::ISamplersPass](classSR__GRAPH__NS_1_1ISamplersPass.md)


Inherited by the following classes: [SR\_GRAPH\_NS::SSAOPass](classSR__GRAPH__NS_1_1SSAOPass.md)
...
| virtual void | [**OnResourceUpdated**](#function-onresourceupdated) ([**SR\_UTILS\_NS::ResourceContainer**](classSR__UTILS__NS_1_1ResourceContainer.md) \* pContainer, int32\_t depth) override<br> |
...
|  uint32\_t | [**m\_vertices**](#variable-m_vertices)   = `0`<br> |
...
|  void | [**SetShader**](#function-setshader) (const [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) &gt; & pShader) <br> |
...
```C++
virtual bool SR_GRAPH_NS::PostProcessPass::Load (
...
```C++
virtual void SR_GRAPH_NS::PostProcessPass::OnMultisampleChanged () override
```
...
```C++
virtual void SR_GRAPH_NS::PostProcessPass::OnResize (
...
```C++
virtual void SR_GRAPH_NS::PostProcessPass::OnResourceUpdated (
    SR_UTILS_NS::ResourceContainer * pContainer,
    int32_t depth
) override
```
...
Implements [*SR\_UTILS\_NS::ResourceContainer::OnResourceUpdated*](classSR__UTILS__NS_1_1ResourceContainer.md#function-onresourceupdated)
...
```C++
virtual bool SR_GRAPH_NS::PostProcessPass::PreRender () override
```
...
_Вызывается только во время построения_ 
```C++
virtual bool SR_GRAPH_NS::PostProcessPass::Render () override
```
...
```C++
virtual void SR_GRAPH_NS::PostProcessPass::Update () override
```
...
```C++
SR_GRAPH_NS::PostProcessPass::~PostProcessPass () override
```
...
### variable m\_dirtyShader 

```C++
bool SR_GRAPH_NS::PostProcessPass::m_dirtyShader;
```
...
```C++
Properties SR_GRAPH_NS::PostProcessPass::m_properties;
```
...
```C++
uint32_t SR_GRAPH_NS::PostProcessPass::m_vertices;
```
...
```C++
int32_t SR_GRAPH_NS::PostProcessPass::m_virtualDescriptor;
```
...
```C++
int32_t SR_GRAPH_NS::PostProcessPass::m_virtualUBO;
```
...
```C++
virtual void SR_GRAPH_NS::PostProcessPass::DeInit () override
```
