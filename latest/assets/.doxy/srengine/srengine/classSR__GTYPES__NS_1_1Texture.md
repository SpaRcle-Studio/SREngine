...
# Class SR\_GTYPES\_NS::Texture



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**Texture**](classSR__GTYPES__NS_1_1Texture.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Texture**](classSR__GTYPES__NS_1_1Texture.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  Texture::Ptr | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath, const std::optional&lt; Memory::TextureConfig &gt; & config=std::nullopt) <br> |
|  Texture::Ptr | [**LoadFromMemory**](#function-loadfrommemory) (const std::string & data, const Memory::TextureConfig & config) <br> |
|  Texture::Ptr | [**LoadRaw**](#function-loadraw) (const uint8\_t \* pData, uint64\_t bytes, uint64\_t h, uint64\_t w, const Memory::TextureConfig & config) <br> |
...
```C++
using SR_GTYPES_NS::Texture::Ptr =  SR_HTYPES_NS::SharedPtr<Texture>;
```
...
```C++
virtual SR_NODISCARD SR_UTILS_NS::Path SR_GTYPES_NS::Texture::GetAssociatedPath () override const
```
...
```C++
SR_NODISCARD uint32_t SR_GTYPES_NS::Texture::GetChannels () noexcept const
```
...
```C++
SR_NODISCARD void * SR_GTYPES_NS::Texture::GetDescriptor () 
```
...
```C++
SR_NODISCARD uint32_t SR_GTYPES_NS::Texture::GetHeight () noexcept const
```
...
```C++
SR_NODISCARD int32_t SR_GTYPES_NS::Texture::GetId () noexcept
```
...
```C++
inline SR_NODISCARD const Memory::TextureConfig & SR_GTYPES_NS::Texture::GetTextureConfig () noexcept const
```
...
```C++
SR_NODISCARD uint32_t SR_GTYPES_NS::Texture::GetWidth () noexcept const
```
...
```C++
inline virtual SR_NODISCARD bool SR_GTYPES_NS::Texture::IsAllowedToRevive () override const
```
...
```C++
SR_GTYPES_NS::Texture::~Texture () override
```
...
```C++
static Texture::Ptr SR_GTYPES_NS::Texture::Load (
    const SR_UTILS_NS::Path & rawPath,
    const std::optional< Memory::TextureConfig > & config=std::nullopt
) 
```
...
```C++
static Texture::Ptr SR_GTYPES_NS::Texture::LoadFromMemory (
...
```C++
static Texture::Ptr SR_GTYPES_NS::Texture::LoadRaw (
    const uint8_t * pData,
    uint64_t bytes,
    uint64_t h,
    uint64_t w,
...
```C++
virtual bool SR_GTYPES_NS::Texture::Load () override
```
...
```C++
virtual bool SR_GTYPES_NS::Texture::Unload () override
```
...
```C++
class SR_GTYPES_NS::Texture::TextureLoader (
    ::SR_GRAPH_NS::TextureLoader
) 
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Types/Texture.h`
