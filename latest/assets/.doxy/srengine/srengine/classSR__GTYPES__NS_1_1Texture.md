...
| Type | Name |
| ---: | :--- |
| typedef [**Texture**](classSR__GTYPES__NS_1_1Texture.md) \* | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  [**Texture::Ptr**](classSR__GTYPES__NS_1_1Texture.md) | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath, const std::optional&lt; Memory::TextureConfig &gt; & config=std::nullopt) <br> |
|  [**Texture::Ptr**](classSR__GTYPES__NS_1_1Texture.md) | [**LoadFromMemory**](#function-loadfrommemory) (const std::string & data, const Memory::TextureConfig & config) <br> |
|  [**Texture::Ptr**](classSR__GTYPES__NS_1_1Texture.md) | [**LoadRaw**](#function-loadraw) (const uint8\_t \* pData, uint64\_t bytes, uint64\_t h, uint64\_t w, const Memory::TextureConfig & config) <br> |
...
```C++
using SR_GTYPES_NS::Texture::Ptr =  Texture*;
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Types/Texture.h`
