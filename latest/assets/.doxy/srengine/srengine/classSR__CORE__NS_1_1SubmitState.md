...
# Class SR\_CORE\_NS::SubmitState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**SubmitState**](classSR__CORE__NS_1_1SubmitState.md)
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::SubmitState::ExecuteImpl () override
```
