...
# Class SR\_AUDIO\_NS::AudioListener



[**ClassList**](annotated.md) **>** [**SR\_AUDIO\_NS**](namespaceSR__AUDIO__NS.md) **>** [**AudioListener**](classSR__AUDIO__NS_1_1AudioListener.md)
...
|  void | [**SetDistanceModel**](#function-setdistancemodel) (ListenerDistanceModel distanceModel) <br> |
|  void | [**SetGain**](#function-setgain) (float\_t gain) <br> |
|  void | [**SetVelocity**](#function-setvelocity) (const SR\_MATH\_NS::FVector3 & velocity) <br> |
...
```C++
virtual void SR_AUDIO_NS::AudioListener::OnAttached () override
```
...
```C++
virtual void SR_AUDIO_NS::AudioListener::OnDisable () override
```
...
```C++
virtual void SR_AUDIO_NS::AudioListener::OnEnable () override
```
...
```C++
virtual void SR_AUDIO_NS::AudioListener::OnMatrixDirty () override
```
...
```C++
void SR_AUDIO_NS::AudioListener::SetDistanceModel (
...
```C++
void SR_AUDIO_NS::AudioListener::SetGain (
    float_t gain
) 
```
...
```C++
void SR_AUDIO_NS::AudioListener::SetVelocity (
...
```C++
virtual void SR_AUDIO_NS::AudioListener::OnDestroy () override
```
