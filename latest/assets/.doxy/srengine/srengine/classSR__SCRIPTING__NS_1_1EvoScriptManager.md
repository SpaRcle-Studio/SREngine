...
# Class SR\_SCRIPTING\_NS::EvoScriptManager



[**ClassList**](annotated.md) **>** [**SR\_SCRIPTING\_NS**](namespaceSR__SCRIPTING__NS.md) **>** [**EvoScriptManager**](classSR__SCRIPTING__NS_1_1EvoScriptManager.md)
...
| Type | Name |
| ---: | :--- |
|  [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) | [**FindMSVCCompiler**](#function-findmsvccompiler) () const<br> |
|  SR\_NODISCARD ScriptPtr | [**Load**](#function-load) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & localPath) <br> |
| virtual void | [**OnSingletonDestroy**](#function-onsingletondestroy) () override<br> |
|  SR\_NODISCARD bool | [**ReloadScript**](#function-reloadscript) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & localPath) <br> |
|  void | [**Update**](#function-update) (bool force) <br> |
...
```C++
SR_UTILS_NS::Path SR_SCRIPTING_NS::EvoScriptManager::FindMSVCCompiler () const
```
...
```C++
SR_NODISCARD ScriptPtr SR_SCRIPTING_NS::EvoScriptManager::Load (
    const SR_UTILS_NS::Path & localPath
) 
```
...
```C++
virtual void SR_SCRIPTING_NS::EvoScriptManager::OnSingletonDestroy () override
```
...
```C++
SR_NODISCARD bool SR_SCRIPTING_NS::EvoScriptManager::ReloadScript (
    const SR_UTILS_NS::Path & localPath
) 
```
...
```C++
void SR_SCRIPTING_NS::EvoScriptManager::Update (
    bool force
) 
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Scripting/inc/Scripting/Impl/EvoScriptManager.h`
