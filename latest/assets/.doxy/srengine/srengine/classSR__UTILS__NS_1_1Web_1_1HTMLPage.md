...
# Class SR\_UTILS\_NS::Web::HTMLPage



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**Web**](namespaceSR__UTILS__NS_1_1Web.md) **>** [**HTMLPage**](classSR__UTILS__NS_1_1Web_1_1HTMLPage.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**HTMLPage**](classSR__UTILS__NS_1_1Web_1_1HTMLPage.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**HTMLContainerInterface::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**GetContainer**](#function-getcontainer) () const<br> |
|  SR\_NODISCARD void \* | [**GetDocument**](#function-getdocument) () const<br> |
|  SR\_NODISCARD const std::vector&lt; [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) &gt; & | [**GetPaths**](#function-getpaths) () const<br> |
|   | [**~HTMLPage**](#function-htmlpage) () <br> |
...
| Type | Name |
| ---: | :--- |
|  Ptr | [**Load**](#function-load) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path, const [**HTMLContainerInterface::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) & pContainer=nullptr) <br> |
...
```C++
using SR_UTILS_NS::Web::HTMLPage::Ptr =  SR_HTYPES_NS::SharedPtr<HTMLPage>;
```
...
```C++
inline SR_NODISCARD HTMLContainerInterface::Ptr SR_UTILS_NS::Web::HTMLPage::GetContainer () const
```
...
```C++
inline SR_NODISCARD void * SR_UTILS_NS::Web::HTMLPage::GetDocument () const
```
...
```C++
SR_NODISCARD const std::vector< SR_UTILS_NS::Path > & SR_UTILS_NS::Web::HTMLPage::GetPaths () const
```
...
```C++
SR_UTILS_NS::Web::HTMLPage::~HTMLPage () 
```
...
```C++
static Ptr SR_UTILS_NS::Web::HTMLPage::Load (
    const SR_UTILS_NS::Path & path,
    const HTMLContainerInterface::Ptr & pContainer=nullptr
) 
```
