...
# Class SR\_NETWORK\_NS::Client



[**ClassList**](annotated.md) **>** [**SR\_NETWORK\_NS**](namespaceSR__NETWORK__NS.md) **>** [**Client**](classSR__NETWORK__NS_1_1Client.md)
...
| Type | Name |
| ---: | :--- |
|   | [**Client**](#function-client) (SocketType type, int32\_t domain, int32\_t service, int32\_t protocol, int32\_t port, uint64\_t interface) <br> |
|  void | [**Ping**](#function-ping) (const std::string & ip, int32\_t port) <br> |
|  std::string | [**Request**](#function-request) (const std::string & serverIp, void \* request, uint64\_t size) <br> |
...
```C++
void SR_NETWORK_NS::Client::Ping (
    const std::string & ip,
    int32_t port
) 
```
...
```C++
std::string SR_NETWORK_NS::Client::Request (
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/Network/Client.h`
