...
# Struct SR\_GRAPH\_NS::RenderSettingsPreset



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**RenderSettingsPreset**](structSR__GRAPH__NS_1_1RenderSettingsPreset.md)
...
### variable editorCameraRenderTechnique 

```C++
SR_UTILS_NS::Path SR_GRAPH_NS::RenderSettingsPreset::editorCameraRenderTechnique;
```
...
### variable mainCameraRenderTechnique 

```C++
SR_UTILS_NS::Path SR_GRAPH_NS::RenderSettingsPreset::mainCameraRenderTechnique;
```
...
### variable shaderDefines 

```C++
std::set<SR_UTILS_NS::StringAtom> SR_GRAPH_NS::RenderSettingsPreset::shaderDefines;
```
