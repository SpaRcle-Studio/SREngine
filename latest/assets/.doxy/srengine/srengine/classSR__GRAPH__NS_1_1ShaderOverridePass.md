...
# Class SR\_GRAPH\_NS::ShaderOverridePass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**ShaderOverridePass**](classSR__GRAPH__NS_1_1ShaderOverridePass.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::IMesh3DClusterPass](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md),  [SR\_GRAPH\_NS::IFramebufferPass](classSR__GRAPH__NS_1_1IFramebufferPass.md)


Inherited by the following classes: [SR\_GRAPH\_NS::DepthBufferPass](classSR__GRAPH__NS_1_1DepthBufferPass.md),  [SR\_GRAPH\_NS::ShadowMapPass](classSR__GRAPH__NS_1_1ShadowMapPass.md)
...
|   | [**~ShaderOverridePass**](#function-shaderoverridepass) () override<br> |
...
| virtual SR\_NODISCARD ShaderPtr | [**GetShader**](#function-getshader) (SR\_SRSL\_NS::ShaderType type) override const<br> |
...
```C++
virtual bool SR_GRAPH_NS::ShaderOverridePass::Init () override
```



Implements [*SR\_GRAPH\_NS::IMesh3DClusterPass::Init*](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-init)
...
```C++
virtual bool SR_GRAPH_NS::ShaderOverridePass::Load (
...
Implements [*SR\_GRAPH\_NS::IMeshClusterPass::Load*](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-load)
...
```C++
virtual void SR_GRAPH_NS::ShaderOverridePass::OnResize (
...
Implements [*SR\_GRAPH\_NS::IMeshClusterPass::OnResize*](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-onresize)
...
```C++
virtual bool SR_GRAPH_NS::ShaderOverridePass::Render () override
```



Implements [*SR\_GRAPH\_NS::IMesh3DClusterPass::Render*](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-render)
...
```C++
virtual void SR_GRAPH_NS::ShaderOverridePass::Update () override
```



Implements [*SR\_GRAPH\_NS::IMesh3DClusterPass::Update*](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md#function-update)
...
### function ~ShaderOverridePass 

```C++
SR_GRAPH_NS::ShaderOverridePass::~ShaderOverridePass () override
```
...
```C++
inline virtual SR_NODISCARD IRenderTechnique * SR_GRAPH_NS::ShaderOverridePass::GetFrameBufferRenderTechnique () override const
```
...
```C++
virtual SR_NODISCARD std::vector< SR_GTYPES_NS::Framebuffer * > SR_GRAPH_NS::ShaderOverridePass::GetFrameBuffers () override const
```
...
```C++
virtual SR_NODISCARD ShaderPtr SR_GRAPH_NS::ShaderOverridePass::GetShader (
    SR_SRSL_NS::ShaderType type
) override const
```



Implements [*SR\_GRAPH\_NS::IMeshClusterPass::GetShader*](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-getshader)
...
```C++
virtual void SR_GRAPH_NS::ShaderOverridePass::UseSharedUniforms (
    ShaderPtr pShader
) override
```
