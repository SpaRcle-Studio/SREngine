...
# Class SR\_GRAPH\_NS::SkyboxPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**SkyboxPass**](classSR__GRAPH__NS_1_1SkyboxPass.md)
...
|  void | [**SetSkybox**](#function-setskybox) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
| virtual void | [**Update**](#function-update) () override<br>_Вызывается постоянно после построения_  |
|   | [**~SkyboxPass**](#function-skyboxpass) () override<br> |
...
```C++
virtual bool SR_GRAPH_NS::SkyboxPass::Render () override
```
...
```C++
void SR_GRAPH_NS::SkyboxPass::SetShader (
...
```C++
void SR_GRAPH_NS::SkyboxPass::SetSkybox (
    const SR_UTILS_NS::Path & path
) 
```
...
```C++
virtual void SR_GRAPH_NS::SkyboxPass::Update () override
```
...
```C++
SR_GRAPH_NS::SkyboxPass::~SkyboxPass () override
```
