...
# Class SR\_SRSL\_NS::SRSLEvaluator



[**ClassList**](annotated.md) **>** [**SR\_SRSL\_NS**](namespaceSR__SRSL__NS.md) **>** [**SRSLEvaluator**](classSR__SRSL__NS_1_1SRSLEvaluator.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD double\_t | [**Evaluate**](#function-evaluate-12) (const std::string & code) <br> |
|  SR\_NODISCARD double\_t | [**Evaluate**](#function-evaluate-22) (const [**SRSLExpr**](classSR__SRSL__NS_1_1SRSLExpr.md) \* pExpr) <br> |
...
```C++
SR_NODISCARD double_t SR_SRSL_NS::SRSLEvaluator::Evaluate (
