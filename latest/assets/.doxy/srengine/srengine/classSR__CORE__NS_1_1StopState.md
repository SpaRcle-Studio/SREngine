...
# Class SR\_CORE\_NS::StopState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**StopState**](classSR__CORE__NS_1_1StopState.md)
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::StopState::ExecuteImpl () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/inc/Core/States/StopState.h`
