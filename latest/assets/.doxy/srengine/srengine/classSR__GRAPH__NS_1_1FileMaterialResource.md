...
# Class SR\_GRAPH\_NS::FileMaterialResource



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**FileMaterialResource**](classSR__GRAPH__NS_1_1FileMaterialResource.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD SR\_UTILS\_NS::IResource::Ptr | [**CopyResource**](#function-copyresource) (SR\_UTILS\_NS::IResource::Ptr pDestination) override const<br> |
...
|  [**FileMaterialResource**](classSR__GRAPH__NS_1_1FileMaterialResource.md) \* | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath) <br> |
...
```C++
SR_NODISCARD SR_UTILS_NS::IResource::Ptr SR_GRAPH_NS::FileMaterialResource::CopyResource (
    SR_UTILS_NS::IResource::Ptr pDestination
) override const
```
...
### function FileMaterialResource 

```C++
SR_GRAPH_NS::FileMaterialResource::FileMaterialResource () 
```
...
```C++
inline SR_NODISCARD const SR_GRAPH_NS::MaterialData::Ptr & SR_GRAPH_NS::FileMaterialResource::GetData () noexcept const
```
...
```C++
static FileMaterialResource * SR_GRAPH_NS::FileMaterialResource::Load (
