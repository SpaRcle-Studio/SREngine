...
# Class SR\_SRLM\_NS::ConstructorNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**ConstructorNode**](classSR__SRLM__NS_1_1ConstructorNode.md)
...
|  void | [**SetInitTypeHashName**](#function-setinittypehashname) (uint64\_t hashName) <br> |
...
```C++
virtual void SR_SRLM_NS::ConstructorNode::Execute (
    float_t dt
) override
```
...
```C++
virtual SR_NODISCARD uint64_t SR_SRLM_NS::ConstructorNode::GetNodeHashName () noexcept override const
```
...
```C++
virtual SR_NODISCARD std::string SR_SRLM_NS::ConstructorNode::GetNodeName () noexcept override const
```
...
```C++
virtual void SR_SRLM_NS::ConstructorNode::InitNode () override
```
...
### function SetInitTypeHashName 

```C++
inline void SR_SRLM_NS::ConstructorNode::SetInitTypeHashName (
    uint64_t hashName
) 
```
