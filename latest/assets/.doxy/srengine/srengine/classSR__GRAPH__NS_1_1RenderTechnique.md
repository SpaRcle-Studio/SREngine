...
# Class SR\_GRAPH\_NS::RenderTechnique



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**RenderTechnique**](classSR__GRAPH__NS_1_1RenderTechnique.md)
...
Inherits the following classes: SR_UTILS_NS::Settings,  [SR\_GRAPH\_NS::IRenderTechnique](classSR__GRAPH__NS_1_1IRenderTechnique.md)
...
| Type | Name |
| ---: | :--- |
|  [**RenderTechnique**](classSR__GRAPH__NS_1_1RenderTechnique.md) \* | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
| Type | Name |
| ---: | :--- |
| virtual bool | [**Build**](#function-build) () override<br> |
...
```C++
static RenderTechnique * SR_GRAPH_NS::RenderTechnique::Load (
...
```C++
virtual bool SR_GRAPH_NS::RenderTechnique::Build () override
```



Implements [*SR\_GRAPH\_NS::IRenderTechnique::Build*](classSR__GRAPH__NS_1_1IRenderTechnique.md#function-build)
...
```C++
void SR_GRAPH_NS::RenderTechnique::ClearSettings () override
```
...
```C++
bool SR_GRAPH_NS::RenderTechnique::Load () override
```
...
```C++
bool SR_GRAPH_NS::RenderTechnique::LoadSettings (
...
```C++
bool SR_GRAPH_NS::RenderTechnique::Unload () override
```
