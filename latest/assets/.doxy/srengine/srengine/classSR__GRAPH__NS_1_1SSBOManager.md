...
# Class SR\_GRAPH\_NS::SSBOManager



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**SSBOManager**](classSR__GRAPH__NS_1_1SSBOManager.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD VirtualSSBO | [**AllocateSSBO**](#function-allocatessbo) (VirtualSSBO virtualSSBO, uint32\_t size, SSBOUsage usage) <br> |
|  BindResult | [**BindSSBO**](#function-bindssbo) (VirtualSSBO ssbo) noexcept<br> |
|  bool | [**FreeSSBO**](#function-freessbo) (VirtualSSBO \* pSSBO) <br> |
...
```C++
enum SR_GRAPH_NS::SSBOManager::BindResult {
    None,
    Success,
    Duplicated,
    Failed
...
```C++
SR_NODISCARD VirtualSSBO SR_GRAPH_NS::SSBOManager::AllocateSSBO (
    VirtualSSBO virtualSSBO,
    uint32_t size,
    SSBOUsage usage
) 
```
...
```C++
BindResult SR_GRAPH_NS::SSBOManager::BindSSBO (
    VirtualSSBO ssbo
) noexcept
```
...
```C++
bool SR_GRAPH_NS::SSBOManager::FreeSSBO (
    VirtualSSBO * pSSBO
) 
```
...
```C++
inline void SR_GRAPH_NS::SSBOManager::SetPipeline (
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Memory/SSBOManager.h`
