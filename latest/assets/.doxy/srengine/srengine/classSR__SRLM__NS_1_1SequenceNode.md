...
# Class SR\_SRLM\_NS::SequenceNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**SequenceNode**](classSR__SRLM__NS_1_1SequenceNode.md)
...
```C++
virtual void SR_SRLM_NS::SequenceNode::Execute (
    float_t dt
) override
```
...
```C++
virtual void SR_SRLM_NS::SequenceNode::InitNode () override
```
