...
# Class SR\_CORE\_GUI\_NS::BoolPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**BoolPropertyDrawer**](classSR__CORE__GUI__NS_1_1BoolPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**BoolPropertyDrawer**](classSR__CORE__GUI__NS_1_1BoolPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_CORE_GUI_NS::BoolPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<BoolPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::BoolPropertyDrawer::Draw (
