...
# Class SR\_GRAPH\_NS::GLFWWindow



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**GLFWWindow**](classSR__GRAPH__NS_1_1GLFWWindow.md)
...
| Type | Name |
| ---: | :--- |
|   | [**GLFWWindow**](#function-glfwwindow) () <br> |
...
|  SR\_NODISCARD GLFWwindow \* | [**GetWindow**](#function-getwindow) () const<br> |
...
|  void | [**OnFocusChangedCallback**](#function-onfocuschangedcallback) (GLFWwindow \* pWindow, bool isFocused) <br> |
|  void | [**OnFramebufferSizeChangedCallback**](#function-onframebuffersizechangedcallback) (GLFWwindow \* pWindow, SR\_MATH\_NS::IVector2 size) <br> |
|  void | [**OnScrollCallback**](#function-onscrollcallback) (GLFWwindow \* pWindow, double xoffset, double yoffset) <br> |
|  void | [**OnSizeChangedCallback**](#function-onsizechangedcallback) (GLFWwindow \* pWindow, SR\_MATH\_NS::IVector2 size) <br> |
|  void | [**OnWindowRefreshCallback**](#function-onwindowrefreshcallback) (GLFWwindow \* pWindow) <br> |
...
```C++
inline explicit SR_GRAPH_NS::GLFWWindow::GLFWWindow () 
```
...
```C++
inline virtual SR_NODISCARD void * SR_GRAPH_NS::GLFWWindow::GetHandle () override const
```
...
```C++
inline virtual SR_NODISCARD WindowType SR_GRAPH_NS::GLFWWindow::GetType () override const
```
...
```C++
inline SR_NODISCARD GLFWwindow * SR_GRAPH_NS::GLFWWindow::GetWindow () const
```
...
```C++
virtual bool SR_GRAPH_NS::GLFWWindow::Initialize (
...
### function OnFocusChangedCallback 

```C++
void SR_GRAPH_NS::GLFWWindow::OnFocusChangedCallback (
    GLFWwindow * pWindow,
    bool isFocused
) 
```
...
### function OnFramebufferSizeChangedCallback 

```C++
void SR_GRAPH_NS::GLFWWindow::OnFramebufferSizeChangedCallback (
    GLFWwindow * pWindow,
...
```C++
void SR_GRAPH_NS::GLFWWindow::OnScrollCallback (
    GLFWwindow * pWindow,
    double xoffset,
    double yoffset
) 
...
### function OnSizeChangedCallback 

```C++
void SR_GRAPH_NS::GLFWWindow::OnSizeChangedCallback (
    GLFWwindow * pWindow,
    SR_MATH_NS::IVector2 size
) 
```
...
### function OnWindowRefreshCallback 

```C++
void SR_GRAPH_NS::GLFWWindow::OnWindowRefreshCallback (
    GLFWwindow * pWindow
) 
```
...
```C++
virtual void SR_GRAPH_NS::GLFWWindow::PollEvents () override
```
...
```C++
virtual void SR_GRAPH_NS::GLFWWindow::SetIcon (
