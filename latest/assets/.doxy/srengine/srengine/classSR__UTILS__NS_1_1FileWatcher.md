...
# Class SR\_UTILS\_NS::FileWatcher



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**FileWatcher**](classSR__UTILS__NS_1_1FileWatcher.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**FileWatcher**](classSR__UTILS__NS_1_1FileWatcher.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_UTILS_NS::FileWatcher::Ptr =  SR_HTYPES_NS::SharedPtr<FileWatcher>;
```
...
```C++
SR_NODISCARD std::string SR_UTILS_NS::FileWatcher::GetName () noexcept const
```
...
```C++
void SR_UTILS_NS::FileWatcher::Pause () 
```
...
```C++
void SR_UTILS_NS::FileWatcher::Resume () 
```
...
```C++
void SR_UTILS_NS::FileWatcher::SetCallBack (
    CallBack callBack
) 
```
...
```C++
void SR_UTILS_NS::FileWatcher::SetName (
    std::string name
) 
```
