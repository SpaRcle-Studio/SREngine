...
# Class SR\_CORE\_NS::Commands::SceneObjectInstance



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**SceneObjectInstance**](classSR__CORE__NS_1_1Commands_1_1SceneObjectInstance.md)
...
|   | [**SceneObjectInstance**](#function-sceneobjectinstance) (const EnginePtr & pEngine, const SR\_UTILS\_NS::SceneObject::Ptr & pSO) <br> |
| virtual bool | [**Undo**](#function-undo) () override<br> |
|   | [**~SceneObjectInstance**](#function-sceneobjectinstance) () override<br> |
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectInstance::Redo () override
```
...
```C++
SR_CORE_NS::Commands::SceneObjectInstance::SceneObjectInstance (
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectInstance::Undo () override
```
...
```C++
SR_CORE_NS::Commands::SceneObjectInstance::~SceneObjectInstance () override
```
