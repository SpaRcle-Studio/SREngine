...
# Class SR\_SRSL\_NS::SRSLLexer



[**ClassList**](annotated.md) **>** [**SR\_SRSL\_NS**](namespaceSR__SRSL__NS.md) **>** [**SRSLLexer**](classSR__SRSL__NS_1_1SRSLLexer.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD Lexems | [**Parse**](#function-parse) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path, uint16\_t fileIndex) <br> |
|  SR\_NODISCARD Lexems | [**ParseString**](#function-parsestring) (std::string code, uint16\_t fileIndex) <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**~SRSLLexer**](#function-srsllexer) () override<br> |
...
```C++
SR_NODISCARD Lexems SR_SRSL_NS::SRSLLexer::Parse (
...
```C++
SR_NODISCARD Lexems SR_SRSL_NS::SRSLLexer::ParseString (
    std::string code,
    uint16_t fileIndex
) 
```
...
```C++
SR_SRSL_NS::SRSLLexer::~SRSLLexer () override
```
