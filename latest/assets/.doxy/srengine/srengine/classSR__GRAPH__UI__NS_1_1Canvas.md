...
# Class SR\_GRAPH\_UI\_NS::Canvas



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_UI\_NS**](namespaceSR__GRAPH__UI__NS.md) **>** [**Canvas**](classSR__GRAPH__UI__NS_1_1Canvas.md)
...
```C++
inline virtual SR_NODISCARD bool SR_GRAPH_UI_NS::Canvas::ExecuteInEditMode () override const
```
...
```C++
virtual void SR_GRAPH_UI_NS::Canvas::OnAttached () override
```
...
```C++
virtual void SR_GRAPH_UI_NS::Canvas::OnDestroy () override
```
...
```C++
virtual void SR_GRAPH_UI_NS::Canvas::Update (
    float_t dt
) override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/UI/Canvas.h`
