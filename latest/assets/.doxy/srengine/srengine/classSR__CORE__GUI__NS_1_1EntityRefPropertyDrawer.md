...
# Class SR\_CORE\_GUI\_NS::EntityRefPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**EntityRefPropertyDrawer**](classSR__CORE__GUI__NS_1_1EntityRefPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**EntityRefPropertyDrawer**](classSR__CORE__GUI__NS_1_1EntityRefPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**Draw**](#function-draw) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) override<br> |
...
```C++
using SR_CORE_GUI_NS::EntityRefPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<EntityRefPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::EntityRefPropertyDrawer::Draw (
...
Implements [*SR\_CORE\_GUI\_NS::PropertyDrawerBase::Draw*](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md#function-draw)


<hr>

------------------------------
The documentation for this class was generated from the following file `Engine/inc/Engine/GUI/PropertyDrawers/EntityRefPropertyDrawer.h`
