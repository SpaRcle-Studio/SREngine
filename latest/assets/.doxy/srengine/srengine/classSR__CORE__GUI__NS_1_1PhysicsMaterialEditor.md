...
# Class SR\_CORE\_GUI\_NS::PhysicsMaterialEditor



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**PhysicsMaterialEditor**](classSR__CORE__GUI__NS_1_1PhysicsMaterialEditor.md)
...
| Type | Name |
| ---: | :--- |
| virtual bool | [**OpenFile**](#function-openfile) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) override<br> |
|   | [**PhysicsMaterialEditor**](#function-physicsmaterialeditor) () <br> |
|  void | [**SetMaterialPath**](#function-setmaterialpath) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
|   | [**~PhysicsMaterialEditor**](#function-physicsmaterialeditor) () override<br> |
...
```C++
virtual bool SR_CORE_GUI_NS::PhysicsMaterialEditor::OpenFile (
...
Implements [*SR\_GRAPH\_GUI\_NS::Widget::OpenFile*](classSR__GRAPH__GUI__NS_1_1Widget.md#function-openfile)
...
### function PhysicsMaterialEditor 

```C++
SR_CORE_GUI_NS::PhysicsMaterialEditor::PhysicsMaterialEditor () 
```
...
```C++
inline void SR_CORE_GUI_NS::PhysicsMaterialEditor::SetMaterialPath (
    const SR_UTILS_NS::Path & path
) 
```
...
```C++
SR_CORE_GUI_NS::PhysicsMaterialEditor::~PhysicsMaterialEditor () override
```
...
```C++
virtual void SR_CORE_GUI_NS::PhysicsMaterialEditor::Draw () override
```
