...
# Class SR\_GRAPH\_NS::WidgetPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**WidgetPass**](classSR__GRAPH__NS_1_1WidgetPass.md)
...
```C++
virtual bool SR_GRAPH_NS::WidgetPass::Overlay () override
```
...
```C++
virtual void SR_GRAPH_NS::WidgetPass::Prepare () override
```
