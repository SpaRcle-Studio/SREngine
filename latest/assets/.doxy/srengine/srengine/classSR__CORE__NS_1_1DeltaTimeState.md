...
# Class SR\_CORE\_NS::DeltaTimeState



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**DeltaTimeState**](classSR__CORE__NS_1_1DeltaTimeState.md)
...
```C++
virtual SR_UTILS_NS::ThreadWorkerResult SR_CORE_NS::DeltaTimeState::ExecuteImpl () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/inc/Core/States/DeltaTimeState.h`
