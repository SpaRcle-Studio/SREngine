...
# Class SR\_GRAPH\_NS::MaterialData



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**MaterialData**](classSR__GRAPH__NS_1_1MaterialData.md)



_@inspector(MaterialDataPropertyDrawer)_ 

* `#include <MaterialData.h>`



Inherits the following classes: [SR\_UTILS\_NS::Serializable](classSR__UTILS__NS_1_1Serializable.md),  [SR\_UTILS\_NS::NonCopyable](classSR__UTILS__NS_1_1NonCopyable.md),  [SR\_HTYPES\_NS::SharedPtr](classSR__HTYPES__NS_1_1SharedPtr.md),  [SR\_UTILS\_NS::SubscriptionHolder](classSR__UTILS__NS_1_1SubscriptionHolder.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**MaterialData**](classSR__GRAPH__NS_1_1MaterialData.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_INLINE\_STATIC const [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**ONLY\_UNIFORMS\_BOOL\_ID**](#variable-only_uniforms_bool_id)   = `"OnlyUniforms"`<br> |
|  SR\_INLINE\_STATIC const [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**PROPERTY\_CHANGED\_EVENT**](#variable-property_changed_event)   = `"PropertyChanged"`<br> |
|  SR\_INLINE\_STATIC const [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**SHADER\_CHANGED\_EVENT**](#variable-shader_changed_event)   = `"ShaderChanged"`<br> |
...
|  SR\_NODISCARD [**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) \* | [**GetShader**](#function-getshader) (const [**Pipeline**](classSR__GRAPH__NS_1_1Pipeline.md) \* pPipeline) noexcept const<br> |
...
|  void SR\_FASTCALL | [**OnSamplerChanged**](#function-onsamplerchanged) ([**SR\_GTYPES\_NS::Texture**](classSR__GTYPES__NS_1_1Texture.md) \* pOldTexture, [**SR\_GTYPES\_NS::Texture**](classSR__GTYPES__NS_1_1Texture.md) \* pNewTexture) noexcept<br> |
...
```C++
using SR_GRAPH_NS::MaterialData::Ptr =  SR_HTYPES_NS::SharedPtr<MaterialData>;
```
...
### variable ONLY\_UNIFORMS\_BOOL\_ID 

```C++
SR_INLINE_STATIC const SR_UTILS_NS::StringAtom SR_GRAPH_NS::MaterialData::ONLY_UNIFORMS_BOOL_ID;
```
...
### variable PROPERTY\_CHANGED\_EVENT 

```C++
SR_INLINE_STATIC const SR_UTILS_NS::StringAtom SR_GRAPH_NS::MaterialData::PROPERTY_CHANGED_EVENT;
```
...
### variable SHADER\_CHANGED\_EVENT 

```C++
SR_INLINE_STATIC const SR_UTILS_NS::StringAtom SR_GRAPH_NS::MaterialData::SHADER_CHANGED_EVENT;
```
...
```C++
void SR_GRAPH_NS::MaterialData::Finalize () 
```
...
### function GetDefaultShaderData [1/2]

```C++
inline SR_NODISCARD MaterialShaderData & SR_GRAPH_NS::MaterialData::GetDefaultShaderData () noexcept
```
...
### function GetDefaultShaderData [2/2]
...
```C++
SR_NODISCARD SR_GTYPES_NS::Shader * SR_GRAPH_NS::MaterialData::GetShader (
...
### function GetShaderData [1/2]

```C++
SR_NODISCARD MaterialShaderData * SR_GRAPH_NS::MaterialData::GetShaderData (
...
### function GetShaderData [2/2]

```C++
SR_NODISCARD const MaterialShaderData * SR_GRAPH_NS::MaterialData::GetShaderData (
    SR_UTILS_NS::StringAtom id
) noexcept const
```
...
```C++
virtual bool SR_GRAPH_NS::MaterialData::Load (
...
```C++
SR_GRAPH_NS::MaterialData::MaterialData () 
```
...
```C++
void SR_GRAPH_NS::MaterialData::OnPropertyChanged (
    bool onlyUniforms
) 
```
...
```C++
void SR_FASTCALL SR_GRAPH_NS::MaterialData::OnSamplerChanged (
    SR_GTYPES_NS::Texture * pOldTexture,
    SR_GTYPES_NS::Texture * pNewTexture
) noexcept
```
...
```C++
virtual void SR_GRAPH_NS::MaterialData::Save (
...
```C++
void SR_FASTCALL SR_GRAPH_NS::MaterialData::SetData (
    SR_UTILS_NS::StringAtom id,
...
```C++
void SR_FASTCALL SR_GRAPH_NS::MaterialData::SetSampler (
    SR_UTILS_NS::StringAtom id,
...
```C++
void SR_GRAPH_NS::MaterialData::UseSamplers (
    const Pipeline * pPipeline
) 
```
...
```C++
void SR_GRAPH_NS::MaterialData::UseUniforms (
    const Pipeline * pPipeline
) 
```
...
```C++
SR_GRAPH_NS::MaterialData::~MaterialData () override
```
