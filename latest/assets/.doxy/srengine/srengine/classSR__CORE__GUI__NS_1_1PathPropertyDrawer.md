...
# Class SR\_CORE\_GUI\_NS::PathPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**PathPropertyDrawer**](classSR__CORE__GUI__NS_1_1PathPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**PathPropertyDrawer**](classSR__CORE__GUI__NS_1_1PathPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_CORE_GUI_NS::PathPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<PathPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::PathPropertyDrawer::Draw (
