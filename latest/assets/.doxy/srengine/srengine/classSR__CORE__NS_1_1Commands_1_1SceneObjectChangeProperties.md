...
# Class SR\_CORE\_NS::Commands::SceneObjectChangeProperties



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**SceneObjectChangeProperties**](classSR__CORE__NS_1_1Commands_1_1SceneObjectChangeProperties.md)
...
|   | [**SceneObjectChangeProperties**](#function-sceneobjectchangeproperties) (const EnginePtr & pEngine, const SR\_UTILS\_NS::SceneObject::Ptr & pSO, SR\_UTILS\_NS::ISerializer::UniquePtr pOld, SR\_UTILS\_NS::ISerializer::UniquePtr pNew) <br> |
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectChangeProperties::Redo () override
```
...
### function SceneObjectChangeProperties 

```C++
inline SR_CORE_NS::Commands::SceneObjectChangeProperties::SceneObjectChangeProperties (
    const EnginePtr & pEngine,
    const SR_UTILS_NS::SceneObject::Ptr & pSO,
    SR_UTILS_NS::ISerializer::UniquePtr pOld,
    SR_UTILS_NS::ISerializer::UniquePtr pNew
) 
```
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectChangeProperties::Undo () override
```
