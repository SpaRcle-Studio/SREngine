...
# Class SR\_GRAPH\_NS::TextureData



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**TextureData**](classSR__GRAPH__NS_1_1TextureData.md)
...
Inherits the following classes: [SR\_HTYPES\_NS::SharedPtr](classSR__HTYPES__NS_1_1SharedPtr.md),  [SR\_UTILS\_NS::NonCopyable](classSR__UTILS__NS_1_1NonCopyable.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD uint8\_t | [**GetChannels**](#function-getchannels) () const<br> |
|  SR\_NODISCARD const uint8\_t \* | [**GetData**](#function-getdata) () const<br> |
|  SR\_NODISCARD ImageLoadFormat | [**GetFormat**](#function-getformat) () const<br> |
|  SR\_NODISCARD uint32\_t | [**GetHeight**](#function-getheight) () const<br> |
|  SR\_NODISCARD uint32\_t | [**GetNumberOfBytes**](#function-getnumberofbytes) () const<br> |
...
|   | [**~TextureData**](#function-texturedata) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  [**TextureData::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**Create**](#function-create) (uint32\_t width, uint32\_t height, uint8\_t \* pData, DeleterFn && deleter, ImageLoadFormat format=ImageLoadFormat::RGBA) <br> |
|  [**TextureData::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**Load**](#function-load) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path, ImageLoadFormat format=ImageLoadFormat::RGBA) <br> |
...
```C++
inline SR_NODISCARD uint8_t SR_GRAPH_NS::TextureData::GetChannels () const
```
...
```C++
inline SR_NODISCARD const uint8_t * SR_GRAPH_NS::TextureData::GetData () const
```
...
```C++
inline SR_NODISCARD ImageLoadFormat SR_GRAPH_NS::TextureData::GetFormat () const
```
...
```C++
inline SR_NODISCARD uint32_t SR_GRAPH_NS::TextureData::GetHeight () const
```
...
```C++
inline SR_NODISCARD uint32_t SR_GRAPH_NS::TextureData::GetNumberOfBytes () const
```
...
```C++
inline SR_NODISCARD SR_UTILS_NS::Path SR_GRAPH_NS::TextureData::GetPath () const
```
...
```C++
inline SR_NODISCARD SR_MATH_NS::UVector2 SR_GRAPH_NS::TextureData::GetSize () const
```
...
```C++
inline SR_NODISCARD uint32_t SR_GRAPH_NS::TextureData::GetWidth () const
```
...
```C++
SR_NODISCARD bool SR_GRAPH_NS::TextureData::Save (
...
```C++
inline void SR_GRAPH_NS::TextureData::SetPath (
    const SR_UTILS_NS::Path & path
) 
```
...
```C++
SR_GRAPH_NS::TextureData::~TextureData () override
```
...
```C++
static TextureData::Ptr SR_GRAPH_NS::TextureData::Create (
    uint32_t width,
    uint32_t height,
    uint8_t * pData,
    DeleterFn && deleter,
    ImageLoadFormat format=ImageLoadFormat::RGBA
) 
```
...
```C++
static TextureData::Ptr SR_GRAPH_NS::TextureData::Load (
    const SR_UTILS_NS::Path & path,
    ImageLoadFormat format=ImageLoadFormat::RGBA
) 
```
