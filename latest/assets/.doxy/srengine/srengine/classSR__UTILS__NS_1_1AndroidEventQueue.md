...
# Class SR\_UTILS\_NS::AndroidEventQueue



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**AndroidEventQueue**](classSR__UTILS__NS_1_1AndroidEventQueue.md)
...
| Type | Name |
| ---: | :--- |
|  bool | [**PopEvent**](#function-popevent) ([**AndroidEvent**](structSR__UTILS__NS_1_1AndroidEvent.md) & event) <br> |
|  void | [**PushEvent**](#function-pushevent) (const [**AndroidEvent**](structSR__UTILS__NS_1_1AndroidEvent.md) & event) <br> |
...
```C++
bool SR_UTILS_NS::AndroidEventQueue::PopEvent (
    AndroidEvent & event
) 
```
...
```C++
void SR_UTILS_NS::AndroidEventQueue::PushEvent (
    const AndroidEvent & event
) 
```
