...
# Class SR\_SRSL\_NS::SRSLAssignExpander



[**ClassList**](annotated.md) **>** [**SR\_SRSL\_NS**](namespaceSR__SRSL__NS.md) **>** [**SRSLAssignExpander**](classSR__SRSL__NS_1_1SRSLAssignExpander.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD std::pair&lt; std::vector&lt; [**Lexem**](structSR__SRSL__NS_1_1Lexem.md) &gt;, [**SRSLResult**](structSR__SRSL__NS_1_1SRSLResult.md) &gt; | [**Expand**](#function-expand) (std::vector&lt; [**Lexem**](structSR__SRSL__NS_1_1Lexem.md) &gt; && lexems) <br> |
...
```C++
SR_NODISCARD std::pair< std::vector< Lexem >, SRSLResult > SR_SRSL_NS::SRSLAssignExpander::Expand (
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/SRSL/AssignExpander.h`
