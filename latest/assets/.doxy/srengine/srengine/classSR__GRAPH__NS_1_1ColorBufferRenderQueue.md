...
# Class SR\_GRAPH\_NS::ColorBufferRenderQueue



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**ColorBufferRenderQueue**](classSR__GRAPH__NS_1_1ColorBufferRenderQueue.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::RenderQueue](classSR__GRAPH__NS_1_1RenderQueue.md)
...
## Public Types inherited from SR_GRAPH_NS::RenderQueue

See [SR\_GRAPH\_NS::RenderQueue](classSR__GRAPH__NS_1_1RenderQueue.md)

| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SortedVector**](classSR__HTYPES__NS_1_1SortedVector.md)&lt; [**MeshInfo**](structSR__GRAPH__NS_1_1RenderQueue_1_1MeshInfo.md), [**RenderQueueLessPredicate**](structSR__GRAPH__NS_1_1RenderQueue_1_1RenderQueueLessPredicate.md) &gt; | [**Queue**](classSR__GRAPH__NS_1_1RenderQueue.md#typedef-queue)  <br> |
| enum uint8\_t | [**QueueState**](classSR__GRAPH__NS_1_1RenderQueue.md#enum-queuestate)  <br> |
| typedef uint8\_t | [**QueueStateFlags**](classSR__GRAPH__NS_1_1RenderQueue.md#typedef-queuestateflags)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**ColorBufferRenderQueue**](#function-colorbufferrenderqueue) ([**RenderStrategy**](classSR__GRAPH__NS_1_1RenderStrategy.md) \* pStrategy, [**MeshDrawerPass**](classSR__GRAPH__NS_1_1MeshDrawerPass.md) \* pDrawer) <br> |
| virtual void | [**CustomDrawMesh**](#function-customdrawmesh) (const [**MeshInfo**](structSR__GRAPH__NS_1_1RenderQueue_1_1MeshInfo.md) & info) override<br> |


## Public Functions inherited from SR_GRAPH_NS::RenderQueue
...
|  void | [**OnMeshDirty**](classSR__GRAPH__NS_1_1RenderQueue.md#function-onmeshdirty) (MeshPtr pMesh, [**ShaderUseInfo**](structSR__GRAPH__NS_1_1ShaderUseInfo.md) info) <br> |
...
|  void | [**UnRegister**](classSR__GRAPH__NS_1_1RenderQueue.md#function-unregister) (const [**MeshRegistrationInfo**](structSR__GRAPH__NS_1_1MeshRegistrationInfo.md) & info) <br> |
|  void | [**Update**](classSR__GRAPH__NS_1_1RenderQueue.md#function-update) () <br> |
| virtual  | [**~RenderQueue**](classSR__GRAPH__NS_1_1RenderQueue.md#function-renderqueue) () <br> |
...
## Protected Attributes inherited from SR_GRAPH_NS::RenderQueue

See [SR\_GRAPH\_NS::RenderQueue](classSR__GRAPH__NS_1_1RenderQueue.md)

| Type | Name |
| ---: | :--- |
|  bool | [**m\_customMeshDraw**](classSR__GRAPH__NS_1_1RenderQueue.md#variable-m_custommeshdraw)   = `false`<br> |
...
## Protected Functions inherited from SR_GRAPH_NS::RenderQueue

See [SR\_GRAPH\_NS::RenderQueue](classSR__GRAPH__NS_1_1RenderQueue.md)

| Type | Name |
| ---: | :--- |
| virtual void | [**CustomDrawMesh**](classSR__GRAPH__NS_1_1RenderQueue.md#function-customdrawmesh) (const [**MeshInfo**](structSR__GRAPH__NS_1_1RenderQueue_1_1MeshInfo.md) & info) <br> |
|  SR\_NODISCARD [**MeshDrawerPass**](classSR__GRAPH__NS_1_1MeshDrawerPass.md) \* | [**GetMeshDrawerPass**](classSR__GRAPH__NS_1_1RenderQueue.md#function-getmeshdrawerpass) () noexcept const<br> |
...
### function ColorBufferRenderQueue 

```C++
SR_GRAPH_NS::ColorBufferRenderQueue::ColorBufferRenderQueue (
...
```C++
virtual void SR_GRAPH_NS::ColorBufferRenderQueue::CustomDrawMesh (
    const MeshInfo & info
) override
```
...
Implements [*SR\_GRAPH\_NS::RenderQueue::CustomDrawMesh*](classSR__GRAPH__NS_1_1RenderQueue.md#function-customdrawmesh)
