...
# Class SR\_CORE\_NS::Commands::SceneObjectTag



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**SceneObjectTag**](classSR__CORE__NS_1_1Commands_1_1SceneObjectTag.md)
...
|   | [**SceneObjectTag**](#function-sceneobjecttag) (const EnginePtr & pEngine, const SR\_UTILS\_NS::SceneObject::Ptr & pSO, [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) newTag) <br> |
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectTag::Redo () override
```
...
### function SceneObjectTag 

```C++
SR_CORE_NS::Commands::SceneObjectTag::SceneObjectTag (
    const EnginePtr & pEngine,
    const SR_UTILS_NS::SceneObject::Ptr & pSO,
    SR_UTILS_NS::StringAtom newTag
) 
```
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectTag::Undo () override
```
