...
# Class SR\_GRAPH\_NS::UniqueMaterial



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**UniqueMaterial**](classSR__GRAPH__NS_1_1UniqueMaterial.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**UniqueMaterial**](classSR__GRAPH__NS_1_1UniqueMaterial.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
|  void | [**SetMaterialData**](#function-setmaterialdata) (const MaterialData::Ptr & pData) noexcept<br> |
|   | [**UniqueMaterial**](#function-uniquematerial) () <br> |
|   | [**~UniqueMaterial**](#function-uniquematerial) () override<br> |
...
|  void SR\_FASTCALL | [**SetTexture**](classSR__GRAPH__NS_1_1BaseMaterial.md#function-settexture) ([**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) id, [**SR\_GTYPES\_NS::Texture**](classSR__GTYPES__NS_1_1Texture.md) \* pTexture) noexcept<br> |
...
| typedef [**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) \* | [**ShaderPtr**](classSR__GRAPH__NS_1_1BaseMaterial.md#typedef-shaderptr)  <br> |
...
```C++
using SR_GRAPH_NS::UniqueMaterial::Ptr =  SR_HTYPES_NS::SharedPtr<UniqueMaterial>;
```
...
```C++
virtual SR_NODISCARD const MaterialData::Ptr & SR_GRAPH_NS::UniqueMaterial::GetMaterialData () noexcept override const
```
...
```C++
virtual SR_NODISCARD MaterialType SR_GRAPH_NS::UniqueMaterial::GetMaterialType () noexcept override const
```
...
```C++
void SR_GRAPH_NS::UniqueMaterial::SetMaterialData (
    const MaterialData::Ptr & pData
) noexcept
```
...
### function UniqueMaterial 

```C++
SR_GRAPH_NS::UniqueMaterial::UniqueMaterial () 
```
...
```C++
SR_GRAPH_NS::UniqueMaterial::~UniqueMaterial () override
```
