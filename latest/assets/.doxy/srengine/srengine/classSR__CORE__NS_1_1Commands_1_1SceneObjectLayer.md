...
# Class SR\_CORE\_NS::Commands::SceneObjectLayer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**SceneObjectLayer**](classSR__CORE__NS_1_1Commands_1_1SceneObjectLayer.md)
...
|   | [**SceneObjectLayer**](#function-sceneobjectlayer) (const EnginePtr & pEngine, const SR\_UTILS\_NS::SceneObject::Ptr & pSO, [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) newLayer) <br> |
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectLayer::Redo () override
```
...
```C++
SR_CORE_NS::Commands::SceneObjectLayer::SceneObjectLayer (
    const EnginePtr & pEngine,
    const SR_UTILS_NS::SceneObject::Ptr & pSO,
    SR_UTILS_NS::StringAtom newLayer
) 
```
...
```C++
virtual bool SR_CORE_NS::Commands::SceneObjectLayer::Undo () override
```
