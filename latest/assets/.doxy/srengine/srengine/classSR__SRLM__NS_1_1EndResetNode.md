...
# Class SR\_SRLM\_NS::EndResetNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**EndResetNode**](classSR__SRLM__NS_1_1EndResetNode.md)
...
```C++
virtual void SR_SRLM_NS::EndResetNode::Execute (
    float_t dt
) override
```
...
```C++
inline virtual SR_NODISCARD LogicalNodeType SR_SRLM_NS::EndResetNode::GetType () noexcept override const
```
...
```C++
virtual void SR_SRLM_NS::EndResetNode::InitNode () override
```
