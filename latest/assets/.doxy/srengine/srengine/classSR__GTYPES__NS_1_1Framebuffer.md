...
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Framebuffer**](classSR__GTYPES__NS_1_1Framebuffer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
|   | [**~Framebuffer**](#function-framebuffer) () override<br> |
...
```C++
using SR_GTYPES_NS::Framebuffer::Ptr =  SR_HTYPES_NS::SharedPtr<Framebuffer>;
```
...
```C++
SR_GTYPES_NS::Framebuffer::Framebuffer () 
```
...
```C++
inline virtual SR_NODISCARD bool SR_GTYPES_NS::Framebuffer::IsAllowedMultiInstance () override const
```
...
```C++
SR_GTYPES_NS::Framebuffer::~Framebuffer () override
```
