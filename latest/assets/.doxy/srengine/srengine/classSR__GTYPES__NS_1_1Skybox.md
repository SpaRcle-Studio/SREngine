...
# Class SR\_GTYPES\_NS::Skybox



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**Skybox**](classSR__GTYPES__NS_1_1Skybox.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Skybox**](classSR__GTYPES__NS_1_1Skybox.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
|  void | [**SetShader**](#function-setshader) (const [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) &gt; & shader) <br> |
|   | [**Skybox**](#function-skybox) () <br> |
| virtual void | [**StartWatch**](#function-startwatch) () override<br> |
|   | [**~Skybox**](#function-skybox) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  Skybox::Ptr | [**Load**](#function-load) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
```C++
using SR_GTYPES_NS::Skybox::Ptr =  SR_HTYPES_NS::SharedPtr<Skybox>;
```
...
```C++
SR_NODISCARD int32_t SR_GTYPES_NS::Skybox::GetIBO () 
```
...
```C++
inline SR_NODISCARD Shader::Ptr SR_GTYPES_NS::Skybox::GetShader () noexcept const
```
...
```C++
SR_NODISCARD int32_t SR_GTYPES_NS::Skybox::GetVBO () 
```
...
```C++
SR_NODISCARD int32_t SR_GTYPES_NS::Skybox::GetVirtualUBO () const
```
...
```C++
inline virtual SR_NODISCARD bool SR_GTYPES_NS::Skybox::IsAllowedToRevive () override const
```
...
```C++
void SR_GTYPES_NS::Skybox::SetShader (
    const SR_HTYPES_NS::SharedPtr < SR_GTYPES_NS::Shader > & shader
) 
```
...
```C++
virtual void SR_GTYPES_NS::Skybox::StartWatch () override
```
...
```C++
SR_GTYPES_NS::Skybox::~Skybox () override
```
...
```C++
static Skybox::Ptr SR_GTYPES_NS::Skybox::Load (
...
```C++
inline virtual uint64_t SR_GTYPES_NS::Skybox::GetFileHash () override const
```
...
```C++
virtual void SR_GTYPES_NS::Skybox::OnResourceUpdated (
