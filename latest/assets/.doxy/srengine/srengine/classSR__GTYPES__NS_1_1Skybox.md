...
|  SR\_NODISCARD [**Shader**](classSR__GTYPES__NS_1_1Shader.md) \* | [**GetShader**](#function-getshader) () noexcept const<br> |
...
|  void | [**SetShader**](#function-setshader) ([**Shader**](classSR__GTYPES__NS_1_1Shader.md) \* shader) <br> |
...
| Type | Name |
| ---: | :--- |
|  [**Skybox**](classSR__GTYPES__NS_1_1Skybox.md) \* | [**Load**](#function-load) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
```C++
inline SR_NODISCARD Shader * SR_GTYPES_NS::Skybox::GetShader () noexcept const
```
...
```C++
static Skybox * SR_GTYPES_NS::Skybox::Load (
