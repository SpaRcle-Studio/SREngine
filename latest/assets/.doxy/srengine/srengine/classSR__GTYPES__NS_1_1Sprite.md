...
# Class SR\_GTYPES\_NS::Sprite



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**Sprite**](classSR__GTYPES__NS_1_1Sprite.md)
...
| Type | Name |
| ---: | :--- |
| typedef Vertices::UIVertex | [**VertexType**](#typedef-vertextype)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual bool | [**BindMesh**](#function-bindmesh) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  bool | [**m\_sliced**](#variable-m_sliced)   = `true`<br> |
|  SR\_MATH\_NS::FVector2 | [**m\_textureBorder**](#variable-m_textureborder)   = `0.15f`<br> |
|  SR\_MATH\_NS::FVector2 | [**m\_windowBorder**](#variable-m_windowborder)   = `0.15f`<br> |
...
```C++
typedef Vertices::UIVertex SR_GTYPES_NS::Sprite::VertexType;
```
...
```C++
virtual bool SR_GTYPES_NS::Sprite::BindMesh () override
```



Implements [*SR\_GTYPES\_NS::Mesh::BindMesh*](classSR__GTYPES__NS_1_1Mesh.md#function-bindmesh)
...
```C++
virtual SR_NODISCARD std::string SR_GTYPES_NS::Sprite::GetMeshIdentifier () override const
```
...
```C++
virtual void SR_GTYPES_NS::Sprite::UseMaterial () override
```
...
```C++
virtual void SR_GTYPES_NS::Sprite::UseModelMatrix () override
```
...
```C++
bool SR_GTYPES_NS::Sprite::m_sliced;
```
...
### variable m\_textureBorder 

```C++
SR_MATH_NS::FVector2 SR_GTYPES_NS::Sprite::m_textureBorder;
```
...
### variable m\_windowBorder 

```C++
SR_MATH_NS::FVector2 SR_GTYPES_NS::Sprite::m_windowBorder;
```
...
```C++
virtual bool SR_GTYPES_NS::Sprite::Calculate () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Types/Geometry/Sprite.h`
