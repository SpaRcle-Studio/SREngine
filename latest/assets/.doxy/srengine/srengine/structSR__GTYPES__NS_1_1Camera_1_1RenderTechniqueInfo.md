...
# Struct SR\_GTYPES\_NS::Camera::RenderTechniqueInfo



[**ClassList**](annotated.md) **>** [**RenderTechniqueInfo**](structSR__GTYPES__NS_1_1Camera_1_1RenderTechniqueInfo.md)
...
```C++
SR_UTILS_NS::Path SR_GTYPES_NS::Camera::RenderTechniqueInfo::path;
```
