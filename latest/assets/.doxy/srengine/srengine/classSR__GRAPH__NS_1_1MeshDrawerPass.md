...
Inherits the following classes: [SR\_GRAPH\_NS::BasePass](classSR__GRAPH__NS_1_1BasePass.md),  [SR\_GRAPH\_NS::LayerFilterPredicate](classSR__GRAPH__NS_1_1LayerFilterPredicate.md),  [SR\_GRAPH\_NS::PriorityFilterPredicate](classSR__GRAPH__NS_1_1PriorityFilterPredicate.md)
...
|  SR\_NODISCARD const [**SR\_SRSL\_NS::ShaderMacrosParams**](structSR__SRSL__NS_1_1ShaderMacrosParams.md) & | [**GetShaderMacros**](#function-getshadermacros) () noexcept const<br> |
...
| virtual void | [**UseSharedUniforms**](#function-useshareduniforms) ([**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) \* pShader) <br> |
| virtual void | [**UseUniforms**](#function-useuniforms) ([**SR\_GTYPES\_NS::Shader**](classSR__GTYPES__NS_1_1Shader.md) \* pShader, MeshPtr pMesh) <br> |
...
```C++
inline SR_NODISCARD uint8_t SR_GRAPH_NS::MeshDrawerPass::GetLayersCount () noexcept const
```
...
```C++
inline SR_NODISCARD const SR_SRSL_NS::ShaderMacrosParams & SR_GRAPH_NS::MeshDrawerPass::GetShaderMacros () noexcept const
```
...
```C++
virtual void SR_GRAPH_NS::MeshDrawerPass::UseSamplers (
    SR_GTYPES_NS::Shader * pShader
) override
```
