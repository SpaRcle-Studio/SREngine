...
# Class SR\_CORE\_GUI\_NS::AnimatorEditor



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**AnimatorEditor**](classSR__CORE__GUI__NS_1_1AnimatorEditor.md)
...
| Type | Name |
| ---: | :--- |
|   | [**AnimatorEditor**](#function-animatoreditor) () <br> |
| virtual void | [**Draw**](#function-draw) () override<br> |
|  void | [**SetAnimator**](#function-setanimator) (const AnimatorPtr & pAnimator) noexcept<br> |
|   | [**~AnimatorEditor**](#function-animatoreditor) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  AnimatorPtr | [**m\_pAnimator**](#variable-m_panimator)  <br> |
...
### function AnimatorEditor 

```C++
SR_CORE_GUI_NS::AnimatorEditor::AnimatorEditor () 
```
...
```C++
virtual void SR_CORE_GUI_NS::AnimatorEditor::Draw () override
```
...
```C++
void SR_CORE_GUI_NS::AnimatorEditor::SetAnimator (
    const AnimatorPtr & pAnimator
) noexcept
```
...
```C++
SR_CORE_GUI_NS::AnimatorEditor::~AnimatorEditor () override
```
...
```C++
AnimatorPtr SR_CORE_GUI_NS::AnimatorEditor::m_pAnimator;
```
