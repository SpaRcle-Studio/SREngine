...
# Class SR\_SRLM\_NS::ConnectorNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**ConnectorNode**](classSR__SRLM__NS_1_1ConnectorNode.md)
...
```C++
inline virtual SR_NODISCARD LogicalNodeType SR_SRLM_NS::ConnectorNode::GetType () noexcept const
```
