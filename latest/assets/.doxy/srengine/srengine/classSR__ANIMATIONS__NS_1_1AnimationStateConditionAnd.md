...
# Class SR\_ANIMATIONS\_NS::AnimationStateConditionAnd



[**ClassList**](annotated.md) **>** [**SR\_ANIMATIONS\_NS**](namespaceSR__ANIMATIONS__NS.md) **>** [**AnimationStateConditionAnd**](classSR__ANIMATIONS__NS_1_1AnimationStateConditionAnd.md)
...
|   | [**~AnimationStateConditionAnd**](#function-animationstateconditionand) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**AnimationStateConditionAnd**](classSR__ANIMATIONS__NS_1_1AnimationStateConditionAnd.md) \* | [**Load**](#function-load) (const SR\_XML\_NS::Node & nodeXml) <br> |
...
```C++
virtual SR_NODISCARD std::optional< float_t > SR_ANIMATIONS_NS::AnimationStateConditionAnd::GetProgress () noexcept override const
```
...
```C++
virtual SR_NODISCARD bool SR_ANIMATIONS_NS::AnimationStateConditionAnd::IsFinished (
...
```C++
virtual SR_NODISCARD bool SR_ANIMATIONS_NS::AnimationStateConditionAnd::IsNeedBreakUpdate () noexcept override const
```
...
```C++
virtual SR_NODISCARD bool SR_ANIMATIONS_NS::AnimationStateConditionAnd::IsSuitable (
    const StateConditionContext & context
) noexcept override const
```
...
```C++
virtual void SR_ANIMATIONS_NS::AnimationStateConditionAnd::Reset () override
```
...
```C++
virtual void SR_ANIMATIONS_NS::AnimationStateConditionAnd::Update (
    const StateConditionContext & context
) override
```
...
### function ~AnimationStateConditionAnd 

```C++
SR_ANIMATIONS_NS::AnimationStateConditionAnd::~AnimationStateConditionAnd () override
```
...
```C++
static SR_NODISCARD AnimationStateConditionAnd * SR_ANIMATIONS_NS::AnimationStateConditionAnd::Load (
...
```C++
std::vector<AnimationStateCondition*> SR_ANIMATIONS_NS::AnimationStateConditionAnd::m_conditions;
```
