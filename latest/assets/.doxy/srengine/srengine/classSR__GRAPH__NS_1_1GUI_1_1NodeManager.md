...
# Class SR\_GRAPH\_NS::GUI::NodeManager



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**GUI**](namespaceSR__GRAPH__NS_1_1GUI.md) **>** [**NodeManager**](classSR__GRAPH__NS_1_1GUI_1_1NodeManager.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD uintptr\_t | [**AllocUniqueId**](#function-allocuniqueid) (void \* ptr) <br> |
|  void | [**FreeUniqueId**](#function-freeuniqueid) (const uintptr\_t & id) <br> |
|  T \* | [**GetUnique**](#function-getunique) (uintptr\_t id) const<br> |
|   | [**~NodeManager**](#function-nodemanager) () override<br> |
...
### function AllocUniqueId 

```C++
SR_NODISCARD uintptr_t SR_GRAPH_NS::GUI::NodeManager::AllocUniqueId (
    void * ptr
) 
```
...
### function FreeUniqueId 

```C++
void SR_GRAPH_NS::GUI::NodeManager::FreeUniqueId (
    const uintptr_t & id
) 
```
...
```C++
template<typename T>
inline T * SR_GRAPH_NS::GUI::NodeManager::GetUnique (
    uintptr_t id
) const
```
...
```C++
SR_GRAPH_NS::GUI::NodeManager::~NodeManager () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/GUI/NodeManager.h`
