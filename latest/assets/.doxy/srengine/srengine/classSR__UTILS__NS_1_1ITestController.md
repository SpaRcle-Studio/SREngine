...
# Class SR\_UTILS\_NS::ITestController



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**ITestController**](classSR__UTILS__NS_1_1ITestController.md)
...
Inherited by the following classes: [SR\_CORE\_NS::Tests::SRSLTest](classSR__CORE__NS_1_1Tests_1_1SRSLTest.md),  [SR\_UTILS\_NS::SharedPtrTest](classSR__UTILS__NS_1_1SharedPtrTest.md),  [SR\_UTILS\_NS::TestGroupController](classSR__UTILS__NS_1_1TestGroupController.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**ITestController**](classSR__UTILS__NS_1_1ITestController.md) | [**OriginType**](#typedef-origintype)  <br> |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**ITestController**](classSR__UTILS__NS_1_1ITestController.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD uint32\_t | [**GetTotalTestsCount**](#function-gettotaltestscount) () const<br> |
|   | [**ITestController**](#function-itestcontroller) () <br> |
| virtual TestExecutionResult | [**Run**](#function-run) () = 0<br> |
...
```C++
using SR_UTILS_NS::ITestController::OriginType =  ITestController;
```
...
```C++
using SR_UTILS_NS::ITestController::Ptr =  SR_HTYPES_NS::SharedPtr<ITestController>;
```
...
```C++
inline virtual SR_NODISCARD uint32_t SR_UTILS_NS::ITestController::GetTotalTestsCount () const
```
...
### function ITestController 

```C++
SR_UTILS_NS::ITestController::ITestController () 
```
...
```C++
virtual TestExecutionResult SR_UTILS_NS::ITestController::Run () = 0
```
