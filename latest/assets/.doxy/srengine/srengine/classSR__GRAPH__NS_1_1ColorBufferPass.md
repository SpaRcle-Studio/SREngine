...
Inherits the following classes: [SR\_GRAPH\_NS::IColorBufferPass](classSR__GRAPH__NS_1_1IColorBufferPass.md),  [SR\_GRAPH\_NS::MeshDrawerPass](classSR__GRAPH__NS_1_1MeshDrawerPass.md)
...
| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD const [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SR\_GTYPES\_NS::Framebuffer**](classSR__GTYPES__NS_1_1Framebuffer.md) &gt; & | [**GetColorFrameBuffer**](#function-getcolorframebuffer) () noexcept override const<br> |
...
| virtual SR\_NODISCARD const [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SR\_GTYPES\_NS::Framebuffer**](classSR__GTYPES__NS_1_1Framebuffer.md) &gt; & | [**GetColorFrameBuffer**](classSR__GRAPH__NS_1_1IColorBufferPass.md#function-getcolorframebuffer) () noexcept const = 0<br> |
|  SR\_NODISCARD uint32\_t | [**GetColorIndex**](classSR__GRAPH__NS_1_1IColorBufferPass.md#function-getcolorindex) () noexcept const<br> |
|  SR\_NODISCARD uint32\_t | [**GetColorMultiplier**](classSR__GRAPH__NS_1_1IColorBufferPass.md#function-getcolormultiplier) () noexcept const<br> |
...
```C++
virtual SR_NODISCARD const SR_HTYPES_NS::SharedPtr < SR_GTYPES_NS::Framebuffer > & SR_GRAPH_NS::ColorBufferPass::GetColorFrameBuffer () noexcept override const
```
...
```C++
virtual void SR_GRAPH_NS::ColorBufferPass::UseSharedUniforms (
    SR_GTYPES_NS::Shader * pShader
) override
```
