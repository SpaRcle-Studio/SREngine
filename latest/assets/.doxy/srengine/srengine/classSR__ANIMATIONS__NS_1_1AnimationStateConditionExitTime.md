...
# Class SR\_ANIMATIONS\_NS::AnimationStateConditionExitTime



[**ClassList**](annotated.md) **>** [**SR\_ANIMATIONS\_NS**](namespaceSR__ANIMATIONS__NS.md) **>** [**AnimationStateConditionExitTime**](classSR__ANIMATIONS__NS_1_1AnimationStateConditionExitTime.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**AnimationStateConditionExitTime**](classSR__ANIMATIONS__NS_1_1AnimationStateConditionExitTime.md) \* | [**Load**](#function-load) (const SR\_XML\_NS::Node & nodeXml) <br> |
...
| Type | Name |
| ---: | :--- |
|  float\_t | [**m\_dtCapacity**](#variable-m_dtcapacity)   = `0.f`<br> |
|  float\_t | [**m\_dtDuration**](#variable-m_dtduration)   = `0.f`<br> |
|  float\_t | [**m\_dtExitTime**](#variable-m_dtexittime)   = `0.f`<br> |
|  float\_t | [**m\_duration**](#variable-m_duration)   = `0.25f`<br> |
|  float\_t | [**m\_exitTime**](#variable-m_exittime)   = `0.75f`<br> |
|  bool | [**m\_hasExitTime**](#variable-m_hasexittime)   = `true`<br> |
...
```C++
virtual SR_NODISCARD std::optional< float_t > SR_ANIMATIONS_NS::AnimationStateConditionExitTime::GetProgress () noexcept override const
```
...
```C++
virtual SR_NODISCARD bool SR_ANIMATIONS_NS::AnimationStateConditionExitTime::IsFinished (
...
```C++
virtual SR_NODISCARD bool SR_ANIMATIONS_NS::AnimationStateConditionExitTime::IsSuitable (
    const StateConditionContext & context
) noexcept override const
```
...
```C++
virtual void SR_ANIMATIONS_NS::AnimationStateConditionExitTime::Reset () override
```
...
```C++
virtual void SR_ANIMATIONS_NS::AnimationStateConditionExitTime::Update (
    const StateConditionContext & context
) override
```
...
```C++
static SR_NODISCARD AnimationStateConditionExitTime * SR_ANIMATIONS_NS::AnimationStateConditionExitTime::Load (
...
### variable m\_dtCapacity 

```C++
float_t SR_ANIMATIONS_NS::AnimationStateConditionExitTime::m_dtCapacity;
```
...
### variable m\_dtDuration 

```C++
float_t SR_ANIMATIONS_NS::AnimationStateConditionExitTime::m_dtDuration;
```
...
### variable m\_dtExitTime 

```C++
float_t SR_ANIMATIONS_NS::AnimationStateConditionExitTime::m_dtExitTime;
```
...
```C++
float_t SR_ANIMATIONS_NS::AnimationStateConditionExitTime::m_duration;
```



Измеряется в отношении времени относительно состоянияни из которого переходим. Если exitTime = 0.75, то переход начнется через 75% времени состояния. А если hasExitTime = false, то переход начнется сразу. duration - время за которое происходит переход. Если duration больше чем 1 - exitTime, то стейт начнется сначала. 
...
### variable m\_exitTime 

```C++
float_t SR_ANIMATIONS_NS::AnimationStateConditionExitTime::m_exitTime;
```
...
### variable m\_hasExitTime 

```C++
bool SR_ANIMATIONS_NS::AnimationStateConditionExitTime::m_hasExitTime;
```
