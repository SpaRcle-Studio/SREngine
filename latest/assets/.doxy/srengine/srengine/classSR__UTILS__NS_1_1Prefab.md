...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**Prefab**](classSR__UTILS__NS_1_1Prefab.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
|   | [**Prefab**](#function-prefab) () <br> |
|   | [**~Prefab**](#function-prefab) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  Prefab::Ptr | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath) <br> |
...
```C++
using SR_UTILS_NS::Prefab::Ptr =  SR_HTYPES_NS::SharedPtr<Prefab>;
```
...
```C++
SR_UTILS_NS::Prefab::~Prefab () override
```
...
```C++
static Prefab::Ptr SR_UTILS_NS::Prefab::Load (
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Utils/inc/Utils/ECS/Prefab.h`
