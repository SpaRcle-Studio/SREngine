...
# Class SR\_UTILS\_NS::ThreadsWorker



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**ThreadsWorker**](classSR__UTILS__NS_1_1ThreadsWorker.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**AddThread**](#function-addthread) ([**ThreadWorker::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) pThread) <br> |
|  SR\_NODISCARD bool | [**CheckFinalize**](#function-checkfinalize) ([**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name) <br> |
|  SR\_NODISCARD [**SR\_HTYPES\_NS::DataStorage**](classSR__HTYPES__NS_1_1DataStorage.md) & | [**GetContext**](#function-getcontext) () <br> |
|  SR\_NODISCARD ThreadWorkerState | [**GetState**](#function-getstate) ([**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name) const<br> |
...
|  void | [**StopAsync**](#function-stopasync) () <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**ThreadsWorker::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) | [**Load**](#function-load) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
```C++
void SR_UTILS_NS::ThreadsWorker::AddThread (
    ThreadWorker::Ptr pThread
) 
```
...
```C++
SR_NODISCARD bool SR_UTILS_NS::ThreadsWorker::CheckFinalize (
...
```C++
inline SR_NODISCARD SR_HTYPES_NS::DataStorage & SR_UTILS_NS::ThreadsWorker::GetContext () 
```
...
```C++
SR_NODISCARD ThreadWorkerState SR_UTILS_NS::ThreadsWorker::GetState (
    SR_UTILS_NS::StringAtom name
) const
```
...
```C++
inline SR_NODISCARD bool SR_UTILS_NS::ThreadsWorker::IsActive () const
```
...
```C++
SR_NODISCARD bool SR_UTILS_NS::ThreadsWorker::IsAlive () const
```
...
```C++
void SR_UTILS_NS::ThreadsWorker::Start () 
```
...
```C++
void SR_UTILS_NS::ThreadsWorker::Stop () 
```
...
```C++
inline void SR_UTILS_NS::ThreadsWorker::StopAsync () 
```
...
```C++
static SR_NODISCARD ThreadsWorker::Ptr SR_UTILS_NS::ThreadsWorker::Load (
