...
# Class SR\_CORE\_NS::Commands::ComponentChange



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**ComponentChange**](classSR__CORE__NS_1_1Commands_1_1ComponentChange.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ComponentChange**](#function-componentchange) (const EnginePtr & pEngine, const SR\_UTILS\_NS::Component::Ptr & pComponent, SR\_UTILS\_NS::ISerializer::UniquePtr pOld) <br> |
...
```C++
inline SR_CORE_NS::Commands::ComponentChange::ComponentChange (
    const EnginePtr & pEngine,
    const SR_UTILS_NS::Component::Ptr & pComponent,
...
```C++
virtual bool SR_CORE_NS::Commands::ComponentChange::Redo () override
```
...
```C++
virtual bool SR_CORE_NS::Commands::ComponentChange::Undo () override
```
