...
# Class SR\_CORE\_NS::GUI::FileBrowser



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**GUI**](namespaceSR__CORE__NS_1_1GUI.md) **>** [**FileBrowser**](classSR__CORE__NS_1_1GUI_1_1FileBrowser.md)
...
| Type | Name |
| ---: | :--- |
|   | [**FileBrowser**](#function-filebrowser) () <br> |
|  void | [**SetCallback**](#function-setcallback) (CallbackFn callbackFn) <br> |
|  void | [**SetFolder**](#function-setfolder) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
|   | [**~FileBrowser**](#function-filebrowser) () override<br> |
...
```C++
SR_CORE_NS::GUI::FileBrowser::FileBrowser () 
```
...
```C++
inline void SR_CORE_NS::GUI::FileBrowser::SetCallback (
...
```C++
void SR_CORE_NS::GUI::FileBrowser::SetFolder (
...
```C++
SR_CORE_NS::GUI::FileBrowser::~FileBrowser () override
```
