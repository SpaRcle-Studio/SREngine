...
# Class SR\_AUDIO\_NS::RawSound



[**ClassList**](annotated.md) **>** [**SR\_AUDIO\_NS**](namespaceSR__AUDIO__NS.md) **>** [**RawSound**](classSR__AUDIO__NS_1_1RawSound.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**RawSound**](classSR__AUDIO__NS_1_1RawSound.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
|   | [**RawSound**](#function-rawsound) () <br> |
|   | [**~RawSound**](#function-rawsound) () override<br> |
...
| Type | Name |
| ---: | :--- |
|  RawSound::Ptr | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath) <br> |
...
```C++
using SR_AUDIO_NS::RawSound::Ptr =  SR_HTYPES_NS::SharedPtr<RawSound>;
```
...
```C++
virtual SR_NODISCARD SR_UTILS_NS::Path SR_AUDIO_NS::RawSound::GetAssociatedPath () override const
```
...
```C++
SR_NODISCARD uint8_t SR_AUDIO_NS::RawSound::GetBitsPerSample () const
```
...
```C++
SR_NODISCARD const uint8_t * SR_AUDIO_NS::RawSound::GetBufferData () const
```
...
```C++
SR_NODISCARD uint64_t SR_AUDIO_NS::RawSound::GetBufferSize () const
```
...
```C++
SR_NODISCARD uint8_t SR_AUDIO_NS::RawSound::GetChannels () const
```
...
```C++
inline virtual SR_NODISCARD uint64_t SR_AUDIO_NS::RawSound::GetFileHash () override const
```
...
```C++
SR_NODISCARD uint32_t SR_AUDIO_NS::RawSound::GetSampleRate () const
```
...
```C++
inline virtual SR_NODISCARD bool SR_AUDIO_NS::RawSound::IsAllowedToRevive () override const
```
...
```C++
SR_AUDIO_NS::RawSound::~RawSound () override
```
...
```C++
static RawSound::Ptr SR_AUDIO_NS::RawSound::Load (
...
```C++
virtual bool SR_AUDIO_NS::RawSound::Load () override
```
...
```C++
virtual bool SR_AUDIO_NS::RawSound::Reload () override
```
...
```C++
virtual bool SR_AUDIO_NS::RawSound::Unload () override
```
