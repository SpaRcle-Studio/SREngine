...
| Type | Name |
| ---: | :--- |
|  [**RawSound**](classSR__AUDIO__NS_1_1RawSound.md) \* | [**Load**](#function-load-12) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & rawPath) <br> |
...
```C++
static RawSound * SR_AUDIO_NS::RawSound::Load (
