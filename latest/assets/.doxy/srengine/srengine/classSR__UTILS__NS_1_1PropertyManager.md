...
# Class SR\_UTILS\_NS::PropertyManager



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**PropertyManager**](classSR__UTILS__NS_1_1PropertyManager.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**Property**](classSR__UTILS__NS_1_1Property.md) \* | [**Allocate**](#function-allocate) (const [**StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) & name) noexcept const<br> |
|  void | [**Register**](#function-register) ([**StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) name, ConstructorFn constructor) <br> |
...
```C++
SR_NODISCARD Property * SR_UTILS_NS::PropertyManager::Allocate (
...
```C++
void SR_UTILS_NS::PropertyManager::Register (
    StringAtom name,
