...
# Class SR\_PTYPES\_NS::Vehicle4W3D



[**ClassList**](annotated.md) **>** [**SR\_PTYPES\_NS**](namespaceSR__PTYPES__NS.md) **>** [**Vehicle4W3D**](classSR__PTYPES__NS_1_1Vehicle4W3D.md)
...
Inherits the following classes: [SR\_PTYPES\_NS::Vehicle](classSR__PTYPES__NS_1_1Vehicle.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**WheelInternalData**](structSR__PTYPES__NS_1_1WheelInternalData.md)[4] | [**WheelsData**](#typedef-wheelsdata)  <br> |
...
|  SR\_NODISCARD WheelsData & | [**GetWheelsData**](#function-getwheelsdata) () <br> |


## Public Functions inherited from SR_PTYPES_NS::Vehicle

See [SR\_PTYPES\_NS::Vehicle](classSR__PTYPES__NS_1_1Vehicle.md)

| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD void \* | [**GetHandle**](classSR__PTYPES__NS_1_1Vehicle.md#function-gethandle) () noexcept const = 0<br> |
| virtual SR\_NODISCARD SR\_UTILS\_NS::Measurement | [**GetMeasurement**](classSR__PTYPES__NS_1_1Vehicle.md#function-getmeasurement) () const<br> |
|  SR\_NODISCARD [**VehicleInternalData**](structSR__PTYPES__NS_1_1VehicleInternalData.md) & | [**GetVehicleData**](classSR__PTYPES__NS_1_1Vehicle.md#function-getvehicledata) () <br> |
| virtual bool | [**InitVehicle**](classSR__PTYPES__NS_1_1Vehicle.md#function-initvehicle) () <br> |
| virtual void | [**OnDestroy**](classSR__PTYPES__NS_1_1Vehicle.md#function-ondestroy) () override<br>_Вызывается когда компонент убирается с объекта, либо объект уничтожается. Может произойти отложенно._  |
...
## Protected Types inherited from SR_PTYPES_NS::Vehicle

See [SR\_PTYPES\_NS::Vehicle](classSR__PTYPES__NS_1_1Vehicle.md)

| Type | Name |
| ---: | :--- |
| typedef [**SR\_PHYSICS\_NS::LibraryImpl**](classSR__PHYSICS__NS_1_1LibraryImpl.md) \* | [**LibraryPtr**](classSR__PTYPES__NS_1_1Vehicle.md#typedef-libraryptr)  <br> |
| typedef [**SR\_HTYPES\_NS::SafePtr**](classSR__HTYPES__NS_1_1SafePtr.md)&lt; PhysicsScene &gt; | [**PhysicsScenePtr**](classSR__PTYPES__NS_1_1Vehicle.md#typedef-physicssceneptr)  <br> |
| typedef [**SR\_UTILS\_NS::Component**](classSR__UTILS__NS_1_1Component.md) | [**Super**](classSR__PTYPES__NS_1_1Vehicle.md#typedef-super)  <br> |
...
```C++
using SR_PTYPES_NS::Vehicle4W3D::WheelsData =  WheelInternalData[4];
```
...
```C++
inline virtual SR_NODISCARD void * SR_PTYPES_NS::Vehicle4W3D::GetHandle () noexcept override const
```



Implements [*SR\_PTYPES\_NS::Vehicle::GetHandle*](classSR__PTYPES__NS_1_1Vehicle.md#function-gethandle)
...
```C++
inline SR_NODISCARD WheelsData & SR_PTYPES_NS::Vehicle4W3D::GetWheelsData () 
```
