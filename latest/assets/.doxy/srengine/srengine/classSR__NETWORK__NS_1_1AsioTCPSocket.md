...
# Class SR\_NETWORK\_NS::AsioTCPSocket



[**ClassList**](annotated.md) **>** [**SR\_NETWORK\_NS**](namespaceSR__NETWORK__NS.md) **>** [**AsioTCPSocket**](classSR__NETWORK__NS_1_1AsioTCPSocket.md)
...
| Type | Name |
| ---: | :--- |
| virtual uint64\_t | [**AsyncReceive**](#function-asyncreceive) (void \* data, std::function&lt; void(uint64\_t bytesReceived)&gt; callback) override<br> |
...
| virtual uint64\_t | [**Receive**](#function-receive) (void \* data, size\_t size) override<br> |
...
|  void | [**SetSocket**](#function-setsocket) (asio::ip::tcp::socket && socket) <br> |
|   | [**~AsioTCPSocket**](#function-asiotcpsocket) () override<br> |
...
```C++
virtual uint64_t SR_NETWORK_NS::AsioTCPSocket::AsyncReceive (
    void * data,
...
```C++
virtual bool SR_NETWORK_NS::AsioTCPSocket::Close () override
```
...
```C++
virtual bool SR_NETWORK_NS::AsioTCPSocket::Connect (
...
```C++
virtual SR_NODISCARD std::string SR_NETWORK_NS::AsioTCPSocket::GetLocalAddress () override const
```
...
```C++
virtual SR_NODISCARD uint16_t SR_NETWORK_NS::AsioTCPSocket::GetLocalPort () override const
```
...
```C++
virtual SR_NODISCARD std::string SR_NETWORK_NS::AsioTCPSocket::GetRemoteAddress () override const
```
...
```C++
virtual SR_NODISCARD uint16_t SR_NETWORK_NS::AsioTCPSocket::GetRemotePort () override const
```
...
```C++
virtual SR_NODISCARD bool SR_NETWORK_NS::AsioTCPSocket::IsOpen () override const
```
...
```C++
virtual uint64_t SR_NETWORK_NS::AsioTCPSocket::Receive (
    void * data,
    size_t size
) override
```
...
```C++
virtual bool SR_NETWORK_NS::AsioTCPSocket::Send (
    const void * data,
    size_t size
) override
```
...
```C++
virtual bool SR_NETWORK_NS::AsioTCPSocket::SendTo (
    const void * data,
    uint64_t size,
    const std::string & address,
    uint16_t port
...
```C++
inline void SR_NETWORK_NS::AsioTCPSocket::SetSocket (
...
### function ~AsioTCPSocket 

```C++
SR_NETWORK_NS::AsioTCPSocket::~AsioTCPSocket () override
```
...
```C++
virtual bool SR_NETWORK_NS::AsioTCPSocket::ReceiveAsyncInternal () override
```
