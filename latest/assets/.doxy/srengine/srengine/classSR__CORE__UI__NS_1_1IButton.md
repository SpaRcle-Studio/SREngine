...
# Class SR\_CORE\_UI\_NS::IButton



[**ClassList**](annotated.md) **>** [**SR\_CORE\_UI\_NS**](namespaceSR__CORE__UI__NS.md) **>** [**IButton**](classSR__CORE__UI__NS_1_1IButton.md)
...
Inherited by the following classes: [SR\_CORE\_UI\_NS::Button](classSR__CORE__UI__NS_1_1Button.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD ButtonState | [**GetState**](#function-getstate) () const<br> |
|   | [**IButton**](#function-ibutton) () <br> |
|  SR\_NODISCARD bool | [**IsHovered**](#function-ishovered) () const<br> |
|  SR\_NODISCARD bool | [**IsIdle**](#function-isidle) () const<br> |
|  SR\_NODISCARD bool | [**IsPressed**](#function-ispressed) () const<br> |
|  void | [**SetHoverCallback**](#function-sethovercallback) (Callback hoverCallback) <br> |
|  void | [**SetIdleCallback**](#function-setidlecallback) (Callback idleCallback) <br> |
|  void | [**SetKeyDownCallback**](#function-setkeydowncallback) (Callback keyDownCallback) <br> |
|  void | [**SetKeyUpCallback**](#function-setkeyupcallback) (Callback keyUpCallback) <br> |
...
| virtual void | [**OnKeyUp**](#function-onkeyup) () <br> |
...
```C++
inline SR_NODISCARD ButtonState SR_CORE_UI_NS::IButton::GetState () const
```
...
```C++
inline SR_NODISCARD bool SR_CORE_UI_NS::IButton::IsHovered () const
```
...
```C++
inline SR_NODISCARD bool SR_CORE_UI_NS::IButton::IsIdle () const
```
...
```C++
inline SR_NODISCARD bool SR_CORE_UI_NS::IButton::IsPressed () const
```
...
```C++
inline void SR_CORE_UI_NS::IButton::SetHoverCallback (
...
```C++
inline void SR_CORE_UI_NS::IButton::SetIdleCallback (
...
### function SetKeyDownCallback 

```C++
inline void SR_CORE_UI_NS::IButton::SetKeyDownCallback (
...
### function SetKeyUpCallback 

```C++
inline void SR_CORE_UI_NS::IButton::SetKeyUpCallback (
...
```C++
virtual void SR_CORE_UI_NS::IButton::Update (
    float_t dt
) override
```
...
```C++
bool SR_CORE_UI_NS::IButton::CompareObject (
...
```C++
inline virtual SR_NODISCARD SR_FORCE_INLINE bool SR_CORE_UI_NS::IButton::ExecuteInEditMode () override const
```
...
```C++
virtual void SR_CORE_UI_NS::IButton::OnHover () 
```
...
```C++
virtual void SR_CORE_UI_NS::IButton::OnIdle () 
```
...
```C++
virtual void SR_CORE_UI_NS::IButton::OnKeyDown () 
```
...
```C++
virtual void SR_CORE_UI_NS::IButton::OnKeyUp () 
```
