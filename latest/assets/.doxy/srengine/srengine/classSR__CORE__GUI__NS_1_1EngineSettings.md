...
# Class SR\_CORE\_GUI\_NS::EngineSettings



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**EngineSettings**](classSR__CORE__GUI__NS_1_1EngineSettings.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EngineSettings**](#function-enginesettings) () <br> |
|   | [**~EngineSettings**](#function-enginesettings) () override<br> |
...
```C++
SR_CORE_GUI_NS::EngineSettings::EngineSettings () 
```
...
```C++
SR_CORE_GUI_NS::EngineSettings::~EngineSettings () override
```
...
```C++
virtual void SR_CORE_GUI_NS::EngineSettings::Draw () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/inc/Core/GUI/EngineSettings.h`
