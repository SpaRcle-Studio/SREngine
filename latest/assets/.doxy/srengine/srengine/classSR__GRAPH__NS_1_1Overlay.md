...
| virtual SR\_NODISCARD bool | [**IsDynamicRenderingEnabled**](#function-isdynamicrenderingenabled) () const = 0<br> |
...
```C++
virtual SR_NODISCARD bool SR_GRAPH_NS::Overlay::IsDynamicRenderingEnabled () const = 0
```
