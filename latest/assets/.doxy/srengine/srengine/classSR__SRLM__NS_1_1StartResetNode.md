...
# Class SR\_SRLM\_NS::StartResetNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**StartResetNode**](classSR__SRLM__NS_1_1StartResetNode.md)
...
| virtual SR\_NODISCARD LogicalNodeType | [**GetType**](#function-gettype) () noexcept override const<br> |
...
```C++
virtual void SR_SRLM_NS::StartResetNode::Execute (
    float_t dt
) override
```
...
```C++
inline virtual SR_NODISCARD LogicalNodeType SR_SRLM_NS::StartResetNode::GetType () noexcept override const
```
...
```C++
virtual void SR_SRLM_NS::StartResetNode::InitNode () override
```
