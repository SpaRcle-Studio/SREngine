...
# Class SR\_CORE\_GUI\_NS::About



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**About**](classSR__CORE__GUI__NS_1_1About.md)
...
```C++
virtual void SR_CORE_GUI_NS::About::Draw () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/inc/Core/GUI/About.h`
