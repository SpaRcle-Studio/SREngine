...
# Class SR\_CORE\_GUI\_NS::SoundDebug



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**SoundDebug**](classSR__CORE__GUI__NS_1_1SoundDebug.md)
...
|   | [**SoundDebug**](#function-sounddebug) () <br> |
...
```C++
virtual void SR_CORE_GUI_NS::SoundDebug::Draw () override
```
...
```C++
SR_CORE_GUI_NS::SoundDebug::SoundDebug () 
```
