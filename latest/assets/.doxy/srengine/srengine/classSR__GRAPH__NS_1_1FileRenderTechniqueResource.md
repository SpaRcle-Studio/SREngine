...
| Type | Name |
| ---: | :--- |
|  const [**RenderTechniqueData**](structSR__GRAPH__NS_1_1RenderTechniqueData.md) & | [**GetData**](#function-getdata) () noexcept const<br> |
...
| Type | Name |
| ---: | :--- |
|  FileRenderTechniqueResource::Ptr | [**Load**](#function-load) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) <br> |
...
```C++
inline const RenderTechniqueData & SR_GRAPH_NS::FileRenderTechniqueResource::GetData () noexcept const
```
