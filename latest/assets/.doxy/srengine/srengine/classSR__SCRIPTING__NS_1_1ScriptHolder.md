...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**ScriptHolder**](classSR__SCRIPTING__NS_1_1ScriptHolder.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_SCRIPTING_NS::ScriptHolder::Ptr =  SR_HTYPES_NS::SharedPtr<ScriptHolder>;
```
