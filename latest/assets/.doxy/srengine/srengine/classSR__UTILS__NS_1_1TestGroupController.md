...
# Class SR\_UTILS\_NS::TestGroupController



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**TestGroupController**](classSR__UTILS__NS_1_1TestGroupController.md)
...
Inherits the following classes: [SR\_UTILS\_NS::ITestController](classSR__UTILS__NS_1_1ITestController.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**TestGroupController**](classSR__UTILS__NS_1_1TestGroupController.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |


## Public Types inherited from SR_UTILS_NS::ITestController

See [SR\_UTILS\_NS::ITestController](classSR__UTILS__NS_1_1ITestController.md)

| Type | Name |
| ---: | :--- |
| typedef [**ITestController**](classSR__UTILS__NS_1_1ITestController.md) | [**OriginType**](classSR__UTILS__NS_1_1ITestController.md#typedef-origintype)  <br> |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**ITestController**](classSR__UTILS__NS_1_1ITestController.md) &gt; | [**Ptr**](classSR__UTILS__NS_1_1ITestController.md#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD uint32\_t | [**GetTotalTestsCount**](#function-gettotaltestscount) () override const<br> |
| virtual TestExecutionResult | [**Run**](#function-run) () override<br> |


## Public Functions inherited from SR_UTILS_NS::ITestController

See [SR\_UTILS\_NS::ITestController](classSR__UTILS__NS_1_1ITestController.md)

| Type | Name |
| ---: | :--- |
| virtual SR\_NODISCARD uint32\_t | [**GetTotalTestsCount**](classSR__UTILS__NS_1_1ITestController.md#function-gettotaltestscount) () const<br> |
|   | [**ITestController**](classSR__UTILS__NS_1_1ITestController.md#function-itestcontroller) () <br> |
| virtual TestExecutionResult | [**Run**](classSR__UTILS__NS_1_1ITestController.md#function-run) () = 0<br> |
...
```C++
using SR_UTILS_NS::TestGroupController::Ptr =  SR_HTYPES_NS::SharedPtr<TestGroupController>;
```
...
```C++
virtual SR_NODISCARD uint32_t SR_UTILS_NS::TestGroupController::GetTotalTestsCount () override const
```



Implements [*SR\_UTILS\_NS::ITestController::GetTotalTestsCount*](classSR__UTILS__NS_1_1ITestController.md#function-gettotaltestscount)
...
```C++
virtual TestExecutionResult SR_UTILS_NS::TestGroupController::Run () override
```



Implements [*SR\_UTILS\_NS::ITestController::Run*](classSR__UTILS__NS_1_1ITestController.md#function-run)


<hr>

------------------------------
The documentation for this class was generated from the following file `Engine/libs/Utils/inc/Utils/Tests/TestManager.h`
