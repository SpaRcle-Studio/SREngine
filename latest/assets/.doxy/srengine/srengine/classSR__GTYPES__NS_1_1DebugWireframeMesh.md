...
| virtual SR\_NODISCARD std::vector&lt; uint32\_t &gt; | [**GetIndices**](#function-getindices) () override const<br> |
...
```C++
virtual SR_NODISCARD std::vector< uint32_t > SR_GTYPES_NS::DebugWireframeMesh::GetIndices () override const
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Graphics/inc/Graphics/Types/Geometry/DebugWireframeMesh.h`
