...
# Class SR\_GTYPES\_NS::DebugWireframeMesh



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**DebugWireframeMesh**](classSR__GTYPES__NS_1_1DebugWireframeMesh.md)
...
|   | [**DebugWireframeMesh**](#function-debugwireframemesh) () = default<br> |
| virtual SR\_NODISCARD const [**SR\_HTYPES\_NS::FastMemoryArray**](classSR__HTYPES__NS_1_1FastMemoryArray.md)&lt; uint32\_t &gt; & | [**GetIndices**](#function-getindices) () override const<br> |
...
| virtual bool | [**OnResourceReloaded**](#function-onresourcereloaded) (const [**SR\_UTILS\_NS::IResource**](classSR__UTILS__NS_1_1IResource.md) \* pResource) override<br> |
|  void | [**SetColor**](#function-setcolor) (const SR\_MATH\_NS::FVector4 & color) <br> |
| virtual void | [**SetMatrix**](#function-setmatrix) (const [**SR\_MATH\_NS::Matrix4x4**](classSR__MATH__NS_1_1Matrix4x4.md) & matrix) override<br> |
| virtual void | [**UseMaterial**](#function-usematerial) () override<br> |
|   | [**~DebugWireframeMesh**](#function-debugwireframemesh) () override<br> |
...
```C++
typedef Vertices::SimpleVertex SR_GTYPES_NS::DebugWireframeMesh::VertexType;
```
...
```C++
virtual bool SR_GTYPES_NS::DebugWireframeMesh::Calculate () override
```
...
### function DebugWireframeMesh 

```C++
SR_GTYPES_NS::DebugWireframeMesh::DebugWireframeMesh () = default
```
...
```C++
virtual SR_NODISCARD const SR_HTYPES_NS::FastMemoryArray < uint32_t > & SR_GTYPES_NS::DebugWireframeMesh::GetIndices () override const
```



Implements [*SR\_GTYPES\_NS::IndexedMesh::GetIndices*](classSR__GTYPES__NS_1_1IndexedMesh.md#function-getindices)
...
```C++
inline virtual SR_NODISCARD const SR_MATH_NS::Matrix4x4 & SR_GTYPES_NS::DebugWireframeMesh::GetMatrix () override const
```



Implements [*SR\_GTYPES\_NS::Mesh::GetMatrix*](classSR__GTYPES__NS_1_1Mesh.md#function-getmatrix)
...
```C++
virtual SR_NODISCARD std::string SR_GTYPES_NS::DebugWireframeMesh::GetMeshIdentifier () override const
```
...
```C++
inline virtual SR_NODISCARD SR_UTILS_NS::StringAtom SR_GTYPES_NS::DebugWireframeMesh::GetMeshLayer () override const
```
...
```C++
inline virtual SR_NODISCARD MeshType SR_GTYPES_NS::DebugWireframeMesh::GetMeshType () noexcept override const
```
...
```C++
virtual void SR_GTYPES_NS::DebugWireframeMesh::OnRawMeshChanged () override
```
...
```C++
virtual bool SR_GTYPES_NS::DebugWireframeMesh::OnResourceReloaded (
...
Implements [*SR\_GTYPES\_NS::Mesh::OnResourceReloaded*](classSR__GTYPES__NS_1_1Mesh.md#function-onresourcereloaded)
...
```C++
void SR_GTYPES_NS::DebugWireframeMesh::SetColor (
...
```C++
virtual void SR_GTYPES_NS::DebugWireframeMesh::SetMatrix (
...
Implements [*SR\_GTYPES\_NS::Mesh::SetMatrix*](classSR__GTYPES__NS_1_1Mesh.md#function-setmatrix)
...
```C++
virtual void SR_GTYPES_NS::DebugWireframeMesh::UseMaterial () override
```
...
```C++
SR_GTYPES_NS::DebugWireframeMesh::~DebugWireframeMesh () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Types/Geometry/DebugWireframeMesh.h`
