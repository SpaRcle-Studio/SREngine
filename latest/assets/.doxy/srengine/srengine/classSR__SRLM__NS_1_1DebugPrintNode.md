...
# Class SR\_SRLM\_NS::DebugPrintNode



[**ClassList**](annotated.md) **>** [**SR\_SRLM\_NS**](namespaceSR__SRLM__NS.md) **>** [**DebugPrintNode**](classSR__SRLM__NS_1_1DebugPrintNode.md)
...
| virtual void | [**InitValues**](#function-initvalues) () override<br> |
...
```C++
virtual void SR_SRLM_NS::DebugPrintNode::Execute (
    float_t dt
) override
```
...
```C++
virtual void SR_SRLM_NS::DebugPrintNode::InitNode () override
```
...
```C++
virtual void SR_SRLM_NS::DebugPrintNode::InitValues () override
```



Implements [*SR\_SRLM\_NS::LogicalNode::InitValues*](classSR__SRLM__NS_1_1LogicalNode.md#function-initvalues)
