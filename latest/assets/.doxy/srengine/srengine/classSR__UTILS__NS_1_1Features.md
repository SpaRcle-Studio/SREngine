...
# Class SR\_UTILS\_NS::Features



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**Features**](classSR__UTILS__NS_1_1Features.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD bool | [**Enabled**](#function-enabled-13) (const std::string & name) const<br> |
|  SR\_NODISCARD bool | [**Enabled**](#function-enabled-23) (const std::string & name, bool def) const<br> |
|  SR\_NODISCARD bool | [**Enabled**](#function-enabled-33) (const std::string & group, const std::string & name) const<br> |
...
### function Enabled [1/3]

```C++
SR_NODISCARD bool SR_UTILS_NS::Features::Enabled (
...
```C++
bool SR_UTILS_NS::Features::Reload () 
```
...
```C++
void SR_UTILS_NS::Features::SetPath (
