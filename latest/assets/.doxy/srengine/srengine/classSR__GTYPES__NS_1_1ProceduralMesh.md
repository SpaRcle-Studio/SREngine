...
# Class SR\_GTYPES\_NS::ProceduralMesh



[**ClassList**](annotated.md) **>** [**SR\_GTYPES\_NS**](namespaceSR__GTYPES__NS.md) **>** [**ProceduralMesh**](classSR__GTYPES__NS_1_1ProceduralMesh.md)
...
Inherits the following classes: [SR\_GTYPES\_NS::IndexedMesh](classSR__GTYPES__NS_1_1IndexedMesh.md)
...
```C++
typedef Vertices::StaticMeshVertex SR_GTYPES_NS::ProceduralMesh::VertexType;
```
...
```C++
inline virtual SR_NODISCARD MeshType SR_GTYPES_NS::ProceduralMesh::GetMeshType () noexcept override const
```
...
```C++
virtual SR_NODISCARD bool SR_GTYPES_NS::ProceduralMesh::IsCalculatable () override const
```
...
```C++
inline virtual SR_NODISCARD bool SR_GTYPES_NS::ProceduralMesh::IsUniqueMesh () override const
```



Implements [*SR\_GTYPES\_NS::Mesh::IsUniqueMesh*](classSR__GTYPES__NS_1_1Mesh.md#function-isuniquemesh)
...
```C++
SR_GTYPES_NS::ProceduralMesh::ProceduralMesh () = default
```
...
### function SetIndexedVertices 

```C++
void SR_GTYPES_NS::ProceduralMesh::SetIndexedVertices (
    void * pData,
    uint64_t count
) 
```
...
```C++
void SR_GTYPES_NS::ProceduralMesh::SetIndices (
    void * pData,
    uint64_t count
) 
```
...
```C++
void SR_GTYPES_NS::ProceduralMesh::SwapIndexedVertices (
    SR_HTYPES_NS::FastMemoryArray < Vertices::StaticMeshVertex > & vertices
) 
```
...
```C++
void SR_GTYPES_NS::ProceduralMesh::SwapIndices (
...
```C++
virtual void SR_GTYPES_NS::ProceduralMesh::UseMaterial () override
```
...
```C++
virtual void SR_GTYPES_NS::ProceduralMesh::UseModelMatrix () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Types/Geometry/ProceduralMesh.h`
