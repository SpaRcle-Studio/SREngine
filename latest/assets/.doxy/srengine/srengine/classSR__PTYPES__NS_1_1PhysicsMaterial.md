...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**PhysicsMaterial**](classSR__PTYPES__NS_1_1PhysicsMaterial.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
|   | [**PhysicsMaterial**](#function-physicsmaterial) () <br> |
...
|   | [**~PhysicsMaterial**](#function-physicsmaterial) () override<br> |
...
```C++
using SR_PTYPES_NS::PhysicsMaterial::Ptr =  SR_HTYPES_NS::SharedPtr<PhysicsMaterial>;
```
...
```C++
SR_PTYPES_NS::PhysicsMaterial::PhysicsMaterial () 
```
...
```C++
SR_PTYPES_NS::PhysicsMaterial::~PhysicsMaterial () override
```
