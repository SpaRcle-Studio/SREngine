...
# Class SR\_CORE\_NS::GUI::EngineStatistics



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**GUI**](namespaceSR__CORE__NS_1_1GUI.md) **>** [**EngineStatistics**](classSR__CORE__NS_1_1GUI_1_1EngineStatistics.md)
...
| Type | Name |
| ---: | :--- |
|   | [**EngineStatistics**](#function-enginestatistics) () <br> |
|   | [**~EngineStatistics**](#function-enginestatistics) () override<br> |
...
### function EngineStatistics 

```C++
SR_CORE_NS::GUI::EngineStatistics::EngineStatistics () 
```
...
```C++
SR_CORE_NS::GUI::EngineStatistics::~EngineStatistics () override
```
...
```C++
virtual void SR_CORE_NS::GUI::EngineStatistics::Draw () override
```
