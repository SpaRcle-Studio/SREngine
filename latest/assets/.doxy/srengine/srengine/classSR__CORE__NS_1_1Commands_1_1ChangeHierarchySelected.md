...
# Class SR\_CORE\_NS::Commands::ChangeHierarchySelected



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**ChangeHierarchySelected**](classSR__CORE__NS_1_1Commands_1_1ChangeHierarchySelected.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ChangeHierarchySelected**](#function-changehierarchyselected) (const EnginePtr & pEngine, [**SR\_CORE\_GUI\_NS::Hierarchy**](classSR__CORE__GUI__NS_1_1Hierarchy.md) \* pHierarchy, const Selection & oldSelected, const Selection & newSelected) <br> |
...
### function ChangeHierarchySelected 

```C++
SR_CORE_NS::Commands::ChangeHierarchySelected::ChangeHierarchySelected (
    const EnginePtr & pEngine,
    SR_CORE_GUI_NS::Hierarchy * pHierarchy,
    const Selection & oldSelected,
...
```C++
virtual bool SR_CORE_NS::Commands::ChangeHierarchySelected::Redo () override
```
...
```C++
virtual bool SR_CORE_NS::Commands::ChangeHierarchySelected::Undo () override
```
