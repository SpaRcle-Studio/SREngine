...
# Class SR\_UTILS\_NS::TestManager



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**TestManager**](classSR__UTILS__NS_1_1TestManager.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD bool | [**HasFatalError**](#function-hasfatalerror) () const<br> |
|  void | [**OnTestResult**](#function-ontestresult) (TestExecutionResult result) <br> |
|  SR\_NODISCARD TestExecutionResult | [**RunAll**](#function-runall) () <br> |
...
```C++
inline SR_NODISCARD bool SR_UTILS_NS::TestManager::HasFatalError () const
```
...
```C++
void SR_UTILS_NS::TestManager::OnTestResult (
...
```C++
SR_NODISCARD TestExecutionResult SR_UTILS_NS::TestManager::RunAll () 
```
