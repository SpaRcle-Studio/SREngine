...
# Class SR\_GRAPH\_NS::IMesh3DClusterPass



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**IMesh3DClusterPass**](classSR__GRAPH__NS_1_1IMesh3DClusterPass.md)
...
Inherits the following classes: [SR\_GRAPH\_NS::IMeshClusterPass](classSR__GRAPH__NS_1_1IMeshClusterPass.md)


Inherited by the following classes: [SR\_GRAPH\_NS::OpaquePass](classSR__GRAPH__NS_1_1OpaquePass.md),  [SR\_GRAPH\_NS::ShaderOverridePass](classSR__GRAPH__NS_1_1ShaderOverridePass.md),  [SR\_GRAPH\_NS::TransparentPass](classSR__GRAPH__NS_1_1TransparentPass.md)
...
| Type | Name |
| ---: | :--- |
|  [**CascadedShadowMapPass**](classSR__GRAPH__NS_1_1CascadedShadowMapPass.md) \* | [**m\_cascadedShadowMapPass**](#variable-m_cascadedshadowmappass)   = `nullptr`<br> |
|  [**ShadowMapPass**](classSR__GRAPH__NS_1_1ShadowMapPass.md) \* | [**m\_shadowMapPass**](#variable-m_shadowmappass)   = `nullptr`<br> |
...
| Type | Name |
| ---: | :--- |
| virtual void | [**MarkDirtyCluster**](#function-markdirtycluster) ([**MeshCluster**](classSR__GRAPH__NS_1_1MeshCluster.md) & meshCluster) <br> |
| virtual void | [**OnClusterDirty**](#function-onclusterdirty) () override<br> |
| virtual bool | [**Render**](#function-render) () override<br>_Вызывается только во время построения_  |
| virtual bool | [**RenderCluster**](#function-rendercluster) ([**MeshCluster**](classSR__GRAPH__NS_1_1MeshCluster.md) & meshCluster) <br> |
| virtual void | [**Update**](#function-update) () override<br>_Вызывается постоянно после построения_  |
| virtual void | [**UpdateCluster**](#function-updatecluster) ([**MeshCluster**](classSR__GRAPH__NS_1_1MeshCluster.md) & meshCluster) <br> |
...
```C++
virtual bool SR_GRAPH_NS::IMesh3DClusterPass::Init () override
```
...
### variable m\_cascadedShadowMapPass 

```C++
CascadedShadowMapPass* SR_GRAPH_NS::IMesh3DClusterPass::m_cascadedShadowMapPass;
```
...
### variable m\_shadowMapPass 

```C++
ShadowMapPass* SR_GRAPH_NS::IMesh3DClusterPass::m_shadowMapPass;
```
...
### function MarkDirtyCluster 

```C++
virtual void SR_GRAPH_NS::IMesh3DClusterPass::MarkDirtyCluster (
...
### function OnClusterDirty 

```C++
virtual void SR_GRAPH_NS::IMesh3DClusterPass::OnClusterDirty () override
```



Implements [*SR\_GRAPH\_NS::IMeshClusterPass::OnClusterDirty*](classSR__GRAPH__NS_1_1IMeshClusterPass.md#function-onclusterdirty)
...
```C++
virtual bool SR_GRAPH_NS::IMesh3DClusterPass::Render () override
```
...
```C++
virtual bool SR_GRAPH_NS::IMesh3DClusterPass::RenderCluster (
    MeshCluster & meshCluster
) 
```
...
```C++
virtual void SR_GRAPH_NS::IMesh3DClusterPass::Update () override
```
...
```C++
virtual void SR_GRAPH_NS::IMesh3DClusterPass::UpdateCluster (
    MeshCluster & meshCluster
) 
```
