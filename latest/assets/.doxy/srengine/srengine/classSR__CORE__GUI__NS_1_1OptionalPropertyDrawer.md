...
# Class SR\_CORE\_GUI\_NS::OptionalPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**OptionalPropertyDrawer**](classSR__CORE__GUI__NS_1_1OptionalPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**OptionalPropertyDrawer**](classSR__CORE__GUI__NS_1_1OptionalPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_CORE_GUI_NS::OptionalPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<OptionalPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::OptionalPropertyDrawer::Draw (
