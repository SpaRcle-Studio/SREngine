...
# Class SR\_GRAPH\_NS::RenderStagesSettings



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**RenderStagesSettings**](classSR__GRAPH__NS_1_1RenderStagesSettings.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**RenderStagesSettings**](classSR__GRAPH__NS_1_1RenderStagesSettings.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_GRAPH_NS::RenderStagesSettings::Ptr =  SR_HTYPES_NS::SharedPtr<RenderStagesSettings>;
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Settings/RenderStagesSettings.h`
