...
# Class SR\_CORE\_NS::Application



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Application**](classSR__CORE__NS_1_1Application.md)
...
|  bool | [**EarlyInit**](#function-earlyinit) () <br> |
...
```C++
void SR_CORE_NS::Application::Close () 
```
...
```C++
bool SR_CORE_NS::Application::EarlyInit () 
```
...
```C++
bool SR_CORE_NS::Application::Execute () 
```
...
### function GetEngine [1/2]

```C++
inline SR_NODISCARD const SR_HTYPES_NS::SharedPtr < Engine > & SR_CORE_NS::Application::GetEngine () const
```
...
### function GetEngine [2/2]

```C++
inline SR_NODISCARD SR_HTYPES_NS::SharedPtr < Engine > & SR_CORE_NS::Application::GetEngine () 
```
...
```C++
inline SR_NODISCARD const SR_UTILS_NS::Path & SR_CORE_NS::Application::GetResourcesPath () const
```
...
```C++
bool SR_CORE_NS::Application::Init () 
```
