...
# Class SR\_CORE\_GUI\_NS::RectPropertyDrawer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**RectPropertyDrawer**](classSR__CORE__GUI__NS_1_1RectPropertyDrawer.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**RectPropertyDrawer**](classSR__CORE__GUI__NS_1_1RectPropertyDrawer.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
```C++
using SR_CORE_GUI_NS::RectPropertyDrawer::Ptr =  SR_HTYPES_NS::SharedPtr<RectPropertyDrawer>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::RectPropertyDrawer::Draw (
