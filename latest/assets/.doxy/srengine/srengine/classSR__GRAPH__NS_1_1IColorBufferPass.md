...
| virtual SR\_NODISCARD const [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**SR\_GTYPES\_NS::Framebuffer**](classSR__GTYPES__NS_1_1Framebuffer.md) &gt; & | [**GetColorFrameBuffer**](#function-getcolorframebuffer) () noexcept const = 0<br> |
|  SR\_NODISCARD uint32\_t | [**GetColorIndex**](#function-getcolorindex) () noexcept const<br> |
|  SR\_NODISCARD uint32\_t | [**GetColorMultiplier**](#function-getcolormultiplier) () noexcept const<br> |
...
```C++
virtual SR_NODISCARD const SR_HTYPES_NS::SharedPtr < SR_GTYPES_NS::Framebuffer > & SR_GRAPH_NS::IColorBufferPass::GetColorFrameBuffer () noexcept const = 0
```
...
### function GetColorMultiplier 

```C++
inline SR_NODISCARD uint32_t SR_GRAPH_NS::IColorBufferPass::GetColorMultiplier () noexcept const
```
