...
```C++
SR_NODISCARD const FrameBufferPassData::ClearColors & SR_GRAPH_NS::FrameBufferPass::GetClearColors () noexcept const
```
...
```C++
virtual void SR_GRAPH_NS::FrameBufferPass::SetRenderTechnique (
