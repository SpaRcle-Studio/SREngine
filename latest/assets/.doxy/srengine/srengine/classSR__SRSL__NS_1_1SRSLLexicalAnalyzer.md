...
# Class SR\_SRSL\_NS::SRSLLexicalAnalyzer



[**ClassList**](annotated.md) **>** [**SR\_SRSL\_NS**](namespaceSR__SRSL__NS.md) **>** [**SRSLLexicalAnalyzer**](classSR__SRSL__NS_1_1SRSLLexicalAnalyzer.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD std::pair&lt; SRSLAnalyzedTree::Ptr, [**SRSLResult**](structSR__SRSL__NS_1_1SRSLResult.md) &gt; | [**Analyze**](#function-analyze) (std::vector&lt; [**Lexem**](structSR__SRSL__NS_1_1Lexem.md) &gt; && lexems) <br> |
...
```C++
SR_NODISCARD std::pair< SRSLAnalyzedTree::Ptr, SRSLResult > SR_SRSL_NS::SRSLLexicalAnalyzer::Analyze (
