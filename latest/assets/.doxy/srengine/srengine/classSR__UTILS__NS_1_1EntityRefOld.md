...
# Class SR\_UTILS\_NS::EntityRefOld



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**EntityRefOld**](classSR__UTILS__NS_1_1EntityRefOld.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD [**EntityRefOld**](classSR__UTILS__NS_1_1EntityRefOld.md) | [**Copy**](#function-copy) (const [**EntityRefUtils::OwnerRef**](structSR__UTILS__NS_1_1EntityRefUtils_1_1OwnerRef.md) & owner) const<br> |
|   | [**EntityRefOld**](#function-entityrefold-12) () = default<br> |
|   | [**EntityRefOld**](#function-entityrefold-22) ([**EntityRefUtils::OwnerRef**](structSR__UTILS__NS_1_1EntityRefUtils_1_1OwnerRef.md) owner) <br> |
...
|  [**EntityRefOld**](classSR__UTILS__NS_1_1EntityRefOld.md) & | [**SetPathTo**](#function-setpathto) (const [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; Entity &gt; & pEntity) <br> |
...
```C++
SR_NODISCARD EntityRefOld SR_UTILS_NS::EntityRefOld::Copy (
...
### function EntityRefOld [1/2]

```C++
SR_UTILS_NS::EntityRefOld::EntityRefOld () = default
```
...
### function EntityRefOld [2/2]

```C++
explicit SR_UTILS_NS::EntityRefOld::EntityRefOld (
...
```C++
template<typename T>
inline SR_NODISCARD SR_HTYPES_NS::SharedPtr < T > SR_UTILS_NS::EntityRefOld::GetComponent () const
```
...
```C++
SR_NODISCARD SR_HTYPES_NS::SharedPtr < Component > SR_UTILS_NS::EntityRefOld::GetComponent () const
```
...
```C++
SR_NODISCARD SR_HTYPES_NS::SharedPtr < GameObject > SR_UTILS_NS::EntityRefOld::GetGameObject () const
```
...
```C++
SR_NODISCARD SR_HTYPES_NS::SharedPtr < SceneObject > SR_UTILS_NS::EntityRefOld::GetSceneObject () const
```
...
```C++
inline SR_NODISCARD const SR_HTYPES_NS::SharedPtr < Entity > & SR_UTILS_NS::EntityRefOld::GetTarget () const
```
...
```C++
inline SR_NODISCARD bool SR_UTILS_NS::EntityRefOld::IsRelative () const
```
...
```C++
SR_NODISCARD bool SR_UTILS_NS::EntityRefOld::IsValid () const
```
...
```C++
virtual void SR_UTILS_NS::EntityRefOld::OnPreSave () override
```
...
```C++
void SR_UTILS_NS::EntityRefOld::SetOwner (
    const EntityRefUtils::OwnerRef & owner
) 
```
...
```C++
EntityRefOld & SR_UTILS_NS::EntityRefOld::SetPathTo (
...
```C++
void SR_UTILS_NS::EntityRefOld::SetRelative (
    bool relative
) 
```
...
```C++
void SR_UTILS_NS::EntityRefOld::UpdateTarget () const
```
