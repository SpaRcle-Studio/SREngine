...
# Class SR\_CORE\_NS::Commands::GameObjectMove



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**Commands**](namespaceSR__CORE__NS_1_1Commands.md) **>** [**GameObjectMove**](classSR__CORE__NS_1_1Commands_1_1GameObjectMove.md)
...
| Type | Name |
| ---: | :--- |
|   | [**GameObjectMove**](#function-gameobjectmove) (const EnginePtr & pEngine, const SR\_UTILS\_NS::SceneObject::Ptr & pSO, SR\_UTILS\_NS::EntityId newParentId) <br> |
...
### function GameObjectMove 

```C++
SR_CORE_NS::Commands::GameObjectMove::GameObjectMove (
    const EnginePtr & pEngine,
    const SR_UTILS_NS::SceneObject::Ptr & pSO,
    SR_UTILS_NS::EntityId newParentId
) 
```
...
```C++
virtual bool SR_CORE_NS::Commands::GameObjectMove::Redo () override
```
...
```C++
virtual bool SR_CORE_NS::Commands::GameObjectMove::Undo () override
```
