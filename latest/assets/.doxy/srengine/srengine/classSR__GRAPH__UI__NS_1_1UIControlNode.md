...
_подстраивается под содержимое (например, текст)_ [More...](#detailed-description)

* `#include <UIControlNode.h>`
...
Inherited by the following classes: [SR\_GRAPH\_UI\_NS::UIContainerNode](classSR__GRAPH__UI__NS_1_1UIContainerNode.md)
...
|  SR\_NODISCARD const UILayout & | [**GetLayout**](#function-getlayout) () noexcept const<br> |
