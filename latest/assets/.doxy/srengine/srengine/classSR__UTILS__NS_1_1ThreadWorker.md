...
# Class SR\_UTILS\_NS::ThreadWorker



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**ThreadWorker**](classSR__UTILS__NS_1_1ThreadWorker.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**AddState**](#function-addstate) ([**ThreadWorkerStateBase::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) pState) <br> |
|  SR\_NODISCARD const std::vector&lt; [**ThreadWorkerStateBase::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) &gt; & | [**GetStates**](#function-getstates) () const<br> |
|  SR\_NODISCARD [**ThreadsWorker**](classSR__UTILS__NS_1_1ThreadsWorker.md) \* | [**GetThreadsWorker**](#function-getthreadsworker) () const<br> |
|  void | [**SetThreadsWorker**](#function-setthreadsworker) ([**ThreadsWorker**](classSR__UTILS__NS_1_1ThreadsWorker.md) \* pThreadsWorker) <br> |
|  void | [**Start**](#function-start) () <br> |
|  void | [**Stop**](#function-stop) () <br> |
|   | [**ThreadWorker**](#function-threadworker) (std::string name) <br> |
...
```C++
void SR_UTILS_NS::ThreadWorker::AddState (
    ThreadWorkerStateBase::Ptr pState
) 
```
...
```C++
inline SR_NODISCARD const std::vector< ThreadWorkerStateBase::Ptr > & SR_UTILS_NS::ThreadWorker::GetStates () const
```
...
```C++
inline SR_NODISCARD ThreadsWorker * SR_UTILS_NS::ThreadWorker::GetThreadsWorker () const
```
...
### function SetThreadsWorker 

```C++
inline void SR_UTILS_NS::ThreadWorker::SetThreadsWorker (
    ThreadsWorker * pThreadsWorker
) 
```
...
```C++
void SR_UTILS_NS::ThreadWorker::Start () 
```
...
```C++
void SR_UTILS_NS::ThreadWorker::Stop () 
```
...
```C++
explicit SR_UTILS_NS::ThreadWorker::ThreadWorker (
    std::string name
) 
```
