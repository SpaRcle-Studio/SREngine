...
# Class SR\_WORLD\_NS::SceneAllocator



[**ClassList**](annotated.md) **>** [**SR\_WORLD\_NS**](namespaceSR__WORLD__NS.md) **>** [**SceneAllocator**](classSR__WORLD__NS_1_1SceneAllocator.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD ScenePtr | [**Allocate**](#function-allocate) () const<br> |
|  bool | [**Init**](#function-init) (const Allocator & allocator) <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**~SceneAllocator**](#function-sceneallocator) () override<br> |
...
```C++
SR_NODISCARD ScenePtr SR_WORLD_NS::SceneAllocator::Allocate () const
```
...
```C++
bool SR_WORLD_NS::SceneAllocator::Init (
...
### function ~SceneAllocator 

```C++
SR_WORLD_NS::SceneAllocator::~SceneAllocator () override
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/World/SceneAllocator.h`
