...
# Class SR\_GRAPH\_NS::ILightComponent



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**ILightComponent**](classSR__GRAPH__NS_1_1ILightComponent.md)
...
Inherited by the following classes: [SR\_GRAPH\_NS::AreaLight](classSR__GRAPH__NS_1_1AreaLight.md),  [SR\_GRAPH\_NS::DirectionalLight](classSR__GRAPH__NS_1_1DirectionalLight.md),  [SR\_GRAPH\_NS::PointLight](classSR__GRAPH__NS_1_1PointLight.md),  [SR\_GRAPH\_NS::ProbeLight](classSR__GRAPH__NS_1_1ProbeLight.md),  [SR\_GRAPH\_NS::SpotLight](classSR__GRAPH__NS_1_1SpotLight.md)
...
| virtual SR\_NODISCARD LightType | [**GetLightType**](#function-getlighttype) () const = 0<br> |
...
| Type | Name |
| ---: | :--- |
|  float\_t | [**m\_bounceIntensity**](#variable-m_bounceintensity)   = `1.f`<br> |
|  float\_t | [**m\_intensity**](#variable-m_intensity)   = `1.f`<br> |
|  ShadowType | [**m\_shadowType**](#variable-m_shadowtype)   = `ShadowType::Soft`<br> |
...
```C++
inline virtual SR_NODISCARD SR_FORCE_INLINE bool SR_GRAPH_NS::ILightComponent::ExecuteInEditMode () override const
```
...
```C++
virtual SR_NODISCARD LightType SR_GRAPH_NS::ILightComponent::GetLightType () const = 0
```
...
```C++
inline virtual SR_NODISCARD bool SR_GRAPH_NS::ILightComponent::IsUpdatable () noexcept override const
```
...
```C++
virtual void SR_GRAPH_NS::ILightComponent::OnAttached () override
```
...
```C++
virtual void SR_GRAPH_NS::ILightComponent::OnDestroy () override
```
...
### variable m\_bounceIntensity 

```C++
float_t SR_GRAPH_NS::ILightComponent::m_bounceIntensity;
```
...
### variable m\_intensity 

```C++
float_t SR_GRAPH_NS::ILightComponent::m_intensity;
```
...
### variable m\_shadowType 

```C++
ShadowType SR_GRAPH_NS::ILightComponent::m_shadowType;
```
