...
# Class SR\_UTILS\_NS::CameraFlyMover



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**CameraFlyMover**](classSR__UTILS__NS_1_1CameraFlyMover.md)
...
|  void | [**SetVelocityFactor**](#function-setvelocityfactor) (const float\_t factor) <br> |
...
```C++
inline virtual SR_NODISCARD bool SR_UTILS_NS::CameraFlyMover::ExecuteInEditMode () override const
```
...
```C++
inline void SR_UTILS_NS::CameraFlyMover::SetActive (
    const bool active
) 
```
...
```C++
void SR_UTILS_NS::CameraFlyMover::SetExecuteInEditMode (
    bool enabled
) 
```
...
### function SetRightMouseButtonToRotate 

```C++
inline void SR_UTILS_NS::CameraFlyMover::SetRightMouseButtonToRotate (
    const bool enabled
) 
```
...
### function SetVelocityFactor 

```C++
inline void SR_UTILS_NS::CameraFlyMover::SetVelocityFactor (
...
------------------------------
The documentation for this class was generated from the following file `Engine/Core/libs/Utils/inc/Utils/Game/CameraFlyMover.h`
