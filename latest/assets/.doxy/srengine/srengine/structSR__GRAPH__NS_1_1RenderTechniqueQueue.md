...
# Struct SR\_GRAPH\_NS::RenderTechniqueQueue



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_NS**](namespaceSR__GRAPH__NS.md) **>** [**RenderTechniqueQueue**](structSR__GRAPH__NS_1_1RenderTechniqueQueue.md)
...
| Type | Name |
| ---: | :--- |
|  std::vector&lt; [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) &gt; | [**frameBuffers**](#variable-framebuffers)  <br> |
...
```C++
std::vector<SR_UTILS_NS::StringAtom> SR_GRAPH_NS::RenderTechniqueQueue::frameBuffers;
```
...
------------------------------
The documentation for this class was generated from the following file `Engine/libs/Graphics/inc/Graphics/Pass/RenderTechniqueQueue.h`
