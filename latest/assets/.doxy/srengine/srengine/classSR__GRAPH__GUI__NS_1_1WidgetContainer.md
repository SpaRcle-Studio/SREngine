...
# Class SR\_GRAPH\_GUI\_NS::WidgetContainer



[**ClassList**](annotated.md) **>** [**SR\_GRAPH\_GUI\_NS**](namespaceSR__GRAPH__GUI__NS.md) **>** [**WidgetContainer**](classSR__GRAPH__GUI__NS_1_1WidgetContainer.md)
...
Inherited by the following classes: [SR\_CORE\_GUI\_NS::SceneTools](classSR__CORE__GUI__NS_1_1SceneTools.md)
...
| Type | Name |
| ---: | :--- |
|  [**WidgetContainerElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainerElement.md) & | [**AddElement**](#function-addelement-13) ([**WidgetContainerElement::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) pElement) <br> |
|  [**WidgetContainerElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainerElement.md) & | [**AddElement**](#function-addelement-23) () <br> |
|  [**WidgetContainerElement**](classSR__GRAPH__GUI__NS_1_1WidgetContainerElement.md) & | [**AddElement**](#function-addelement-33) (std::string text) <br> |
| virtual void | [**Draw**](#function-draw) () <br> |
|   | [**WidgetContainer**](#function-widgetcontainer) (std::string name) <br> |
...
| Type | Name |
| ---: | :--- |
|  std::vector&lt; [**WidgetContainerElement::Ptr**](classSR__HTYPES__NS_1_1SharedPtr.md) &gt; | [**m\_elements**](#variable-m_elements)  <br> |
...
### function AddElement [1/3]

```C++
inline WidgetContainerElement & SR_GRAPH_GUI_NS::WidgetContainer::AddElement (
    WidgetContainerElement::Ptr pElement
) 
```
...
### function AddElement [3/3]

```C++
WidgetContainerElement & SR_GRAPH_GUI_NS::WidgetContainer::AddElement (
    std::string text
) 
```
...
```C++
virtual void SR_GRAPH_GUI_NS::WidgetContainer::Draw () 
```
...
```C++
inline explicit SR_GRAPH_GUI_NS::WidgetContainer::WidgetContainer (
    std::string name
) 
```
...
### variable m\_elements 

```C++
std::vector<WidgetContainerElement::Ptr> SR_GRAPH_GUI_NS::WidgetContainer::m_elements;
```
