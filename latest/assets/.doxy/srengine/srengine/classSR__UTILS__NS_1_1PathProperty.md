...
# Class SR\_UTILS\_NS::PathProperty



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**PathProperty**](classSR__UTILS__NS_1_1PathProperty.md)



_---------------------------------------_  __[_**PathProperty**_](classSR__UTILS__NS_1_1PathProperty.md) _-----------------------------------------------------_ __
...
| Type | Name |
| ---: | :--- |
|  [**PathProperty**](classSR__UTILS__NS_1_1PathProperty.md) & | [**AddFileFilter**](#function-addfilefilter) ([**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) description, [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) extension) <br> |
|  SR\_NODISCARD const Filter & | [**GetFileFilter**](#function-getfilefilter) () noexcept const<br> |
|  SR\_NODISCARD [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) | [**GetPath**](#function-getpath) () noexcept const<br> |
|  SR\_NODISCARD [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) | [**GetWidgetEditor**](#function-getwidgeteditor) () noexcept const<br> |
...
|  [**PathProperty**](classSR__UTILS__NS_1_1PathProperty.md) & | [**SetGetter**](#function-setgetter) (const GetterFn & value) <br> |
|  [**PathProperty**](classSR__UTILS__NS_1_1PathProperty.md) & | [**SetPath**](#function-setpath) (const [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) & path) noexcept<br> |
|  [**PathProperty**](classSR__UTILS__NS_1_1PathProperty.md) & | [**SetSetter**](#function-setsetter) (const SetterFn & value) <br> |
|  [**PathProperty**](classSR__UTILS__NS_1_1PathProperty.md) & | [**SetWidgetEditor**](#function-setwidgeteditor) (const [**SR\_UTILS\_NS::StringAtom**](classSR__UTILS__NS_1_1StringAtom.md) & value) <br> |
...
```C++
inline PathProperty & SR_UTILS_NS::PathProperty::AddFileFilter (
    SR_UTILS_NS::StringAtom description,
    SR_UTILS_NS::StringAtom extension
) 
```
...
```C++
inline SR_NODISCARD const Filter & SR_UTILS_NS::PathProperty::GetFileFilter () noexcept const
```
...
```C++
SR_NODISCARD SR_UTILS_NS::Path SR_UTILS_NS::PathProperty::GetPath () noexcept const
```
...
### function GetWidgetEditor 

```C++
inline SR_NODISCARD SR_UTILS_NS::StringAtom SR_UTILS_NS::PathProperty::GetWidgetEditor () noexcept const
```
...
```C++
virtual void SR_UTILS_NS::PathProperty::LoadProperty (
    MarshalRef marshal
) noexcept override
```
...
```C++
virtual void SR_UTILS_NS::PathProperty::SaveProperty (
    MarshalRef marshal
...
```C++
inline PathProperty & SR_UTILS_NS::PathProperty::SetGetter (
...
```C++
PathProperty & SR_UTILS_NS::PathProperty::SetPath (
...
```C++
inline PathProperty & SR_UTILS_NS::PathProperty::SetSetter (
...
```C++
inline PathProperty & SR_UTILS_NS::PathProperty::SetWidgetEditor (
