...
# Class SR\_SRSL\_NS::SRSLMathExpression



[**ClassList**](annotated.md) **>** [**SR\_SRSL\_NS**](namespaceSR__SRSL__NS.md) **>** [**SRSLMathExpression**](classSR__SRSL__NS_1_1SRSLMathExpression.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD std::pair&lt; [**SRSLExpr**](classSR__SRSL__NS_1_1SRSLExpr.md) \*, [**SRSLResult**](structSR__SRSL__NS_1_1SRSLResult.md) &gt; | [**Analyze**](#function-analyze) (std::vector&lt; [**Lexem**](structSR__SRSL__NS_1_1Lexem.md) &gt; && lexems) <br> |
...
```C++
SR_NODISCARD std::pair< SRSLExpr *, SRSLResult > SR_SRSL_NS::SRSLMathExpression::Analyze (
