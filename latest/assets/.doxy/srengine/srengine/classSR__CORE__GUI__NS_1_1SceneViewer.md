...
# Class SR\_CORE\_GUI\_NS::SceneViewer



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**SceneViewer**](classSR__CORE__GUI__NS_1_1SceneViewer.md)
...
|  SR\_NODISCARD GameObjectPtr | [**GetGizmo**](#function-getgizmo) () const<br> |
|  SR\_NODISCARD SR\_MATH\_NS::FPoint | [**GetImagePosition**](#function-getimageposition) () const<br> |
|  SR\_NODISCARD SR\_MATH\_NS::FPoint | [**GetTextureSize**](#function-gettexturesize) () const<br> |
...
|   | [**SceneViewer**](#function-sceneviewer-12) () = default<br> |
|   | [**SceneViewer**](#function-sceneviewer-22) (const EnginePtr & pEngine, [**Hierarchy**](classSR__CORE__GUI__NS_1_1Hierarchy.md) \* hierarchy) <br> |
| virtual void | [**SetScene**](#function-setscene) (const ScenePtr & scene) override<br> |
|   | [**~SceneViewer**](#function-sceneviewer) () override<br> |
...
```C++
void SR_CORE_GUI_NS::SceneViewer::Enable (
    bool value
) 
```
...
```C++
virtual void SR_CORE_GUI_NS::SceneViewer::FixedUpdate () override
```



Implements [*SR\_GRAPH\_GUI\_NS::Widget::FixedUpdate*](classSR__GRAPH__GUI__NS_1_1Widget.md#function-fixedupdate)
...
```C++
inline SR_NODISCARD GameObjectPtr SR_CORE_GUI_NS::SceneViewer::GetGizmo () const
```
...
```C++
SR_NODISCARD SR_MATH_NS::FPoint SR_CORE_GUI_NS::SceneViewer::GetImagePosition () const
```
...
```C++
inline SR_NODISCARD SR_MATH_NS::FPoint SR_CORE_GUI_NS::SceneViewer::GetTextureSize () const
```
...
```C++
virtual void SR_CORE_GUI_NS::SceneViewer::OnKeyDown (
...
```C++
virtual void SR_CORE_GUI_NS::SceneViewer::OnKeyPress (
    const SR_UTILS_NS::KeyboardInputData * data
) override
```
...
```C++
virtual void SR_CORE_GUI_NS::SceneViewer::OnMouseDown (
...
```C++
virtual void SR_CORE_GUI_NS::SceneViewer::OnMouseUp (
    const SR_UTILS_NS::MouseInputData * data
) override
```
...
### function SceneViewer [1/2]

```C++
SR_CORE_GUI_NS::SceneViewer::SceneViewer () = default
```
...
### function SceneViewer [2/2]

```C++
SR_CORE_GUI_NS::SceneViewer::SceneViewer (
...
```C++
virtual void SR_CORE_GUI_NS::SceneViewer::SetScene (
...
Implements [*SR\_GRAPH\_GUI\_NS::Widget::SetScene*](classSR__GRAPH__GUI__NS_1_1Widget.md#function-setscene)
...
```C++
SR_CORE_GUI_NS::SceneViewer::~SceneViewer () override
```
