...
# Class SR\_UTILS\_NS::TestManagerAsset



[**ClassList**](annotated.md) **>** [**SR\_UTILS\_NS**](namespaceSR__UTILS__NS.md) **>** [**TestManagerAsset**](classSR__UTILS__NS_1_1TestManagerAsset.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**TestManagerAsset**](classSR__UTILS__NS_1_1TestManagerAsset.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  std::vector&lt; ITestController::Ptr &gt; | [**m\_tests**](#variable-m_tests)  <br> |
...
```C++
using SR_UTILS_NS::TestManagerAsset::Ptr =  SR_HTYPES_NS::SharedPtr<TestManagerAsset>;
```
...
```C++
std::vector<ITestController::Ptr> SR_UTILS_NS::TestManagerAsset::m_tests;
```
