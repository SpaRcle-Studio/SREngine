...
# Class SR\_CORE\_GUI\_NS::PropertyDrawerBase



[**ClassList**](annotated.md) **>** [**SR\_CORE\_GUI\_NS**](namespaceSR__CORE__GUI__NS.md) **>** [**PropertyDrawerBase**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md)
...
Inherits the following classes: [SR\_UTILS\_NS::SRClass](classSR__UTILS__NS_1_1SRClass.md),  [SR\_HTYPES\_NS::SharedPtr](classSR__HTYPES__NS_1_1SharedPtr.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**PropertyDrawerBase**](classSR__CORE__GUI__NS_1_1PropertyDrawerBase.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
| virtual [**PropertyDrawerFeedback**](structSR__CORE__GUI__NS_1_1PropertyDrawerFeedback.md) | [**Draw**](#function-draw) (const [**PropertyDrawerContext**](structSR__CORE__GUI__NS_1_1PropertyDrawerContext.md) & context) = 0<br> |
|   | [**PropertyDrawerBase**](#function-propertydrawerbase) () <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD bool | [**CheckSearchMatch**](#function-checksearchmatch) (std::string\_view searchBuffer, std::string\_view text) <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD SR\_GRAPH\_NS::RenderContext::Ptr | [**GetRenderContext**](#function-getrendercontext) () const<br> |
...
```C++
using SR_CORE_GUI_NS::PropertyDrawerBase::Ptr =  SR_HTYPES_NS::SharedPtr<PropertyDrawerBase>;
```
...
```C++
virtual PropertyDrawerFeedback SR_CORE_GUI_NS::PropertyDrawerBase::Draw (
...
### function PropertyDrawerBase 

```C++
inline SR_CORE_GUI_NS::PropertyDrawerBase::PropertyDrawerBase () 
```
...
```C++
static inline SR_NODISCARD bool SR_CORE_GUI_NS::PropertyDrawerBase::CheckSearchMatch (
    std::string_view searchBuffer,
...
```C++
SR_NODISCARD SR_GRAPH_NS::RenderContext::Ptr SR_CORE_GUI_NS::PropertyDrawerBase::GetRenderContext () const
```
...
static inline void SR_CORE_GUI_NS::PropertyDrawerBase::SetMappedValue (
    const PropertyDrawerContext & context,
...
### function SetReflectedValue 

```C++
static inline void SR_CORE_GUI_NS::PropertyDrawerBase::SetReflectedValue (
    const PropertyDrawerContext & context,
    PropertyDrawerFeedback & feedback,
...
```C++
static inline void SR_CORE_GUI_NS::PropertyDrawerBase::SetValue (
    const PropertyDrawerContext & context,
    const PropertyDrawerFeedback & feedback,
    const SR_UTILS_NS::Reflection::Value & value
) 
```
