...
# Class SR\_CORE\_NS::EditorSettings



[**ClassList**](annotated.md) **>** [**SR\_CORE\_NS**](namespaceSR__CORE__NS.md) **>** [**EditorSettings**](classSR__CORE__NS_1_1EditorSettings.md)
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD Icons | [**GetIcons**](#function-geticons) () const<br> |
|  SR\_NODISCARD [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) | [**GetPrefabEditorRenderTechnique**](#function-getprefabeditorrendertechnique) () const<br> |
|  SR\_NODISCARD [**SR\_UTILS\_NS::Path**](classSR__UTILS__NS_1_1Path.md) | [**GetRenderTechnique**](#function-getrendertechnique) () const<br> |
...
|  SR\_NODISCARD bool | [**IsNeedDebugChunks**](#function-isneeddebugchunks) () noexcept const<br> |
...
|   | [**~EditorSettings**](#function-editorsettings) () override<br> |
...
```C++
SR_NODISCARD Icons SR_CORE_NS::EditorSettings::GetIcons () const
```
...
### function GetPrefabEditorRenderTechnique 

```C++
SR_NODISCARD SR_UTILS_NS::Path SR_CORE_NS::EditorSettings::GetPrefabEditorRenderTechnique () const
```
...
```C++
SR_NODISCARD SR_UTILS_NS::Path SR_CORE_NS::EditorSettings::GetRenderTechnique () const
```
...
```C++
SR_NODISCARD SR_UTILS_NS::Path SR_CORE_NS::EditorSettings::InitializeResourcePath () override const
```
...
### function IsNeedDebugChunks 

```C++
inline SR_NODISCARD bool SR_CORE_NS::EditorSettings::IsNeedDebugChunks () noexcept const
```
...
```C++
void SR_CORE_NS::EditorSettings::ClearSettings () override
```
...
```C++
bool SR_CORE_NS::EditorSettings::LoadSettings (
...
```C++
SR_CORE_NS::EditorSettings::~EditorSettings () override
```
...
### friend GlobalSettings&lt; EditorSettings &gt; 

```C++
class SR_CORE_NS::EditorSettings::GlobalSettings< EditorSettings > (
    SR_UTILS_NS::GlobalSettings < EditorSettings >
) 
```
