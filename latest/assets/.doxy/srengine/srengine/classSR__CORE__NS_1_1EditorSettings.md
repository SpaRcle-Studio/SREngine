...
| Type | Name |
| ---: | :--- |
| typedef [**SR\_HTYPES\_NS::SharedPtr**](classSR__HTYPES__NS_1_1SharedPtr.md)&lt; [**EditorSettings**](classSR__CORE__NS_1_1EditorSettings.md) &gt; | [**Ptr**](#typedef-ptr)  <br> |
...
| Type | Name |
| ---: | :--- |
|  SR\_NODISCARD const std::map&lt; EditorIcon, [**EditorSettingsIconInfo**](structSR__CORE__NS_1_1EditorSettingsIconInfo.md) &gt; & | [**GetIcons**](#function-geticons) () noexcept const<br> |
...
```C++
using SR_CORE_NS::EditorSettings::Ptr =  SR_HTYPES_NS::SharedPtr<EditorSettings>;
```
...
```C++
inline SR_NODISCARD const std::map< EditorIcon, EditorSettingsIconInfo > & SR_CORE_NS::EditorSettings::GetIcons () noexcept const
```
